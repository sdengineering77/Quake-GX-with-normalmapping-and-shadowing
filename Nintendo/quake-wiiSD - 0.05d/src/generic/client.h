...
//	int 						num_neighbouring; // = num_vis
//	struct shadowvol_s	*neighbours[MAX_NEIGHBOURING_SURFACES]; // max 4 neighbours
	
} shadowvol_t;

typedef struct shadowvolchain_s {
	struct shadowvolchain_s *next;
	shadowvol_t *firstshadowvol;
} shadowvolchain_t;
