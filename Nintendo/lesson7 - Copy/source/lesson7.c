...
int main(int argc,char **argv)
{
	...
	while(1) {
		...
		// setup indirect unit (for some reason I get a ABGR triplet, so transforms are done on normal map's B and G components)
		f32 offset_mtx[2][3] = {
...
//			{  0.0f,   0.0f,  0.25f}  // G -> vertical coordinate (t)
		...
		GX_SetTevOrder(GX_TEVSTAGE0, GX_TEXCOORD2, GX_TEXMAP1, GX_COLORNULL);

		GX_LoadTexObj(&texture, GX_TEXMAP0);
		GX_LoadTexObj(&light_tex, GX_TEXMAP1);
