# 1 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 2 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 3 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 4 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 5 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 7 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c" 2
...
# 48 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 125 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 245 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 370 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
typedef struct fog
{
...
# 461 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 585 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 674 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
# 827 "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c"
...
static void push(attribStack_t * ptr, AttribOpt * opts, size_t n_opts, GLenum mask)
{
 ...
 if(ptr->typeCur >= 16)
 {
  _glSetErrorEx(0x0503, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1043);
  return;
 }
  ...
  if((opts[i].mask & mask) == opts[i].mask)
  {
   while(!opts[i].push(&cur, stackEnd(ptr)))
   {
    ...
    if(!resizeStack(ptr))
    {
     ...
     _glSetErrorEx(0x0503, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1062);
     return;
    }
   }
  }
...
static void pop(attribStack_t * ptr, AttribOpt * opts, size_t n_opts)
{
 ...
 if(ptr->typeCur == 0)
 {
  _glSetErrorEx(0x0504, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1082);
  return;
 }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1107); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1114); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1202); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "c:/projects/wii/gl2gx/libogc/../source/gl_stacks.c", 1209); return; };
