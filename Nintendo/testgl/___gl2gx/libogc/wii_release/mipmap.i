# 1 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
# 1 "c:\\projects\\wii\\gl2gx\\libogc\\wii_release//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
# 38 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
# 1 "c:/projects/wii/gl2gx/libogc/../source/include/gluos.h" 1
# 39 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
...
# 40 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
# 1 "c:/projects/wii/gl2gx/libogc/include/GL/glu.h" 1
# 37 "c:/projects/wii/gl2gx/libogc/include/GL/glu.h"
...
# 38 "c:/projects/wii/gl2gx/libogc/include/GL/glu.h" 2
# 269 "c:/projects/wii/gl2gx/libogc/include/GL/glu.h"
...
# 41 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
...
# 42 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
...
# 44 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
# 1 "c:\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-gekko/4.2.4/include/limits.h" 1 3 4
# 45 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
...
# 46 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
# 1 "c:/projects/wii/gl2gx/libogc/../source/libutil/gluint.h" 1
# 41 "c:/projects/wii/gl2gx/libogc/../source/libutil/gluint.h"
extern const char *__gluNURBSErrorString( int errno );

extern const char *__gluTessErrorString( int errno );
# 47 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c" 2
...
# 338 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
...
# 3434 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
                     ...
                     GLenum type, const void *data)
{
    ...
    retrieveStoreModes(&psm);
# 3730 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
...
# 4628 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
       ...
       GLenum type, void *data)
{
    ...
    GLint maxsize;
    GLint cmpts;
# 4652 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
         ...
         GLint rowSizeInBytes,GLint isSwap)
{
 ...
 for (j = 0; j < widthOut; j++) {
  ...
  percent = y_percent * (1-lowx_float);
# 6106 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
...
# 6125 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
      (*extractPackedPixel)(isSwap,temp,extractTotals);
      for (k = 0; k < components; k++) {
  ...
  right = temp;
  percent = y_percent * highx_float;
# 6144 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
...
# 6165 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
  ...
  for(l = lowx_int+1; l < highx_int; l++) {
                    temp += pixelSizeInBytes;
# 6183 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
      (*extractPackedPixel)(isSwap,temp,extractTotals);
      for (k = 0; k < components; k++) {
         totals[k]+= extractTotals[k] * y_percent;
      }
                ...
                temp += pixelSizeInBytes;
  percent = y_percent * highx_float;
# 6202 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
...
# 6225 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  ...
  percent = (1-lowy_float)*x_percent;
  temp = (const char *)dataIn + xindex + lowy_int*rowSizeInBytes;
# 6247 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
  ...
  for(m = lowy_int+1; m < highy_int; m++) {
      temp += rowSizeInBytes;
# 6265 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
      (*extractPackedPixel)(isSwap,temp,extractTotals);
      for (k = 0; k < components; k++) {
  ...
  percent = x_percent * highy_float;
  temp += rowSizeInBytes;
# 6283 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
  ...
  percent = (1-lowx_float)*y_percent;
  temp = (const char *)dataIn + xindex + lowy_int*rowSizeInBytes;
# 6302 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
  ...
  for (l = lowx_int+1; l < highx_int; l++) {
                    temp += pixelSizeInBytes;
# 6320 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * y_percent;
  }
  ...
  temp += pixelSizeInBytes;
  percent = y_percent * highx_float;
# 6338 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
  ...
  percent = (highy_float-lowy_float)*(highx_float-lowx_float);
  temp = (const char *)dataIn + xindex + lowy_int * rowSizeInBytes;
# 6356 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  (*extractPackedPixel)(isSwap,temp,extractTotals);
  for (k = 0; k < components; k++) {
     totals[k]+= extractTotals[k] * percent;
  }
  ...
  temp = temp0;
  for(l = lowx_int+1; l < highx_int; l++) {
# 6378 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
      (*extractPackedPixel)(isSwap,temp,extractTotals);
      for (k = 0; k < components; k++) {
      ...
      GLint rowSizeInBytes, GLint isSwap)
{
  ...
  src+= padBytes;
# 6502 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
  src+= rowSizeInBytes;
      }
    ...
    GLint isSwap)
{
  ...
  for (ii= 0; ii< halfHeight; ii++) {
    ...
    src+= elementSizeInBytes;
     ...
     src+= padBytes;
# 7163 "c:/projects/wii/gl2gx/libogc/../source/libutil/mipmap.c"
     src+= rowSizeInBytes;
  }
