...
void idScreenRect::Expand() {
	...
	x2++;
	y2++;
// DRS TODO: This might be the place to make multiple of two
}
...
DRS: DoomGX pads to 32 for vertex array
================
*/
...
//Sys_Printf(">>> R_SetupProjection( void ) tr_main.cpp DOES INFINITE\r\n");
...
Sys_Printf("r_subviewOnly, return\r\n");
			return;
		}
	}
