...
float readFloat( void ) {
	poor	me;
#ifdef __ppc__ // DRS Aha, this made gui texts fail, didn't set __ppc__ define...:)
...
*/
	...
	for ( fontCount = 0; fontCount < 3; fontCount++ ) {
		...
		for( i = 0; i < GLYPHS_PER_FONT; i++ ) {
			...
			int junk /* font.glyphs[i].glyph */		= readInt(); // DRS TODO: wouldn't just readInt() be sufficient?
