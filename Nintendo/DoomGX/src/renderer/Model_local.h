...
public:
	...
	virtual void				InitEmpty( const char *name, const char *filename = NULL, int fileoffset = 0 );
	virtual void				AddSurface( modelSurface_t surface );
	virtual void				FinishSurfaces();
	virtual void				FreeVertexCache();
	virtual const char *		GetFileName() const;
	virtual int					GetFileOffset() const;
...
protected:
	...
	idStr						filename; // DRS added
	int							fileoffset; // DRS added
