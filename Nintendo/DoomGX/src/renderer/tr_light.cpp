...
//Sys_Printf(">>> R_AddDrawSurf srfTriangles_t %p rect %d %d %d %d\r\n", tri, scissor.x1, scissor.x2, scissor.y1, scissor.y2);
...
#ifdef DOOMGX
//Sys_Printf(">>> Flushing range %p %d\r\n", (byte *)tri->ambientCache->virtMem  + tri->ambientCache->offset, tri->ambientCache->size);
	DCFlushRange((byte *) tri->ambientCache->virtMem + tri->ambientCache->offset, tri->ambientCache->size);
#endif
