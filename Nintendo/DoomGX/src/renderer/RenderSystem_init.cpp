...
#ifdef DOOMGX
    Sys_Printf(">>> void R_CheckPortableExtensions( void ) TODO: GL render params\r\n");
...
#else
	glConfig.vendor_string = "F U N N Y M A N";
	glConfig.renderer_string = "GX";
	glConfig.version_string = "1.0";
	glConfig.extensions_string = "Normally GL extensions would be listed here...";

	glConfig.maxTextureSize = 0; // gets fixed below, 256 is feasible I guess. Purists could set it to 1024 though
...
// DRS: not needed    Sys_Printf("void GL_CheckErrors( void )\r\n");
}
...
Sys_Printf(">>> void R_InitCommands( void ) has TODO\r\n");
...
#endif // DOOMGX will exit directly on error
	}
}
