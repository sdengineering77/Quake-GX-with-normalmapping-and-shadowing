...
public:
	...
	idRenderModel *			ParseModel( idLexer *src, const char *filename, int fileoffset = 0, idRenderModel *target = NULL );
	idRenderModel *			ParseShadowModel( idLexer *src, const char *filename, int fileoffset = 0, idRenderModel *target = NULL );
	void					SetupAreaRefs();
	...
	virtual bool 			ReloadModelFromMapFile( idRenderModel * model );
