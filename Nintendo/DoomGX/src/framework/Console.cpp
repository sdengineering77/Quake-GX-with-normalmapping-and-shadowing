...
void idConsoleLocal::LoadGraphics() {
	charSetShader = declManager->FindMaterial( "textures/bigchars", true, true ); // DRS keep it since it has hard ref
	whiteShader = declManager->FindMaterial( "_white", true, true );
	consoleShader = declManager->FindMaterial( "console", true, true );
}
