...
idUsercmdGenLocal::idUsercmdGenLocal( void ) {
    ...
    Sys_DebugPrintf("idUsercmdGenLocal::idUsercmdGenLocal( void ) size %d\r\n", sizeof(*this));
#endif
...
void idUsercmdGenLocal::MouseMove( void ) {
	...
	// DRS TODO: wiimote integration somehow?
...
// DRS TODO		Sys_DebugPrintf( "idUsercmdGenLocal::MouseMove: Ignoring ridiculous mouse delta.\n" );
...
// DRS TODO revert		Sys_DebugPrintf( "[%3i %3i  = %5.1f %5.1f = %5.1f %5.1f] ", mouseDx, mouseDy, mx, my, strafeMx, strafeMy );
		Sys_Printf( "[%3i %3i  = %5.1f %5.1f = %5.1f %5.1f] \r\n", mouseDx, mouseDy, mx, my, strafeMx, strafeMy );
//	}
...
void idUsercmdGenLocal::Mouse( void ) {
	...
	// DRS TODO: wiimote should force mouse to position
