...
#ifdef DOOMGX
// DRS: Let the disk magic begin. This is a simple, file driven char array
class fileDataPtr {
public:
	fileDataPtr();
	~fileDataPtr();
...
public:
	...
	void			SetFileOffset( int offset ); // DRS added
					// get file time
...
private:
	...
	fileDataPtr		script_p;				// current pointer in the script
...
ID_INLINE void idLexer::SetFileOffset( int offset ) {
