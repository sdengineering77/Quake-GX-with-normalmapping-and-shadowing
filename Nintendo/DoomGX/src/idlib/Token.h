...
// DRS	const char *	whiteSpaceStart_p;				// start of white space before token, only used by idLexer
// DRS	const char *	whiteSpaceEnd_p;				// end of white space before token, only used by idLexer
	int				whiteSpaceStart_p;					// start of white space before token, only used by idLexer
	int				whiteSpaceEnd_p;					// end of white space before token, only used by idLexer
