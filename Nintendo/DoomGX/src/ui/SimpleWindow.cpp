...
idSimpleWindow::idSimpleWindow(idWindow *win) {
    ...
    Sys_DebugPrintf("idSimpleWindow::idSimpleWindow(idWindow *win) size %d\r\n", sizeof(*this));
#endif
...
void * idSimpleWindow::operator new(std::size_t size) throw(std::bad_alloc) {
...
void idSimpleWindow::operator delete(void *pMem) throw() {
