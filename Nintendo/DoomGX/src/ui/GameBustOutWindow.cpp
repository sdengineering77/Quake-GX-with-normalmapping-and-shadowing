...
BOEntity::BOEntity(idGameBustOutWindow* _game) {
    ...
    Sys_DebugPrintf("BOEntity::BOEntity(idGameBustOutWindow* _game) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("BOBrick::BOBrick( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("BOBrick::BOBrick( BOEntity *_ent, float _x, float _y, float _width, float _height ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGameBustOutWindow::idGameBustOutWindow size %d\r\n", sizeof(*this));
#endif
	dc = d;
	gui = g;
	CommonInit();
