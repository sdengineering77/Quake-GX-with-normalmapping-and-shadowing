...
SSDCrossHair::SSDCrossHair() {
    ...
    Sys_DebugPrintf("SSDCrossHair::SSDCrossHair() size %d\r\n", sizeof(*this));
#endif
...
SSDEntity::SSDEntity() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDEntity::SSDEntity() size %d\r\n", sizeof(*this));
#endif
...
SSDMover::SSDMover() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDMover::SSDMover() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDAsteroid::SSDAsteroid() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDAstronaut::SSDAstronaut() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDExplosion::SSDExplosion() size %d\r\n", sizeof(*this));
#endif
...
SSDPoints::SSDPoints() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDPoints::SSDPoints() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDProjectile::SSDProjectile() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("SSDPowerup::SSDPowerup() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGameSSDWindow::idGameSSDWindow size %d\r\n", sizeof(*this));
#endif
	dc = d;
	gui = g;
	CommonInit();
