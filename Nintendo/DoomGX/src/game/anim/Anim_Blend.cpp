...
idAnim::idAnim() {
    ...
    Sys_DebugPrintf("idAnim::idAnim() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idAnim::idAnim( const idDeclModelDef *modelDef, const idAnim *anim ) size %d\r\n", sizeof(*this));
#endif
...
// DRS TODO:			fc.soundShader = declManager->FindSound( token );
// DRS TODO:			if ( fc.soundShader->GetState() == DS_DEFAULTED ) {
// DRS TODO:				gameLocal.Warning( "Sound '%s' not found", token.c_str() );
// DRS TODO:			}
		}
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idAnimBlend::idAnimBlend( void ) size %d\r\n", sizeof(*this));
#endif
...
idDeclModelDef::idDeclModelDef() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idDeclModelDef::idDeclModelDef() size %d\r\n", sizeof(*this));
#endif
...
idAnimator::idAnimator() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idAnimator::idAnimator() size %d\r\n", sizeof(*this));
#endif
