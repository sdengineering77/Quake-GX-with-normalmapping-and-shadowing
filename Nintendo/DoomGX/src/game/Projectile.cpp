...
idProjectile::idProjectile( void ) {
    ...
    Sys_DebugPrintf("idProjectile::idProjectile( void ) size %d\r\n", sizeof(*this));
#endif
...
void idProjectile::DefaultDamageEffect( idEntity *soundEnt, const idDict &projectileDef, const trace_t &collision, const idVec3 &velocity ) {
	...
	if ( *sound != '\0' ) {
// DRS TODO:		soundEnt->StartSoundShader( declManager->FindSound( sound ), SND_CHANNEL_BODY, 0, false, NULL );
	}
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGuidedProjectile::idGuidedProjectile( void ) size %d\r\n", sizeof(*this));
#endif
...
idBFGProjectile::idBFGProjectile() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBFGProjectile::idBFGProjectile() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idDebris::idDebris( void ) size %d\r\n", sizeof(*this));
#endif
...
void idDebris::Launch( void ) {
	...
	if ( *sndName != '\0' ) {
// DRS TODO:		sndBounce = declManager->FindSound( sndName );
		sndBounce = NULL;
	}
