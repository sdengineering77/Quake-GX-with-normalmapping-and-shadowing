...
idSaveGame::idSaveGame( idFile *savefile ) {
    ...
    Sys_DebugPrintf("idSaveGame::idSaveGame( idFile *savefile ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idRestoreGame::idRestoreGame( idFile *savefile ) size %d\r\n", sizeof(*this));
#endif
...
// DRS TODO		shader = declManager->FindSound( name );
	}
}
