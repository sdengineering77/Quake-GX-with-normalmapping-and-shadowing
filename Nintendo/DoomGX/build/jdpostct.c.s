...
start_pass_dpost:
.LFB0:
	.file 1 "d:/Data/Nintendo/DoomGX/src/renderer/jpeg-6/jdpostct.c.c"
	.loc 1 74 0
	.cfi_startproc
.LVL0:
	mflr 0
...
.LCFI2:
	...
	lwz 0,12(31)
	.loc 1 81 0
	lis 11,post_process_1pass@ha
	.loc 1 86 0
	cmpwi 7,0,0
	.loc 1 81 0
	la 0,post_process_1pass@l(11)
	stw 0,4(31)
	.loc 1 86 0
	bne+ 7,.L5
	.loc 1 87 0
...
.LVL26:
	.loc 1 258 0
	lis 9,start_pass_dpost@ha
	.loc 1 259 0
	li 0,0
	.loc 1 258 0
	la 9,start_pass_dpost@l(9)
	.loc 1 257 0
	stw 3,392(30)
	.loc 1 254 0
	mr 31,3
...
.LASF386:
	.string	"d:/Data/Nintendo/DoomGX/src/renderer/jpeg-6/jdpostct.c.c"
.LASF318:
...
.LASF388:
	.string	"jinit_d_post_controller"
.LASF19:
	.string	"JSAMPARRAY"
.LASF84:
