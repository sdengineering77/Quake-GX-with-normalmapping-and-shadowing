...
idFile_Memory::idFile_Memory( void ) {
    ...
    Sys_DebugPrintf("idFile_Memory::idFile_Memory( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFile_Memory::idFile_Memory( const char *name ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFile_Memory::idFile_Memory( const char *name, char *data, int length ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFile_Memory::idFile_Memory( const char *name, const char *data, int length ) size %d\r\n", sizeof(*this));
#endif
...
idFileType_t	idFile_Memory::GetFileType(void) {
	return FILETYPE_MEMORY;
}
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFile_BitMsg::idFile_BitMsg( idBitMsg &msg ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFile_BitMsg::idFile_BitMsg( const idBitMsg &msg ) size %d\r\n", sizeof(*this));
#endif
...
idFileType_t	idFile_BitMsg::GetFileType(void) {
	return FILETYPE_BITMSG;
}
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFile_Permanent::idFile_Permanent( void ) size %d\r\n", sizeof(*this));
#endif
...
idFileType_t	idFile_Permanent::GetFileType(void) {
	return FILETYPE_PERMANENT;
}
...
#ifdef TRACE_CONSTRUCTS
//    Sys_DebugPrintf("idFile_InZip::idFile_InZip( void ) size %d\r\n", sizeof(*this));
#endif
...
idFileType_t	idFile_InZip::GetFileType(void) {
	return FILETYPE_INZIP;
}
