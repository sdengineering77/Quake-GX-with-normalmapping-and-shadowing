...
idTarget_FadeEntity::idTarget_FadeEntity( void ) {
    ...
    Sys_DebugPrintf("idTarget_FadeEntity::idTarget_FadeEntity( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTarget_SetInfluence::idTarget_SetInfluence( void ) size %d\r\n", sizeof(*this));
#endif
...
// DRS TODO		shader = declManager->FindSound( flashInSound );
// DRS TODO player->StartSoundShader( shader, SND_CHANNEL_VOICE, 0, false, NULL );
	} else if ( out && ( flashOutSound.Length() || flashInSound.Length() ) ) {
// DRS TODO		shader = declManager->FindSound( flashOutSound.Length() ? flashOutSound : flashInSound );
// DRS TODO		player->StartSoundShader( shader, SND_CHANNEL_VOICE, 0, false, NULL );
	}
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTarget_Tip::idTarget_Tip( void ) size %d\r\n", sizeof(*this));
#endif
