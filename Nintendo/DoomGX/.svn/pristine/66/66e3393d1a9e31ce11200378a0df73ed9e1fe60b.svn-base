...
#else // DRS TODO: not sure what to do here, replace with stdio as much as possible
// or use idStr all the way? Above statement from ID could mean:
// - don't use default sys lib functions, but use idStr::, cause it is multiplatform
// - don't use id lib for cross platform compatibility
// went for ID, unless a sys version is available for now, doesn't compile as it is anyway
//#define stricmp			idStr::Icmp		// use_idStr_Icmp
//#define _stricmp		idStr::Icmp
#define strcasecmp		idStr::Icmp
//#define strnicmp		idStr::Icmpn
#define _strnicmp		idStr::Icmpn
#define _memicmp		idStr::Icmpn
#define snprintf		idStr::snPrintf
#define _snprintf		idStr::snPrintf
