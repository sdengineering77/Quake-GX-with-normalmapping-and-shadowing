...
idForce_Constant::idForce_Constant( void ) {
    ...
    Sys_DebugPrintf("idForce_Constant::idForce_Constant( void ) size %d\r\n", sizeof(*this));
#endif
...
void idForce_Constant::Save( idSaveGame *savefile ) const {
    Sys_Printf("void idForce_Constant::Save( idSaveGame *savefile )\r\n");
}
...
void idForce_Constant::Restore( idRestoreGame *savefile ) {
    Sys_Printf("void idForce_Constant::Restore( idRestoreGame *savefile )\r\n");
}
...
void idForce_Constant::SetPosition( idPhysics *physics, int id, const idVec3 &point ) {
    Sys_Printf("void idForce_Constant::SetPosition( idPhysics *physics, int id, const idVec3 &point )\r\n");
}
...
void idForce_Constant::SetForce( const idVec3 &force ) {
    Sys_Printf("void idForce_Constant::SetForce( const idVec3 &force )\r\n");
}
...
void idForce_Constant::SetPhysics( idPhysics *physics ) {
    Sys_Printf("void idForce_Constant::SetPhysics( idPhysics *physics )\r\n");
}
...
void idForce_Constant::Evaluate( int time ) {
    Sys_Printf("void idForce_Constant::Evaluate( int time )\r\n");
}
...
void idForce_Constant::RemovePhysics( const idPhysics *phys ) {
    Sys_Printf("void idForce_Constant::RemovePhysics( const idPhysics *phys )\r\n");
}
