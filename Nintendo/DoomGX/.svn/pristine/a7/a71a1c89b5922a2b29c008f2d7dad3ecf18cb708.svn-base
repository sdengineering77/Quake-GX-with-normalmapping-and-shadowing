...
fontInfoEx_t::fontInfoEx_t(void) {
	Sys_DebugPrintf("fontInfoEx_t::fontInfoEx_t() %d %p\r\n", sizeof(*this), this);
}

void * fontInfoEx_t::operator new(std::size_t size) throw(std::bad_alloc) {
...
void fontInfoEx_t::operator delete(void *pMem) throw() {
