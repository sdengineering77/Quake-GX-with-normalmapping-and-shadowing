# 1 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c"
# 1 "c:\\Utils\\devkitPro\\examples\\gamecube\\graphics\\gx\\neheGX\\lesson7\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c"
...
# 8 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
...
# 9 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
...
# 10 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
...
# 11 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
...
# 12 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
...
# 13 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
...
# 101 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
typedef enum ir_position_t {
 WIIUSE_IR_ABOVE,
 WIIUSE_IR_BELOW
} ir_position_t;
# 179 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
# 209 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
# 295 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
# 415 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
typedef struct wiimote_t {
 const int unid;
# 583 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
# 671 "c:/Utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
# 139 "c:/Utils/devkitPro/libogc/include/wiiuse/wpad.h"
...
# 14 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2

# 1 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/build/crate_tpl.h" 1
extern const u8 crate_tpl_end[];
extern const u8 crate_tpl[];
extern const u32 crate_tpl_size;
# 16 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
# 1 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/build/crate.h" 1
# 17 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c" 2
# 33 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c"
...
static GXRModeObj *rmode = ((void *)0);
...
Vector setlight(Mtx view,f32 theta,f32 phi,f32 dist, GXColor litcol, GXColor ambcol,GXColor matcol)
{
 ...
 _theta = (f32)theta*3.14159265358979323846/180.0f;
 _phi = (f32)phi*3.14159265358979323846/180.0f;
 lpos.x = dist * cosf(_phi) * sinf(_theta);
 lpos.y = dist * sinf(_phi);
 lpos.z = dist * cosf(_phi) * cosf(_theta);

 ps_guVecMultiply(view,&lpos,&lpos);

 GX_InitLightPos(&lobj,lpos.x,lpos.y,lpos.z);
 GX_InitLightColor(&lobj,litcol);
 GX_LoadLightObj(&lobj,0x001);


 GX_SetNumChans(1);
    GX_SetChanCtrl(0,1,0,0,0x001,2,2);
    GX_SetChanAmbColor(4,ambcol);
    GX_SetChanMatColor(4,matcol);
...
int main(int argc,char **argv)
{
 ...
 TPL_GetTexture(&crateTPL, 1, &light_tex);
 TPL_GetTexture(&crateTPL, 2, &reflectionlight_tex);
 ...
 while(1) {
  ...
  else if (WPAD_ButtonsHeld(0)&0x0100) zt -= 0.25f;
  else if (WPAD_ButtonsHeld(0)&0x0200) zt += 0.25f;
  else if (WPAD_ButtonsHeld(0)&0x0800) dir -= 0.25f;
  else if (WPAD_ButtonsHeld(0)&0x0400) dir += 0.25f;
  else if (WPAD_ButtonsHeld(0)&0x0008) mode=0;
  else if (WPAD_ButtonsHeld(0)&0x0004) mode=1;
  else if (WPAD_ButtonsHeld(0)&0x1000) mode^=1;
  else if (WPAD_ButtonsHeld(0)&0x0010) vsync^=1;
  ...
  GX_LoadTexMtxImm(nullMtx, 30, 1);
  GX_LoadTexMtxImm(halfMtx, 33, 1);
  ...
  GX_LoadLightObj(&camlightobj, 0x080);
  ...
  GX_SetTexCoordGen(0x1, 1, 4, 30);

  GX_SetTexCoordGen(0x2, 2, 13, 60);


  GX_SetTexCoordGen(0x3, 9, 13, 60);
  ...
  GX_SetTevColorIn(tevstage, 10, 15, 12, 10);
  GX_SetTevColorOp(tevstage, 14, 0, 3, 0, 2);
  GX_SetTevOrder(tevstage, 0xff, 0x100, 4);
  tevstage++;


  GX_SetIndTexOrder(0,0x0,0);
  GX_SetIndTexCoordScale(0,0,0);
  ...
  GX_SetIndTexMatrix(1,offset_mtx, 0);
  ...
  GX_SetTevKColorSel(tevstage, 0x07);
  GX_SetTevColorIn(tevstage, 15, 8, 4, 14);
  GX_SetTevColorOp(tevstage, 0, 0, 0, 1, 0);
  GX_SetTevOrder(tevstage, 0x2, 2, 0xff);
  ...
  GX_SetTevColorIn(tevstage, 15, 8, 4, 0);
  GX_SetTevColorOp(tevstage, 0, 0, 0, 1, 0);
  GX_SetTevOrder(tevstage, 0x3, 1, 0xff);
  tevstage++;
  }
  ...
  GX_SetTevKColorSel(tevstage, 0x07);
  GX_SetTevColorIn(tevstage, 15, 14, 8, 0);
  GX_SetTevColorOp(tevstage, 0, 0, 3, 1, 0);
  GX_SetTevOrder(tevstage, 0x3, 2, 0xff);
  tevstage++;
  ...
  GX_LoadTexObj(&texture, 0);
  GX_LoadTexObj(&light_tex, 1);
  GX_LoadTexObj(&reflectionlight_tex, 2);
# 410 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c"
  ps_guMtxIdentity(model);
  ps_guMtxRotAxisRad(model,&cubeAxis,( (rquad) * 0.01745329252f ));
  ps_guMtxTransApply(model, model, -2.0f, 0.0f,-4.0f);
  ...
  ps_guMtxInverse(modelview,mvi);
  ps_guMtxTranspose(mvi,modelview);
  ...
  GX_Begin(0x80, 0, 24);
   ...
   GX_Normal3f32 ( 0.0f, 0.0f, 0.125f);
   GX_TexCoord2f32(1.0f,1.0f);
# 486 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c"
   GX_Position3f32(-1.0f,-1.0f, 1.0f);
