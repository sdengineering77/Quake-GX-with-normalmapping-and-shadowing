...
void Host_Init (quakeparms_t *parms)
{
	...
	Con_Printf ("Quake-Wii, by id Software, PeterM, EluanCM, Izhido, Piko and DRS (normalmapping and shadowing)\n");
