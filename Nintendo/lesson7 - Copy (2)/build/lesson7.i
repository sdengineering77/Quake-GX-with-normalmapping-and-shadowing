...
int main(int argc,char **argv)
{
 ...
 while(1) {
  ...
  GX_InitLightPos(&camlightobj,lpos.x,lpos.y,lpos.z);
  GX_InitLightColor(&camlightobj,litcolors[0]);
  ...
  GX_SetTevColorIn(0, 10, 15, 8, 15);
  GX_SetTevColorOp(0, 14, 0, 3, 0, 0);
  GX_SetTevOrder(0, 0x3, 2, 4);
  ...
  GX_SetTevColorIn(1, 15, 13, 8, 0);
  GX_SetTevColorOp(1, 0, 0, 3, 0, 0);
  GX_SetTevOrder(1, 0x1, 1, 0xff);
  ...
  ps_guMtxTransApply(model, model, 0.0f,0.0f,-5.0f);
  ...
  GX_Begin(0x80, 0, 24);
   ...
   GX_Normal3f32 ( 0.0f, 0.0f, 0.25f);
   GX_TexCoord2f32(1.0f,1.0f);
# 402 "c:/Utils/devkitPro/examples/gamecube/graphics/gx/neheGX/lesson7/source/lesson7.c"
   GX_Position3f32(-1.0f,-1.0f, 1.0f);
