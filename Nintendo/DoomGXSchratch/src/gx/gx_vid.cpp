...
Sys_Printf(">>> vidrmode->xfbHeight %d vidrmode->efbHeight %d vidrmode->viHeight %d\r\n", vidrmode->xfbHeight, vidrmode->efbHeight, vidrmode->viHeight);
	vidrmode->viWidth += 20;
	vidrmode->viXOrigin -= 10;
	vidrmode->viYOrigin  = 24;
	vidrmode->xfbHeight -= 48;
