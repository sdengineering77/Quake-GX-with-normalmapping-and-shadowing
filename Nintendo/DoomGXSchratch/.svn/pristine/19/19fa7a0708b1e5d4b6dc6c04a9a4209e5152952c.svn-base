...
idClipModel::idClipModel( void ) {
    ...
    Sys_DebugPrintf("idClipModel::idClipModel( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idClipModel::idClipModel( const char *name ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idClipModel::idClipModel( const idTraceModel &trm ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idClipModel::idClipModel( const int renderModelHandle ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idClipModel::idClipModel( const idClipModel *model ) size %d\r\n", sizeof(*this));
#endif
...
idClip::idClip( void ) {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idClip::idClip( void ) size %d\r\n", sizeof(*this));
#endif
