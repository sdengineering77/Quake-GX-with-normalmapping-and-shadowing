...
idRenderModelPrt::idRenderModelPrt() {
    ...
    Sys_DebugPrintf("idRenderModelPrt::idRenderModelPrt() size %d\r\n", sizeof(*this));
#endif
...
void idRenderModelPrt::InitFromFile( const char *fileName ) {
    Sys_Printf("void idRenderModelPrt::InitFromFile( const char *fileName )\r\n");
}
...
void idRenderModelPrt::TouchData( void ) {
    Sys_Printf("void idRenderModelPrt::TouchData( void )\r\n");
}
...
idRenderModel *idRenderModelPrt::InstantiateDynamicModel( const struct renderEntity_s *renderEntity, const struct viewDef_s *viewDef, idRenderModel *cachedModel ) {
    Sys_Printf("idRenderModel *idRenderModelPrt::InstantiateDynamicModel( const struct renderEntity_s *renderEntity, const struct viewDef_s *viewDef, idRenderModel *cachedModel )\r\n");
    return NULL;
}
...
dynamicModel_t idRenderModelPrt::IsDynamicModel() const {
    ...
    Sys_Printf("dynamicModel_t idRenderModelPrt::IsDynamicModel()\r\n");
    return retVal;
}
...
idBounds idRenderModelPrt::Bounds( const struct renderEntity_s *ent ) const {
    ...
    Sys_Printf("idBounds idRenderModelPrt::Bounds( const struct renderEntity_s *ent )\r\n");
    return retVal;
}
...
float idRenderModelPrt::DepthHack() const {
    ...
    Sys_Printf("float idRenderModelPrt::DepthHack()\r\n");
    return retVal;
}
...
int idRenderModelPrt::Memory() const {
    ...
    Sys_Printf("int idRenderModelPrt::Memory()\r\n");
    return retVal;
}
