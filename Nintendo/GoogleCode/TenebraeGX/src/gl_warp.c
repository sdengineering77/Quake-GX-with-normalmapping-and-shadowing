...
#else
#define SKY_TEX 2000 // gx2gl initialises with max 4000, setting this to 10000 will break some stuff!
#endif
...
#else
		glTexImage2D (GL_TEXTURE_2D, 0, GL_RGB5_A1, targa_header.width, targa_header.height, 0, GL_RGBA, GL_UNSIGNED_BYTE, targa_rgba);
#endif
	    free (targa_rgba);
