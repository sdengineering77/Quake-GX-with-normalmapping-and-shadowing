...
#define STENCIL_WIDTH						640
#define STENCIL_HEIGHT						480
#define ZBUFTEX_WIDTH						64
#define ZBUFTEX_HEIGHT					48
...
typedef struct entity_s
{
	...
	int						numlights;
	entitylight_t			lightdata[MAX_ENTITYLIGHTS];
