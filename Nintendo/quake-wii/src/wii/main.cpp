...
namespace quake
{
	namespace main
	{
		...
		static void init()
		{
			...
			rmode = VIDEO_GetPreferredMode(&TVMpal480IntDf);
...
//		int main_thread_function(void)
		{
			u32 level, real_heap_size;
			check_pak_file_exists(); // DRS: some thread security with new versions of ogc?
