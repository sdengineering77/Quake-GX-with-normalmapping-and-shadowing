...
rvGEItemPropsImagePage::rvGEItemPropsImagePage ( idDict* dict )
{
    ...
    Sys_DebugPrintf("rvGEItemPropsImagePage::rvGEItemPropsImagePage ( idDict* dict ) size %d\r\n", sizeof(*this));
#endif
...
{
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("rvGEItemPropsTextPage::rvGEItemPropsTextPage ( idDict* dict ) size %d\r\n", sizeof(*this));
#endif
...
{
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("rvGEItemPropsKeysPage::rvGEItemPropsKeysPage ( idDict* dict, rvGEWindowWrapper* wrapper ) size %d\r\n", sizeof(*this));
#endif
