...
idGLWidget::idGLWidget()
{
    ...
    Sys_DebugPrintf("idGLWidget::idGLWidget() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGLDrawableModel::idGLDrawableModel(const char *name) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGLDrawableModel::idGLDrawableModel() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGLDrawable::idGLDrawable() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idGLDrawableWorld::idGLDrawableWorld() size %d\r\n", sizeof(*this));
#endif
