...
NSBitmapImageRep::NSBitmapImageRep( void ) {
    ...
    Sys_DebugPrintf("NSBitmapImageRep::NSBitmapImageRep( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("NSBitmapImageRep::NSBitmapImageRep( const char *filename ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("NSBitmapImageRep::NSBitmapImageRep( int wide, int high ) size %d\r\n", sizeof(*this));
#endif
