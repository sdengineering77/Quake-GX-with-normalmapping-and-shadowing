...
idLedge::idLedge( void ) {
    ...
    Sys_DebugPrintf("idLedge::idLedge( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idLedge::idLedge( const idVec3 &v1, const idVec3 &v2, const idVec3 &gravityDir, idBrushBSPNode *n ) size %d\r\n", sizeof(*this));
#endif
