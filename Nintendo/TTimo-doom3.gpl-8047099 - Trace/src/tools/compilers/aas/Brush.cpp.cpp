...
idBrushSide::idBrushSide( void ) {
    ...
    Sys_DebugPrintf("idBrushSide::idBrushSide( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBrushSide::idBrushSide( const idPlane &plane, int planeNum ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBrush::idBrush( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBrushList::idBrushList( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBrushMap::idBrushMap( const idStr &fileName, const idStr &ext ) size %d\r\n", sizeof(*this));
#endif
