...
idBrushBSPPortal::idBrushBSPPortal( void ) {
    ...
    Sys_DebugPrintf("idBrushBSPPortal::idBrushBSPPortal( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBrushBSPNode::idBrushBSPNode( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idBrushBSP::idBrushBSP( void ) size %d\r\n", sizeof(*this));
#endif
