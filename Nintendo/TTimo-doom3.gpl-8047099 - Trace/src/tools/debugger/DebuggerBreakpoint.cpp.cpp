...
rvDebuggerBreakpoint::rvDebuggerBreakpoint ( const char* filename, int linenumber, int id )
{
    ...
    Sys_DebugPrintf("rvDebuggerBreakpoint::rvDebuggerBreakpoint ( const char* filename, int linenumber, int id ) size %d\r\n", sizeof(*this));
#endif
...
{
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("rvDebuggerBreakpoint::rvDebuggerBreakpoint ( rvDebuggerBreakpoint& bp ) size %d\r\n", sizeof(*this));
#endif
