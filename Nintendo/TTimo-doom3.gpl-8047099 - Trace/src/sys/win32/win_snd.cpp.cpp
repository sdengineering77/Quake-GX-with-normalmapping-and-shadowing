...
idAudioHardwareWIN32::idAudioHardwareWIN32() {
    ...
    Sys_DebugPrintf("idAudioHardwareWIN32::idAudioHardwareWIN32() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idAudioBufferWIN32::idAudioBufferWIN32( LPDIRECTSOUNDBUFFER apDSBuffer, dword dwDSBufferSize, idWaveFile* pWaveFile ) size %d\r\n", sizeof(*this));
#endif
