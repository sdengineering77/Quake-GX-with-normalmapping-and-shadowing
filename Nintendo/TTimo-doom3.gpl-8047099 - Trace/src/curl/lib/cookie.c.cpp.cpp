...
{
    SYS_Printf("voidfree_cookiemess(struct Cookie *co)\r\n");
}
...
static bool tailmatch(const char *little, const char *bigone)
{
    ...
    SYS_Printf("bool tailmatch(const char *little, const char *bigone)\r\n");
    return retVal;
}
...
struct CookieInfo *Curl_cookie_init(struct SessionHandle *data,
                                    ...
                                    bool newsession)
{
    SYS_Printf("CookieInfo *Curl_cookie_init(struct SessionHandle *data,                                    char *file,                                    struct CookieInfo *inc,                                    bool newsession)\r\n");
    return NULL;
}
...
struct Cookie *Curl_cookie_getlist(struct CookieInfo *c,
                                   char *host, char *path, bool secure)
{
    SYS_Printf("Cookie *Curl_cookie_getlist(struct CookieInfo *c,                                   char *host, char *path, bool secure)\r\n");
    return NULL;
}
...
{
    SYS_Printf("void Curl_cookie_freelist(struct Cookie *co)\r\n");
}
...
{
    SYS_Printf("void Curl_cookie_cleanup(struct CookieInfo *c)\r\n");
}
...
int Curl_cookie_output(struct CookieInfo *c, char *dumphere)
{
    ...
    SYS_Printf("int Curl_cookie_output(struct CookieInfo *c, char *dumphere)\r\n");
    return retVal;
}
