...
idExportOptions::idExportOptions( const char *commandline, const char *ospath ) {
    ...
    Sys_DebugPrintf("idExportOptions::idExportOptions( const char *commandline, const char *ospath ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idExportJoint::idExportJoint() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idExportModel::idExportModel() size %d\r\n", sizeof(*this));
#endif
