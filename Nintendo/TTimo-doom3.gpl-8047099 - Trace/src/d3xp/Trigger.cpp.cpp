...
idTrigger::idTrigger() {
    ...
    Sys_DebugPrintf("idTrigger::idTrigger() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_Multi::idTrigger_Multi( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_EntityName::idTrigger_EntityName( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_Timer::idTrigger_Timer( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_Count::idTrigger_Count( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_Hurt::idTrigger_Hurt( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_Touch::idTrigger_Touch( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idTrigger_Flag::idTrigger_Flag( void ) size %d\r\n", sizeof(*this));
#endif
