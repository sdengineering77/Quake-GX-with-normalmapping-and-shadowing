...
idItem::idItem() {
    ...
    Sys_DebugPrintf("idItem::idItem() size %d\r\n", sizeof(*this));
#endif
...
idItemPowerup::idItemPowerup() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idItemPowerup::idItemPowerup() size %d\r\n", sizeof(*this));
#endif
...
idItemTeam::idItemTeam() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idItemTeam::idItemTeam() size %d\r\n", sizeof(*this));
#endif
...
idObjective::idObjective() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idObjective::idObjective() size %d\r\n", sizeof(*this));
#endif
...
idMoveableItem::idMoveableItem() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idMoveableItem::idMoveableItem() size %d\r\n", sizeof(*this));
#endif
...
idObjectiveComplete::idObjectiveComplete() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idObjectiveComplete::idObjectiveComplete() size %d\r\n", sizeof(*this));
#endif
