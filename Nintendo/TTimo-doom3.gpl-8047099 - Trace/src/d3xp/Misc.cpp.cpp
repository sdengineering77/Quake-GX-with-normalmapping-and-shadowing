...
idShockwave::idShockwave() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idShockwave::idShockwave() size %d\r\n", sizeof(*this));
#endif
...
idFuncMountedObject::idFuncMountedObject() {
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFuncMountedObject::idFuncMountedObject() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idFuncMountedWeapon::idFuncMountedWeapon() size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idPortalSky::idPortalSky( void ) size %d\r\n", sizeof(*this));
#endif
