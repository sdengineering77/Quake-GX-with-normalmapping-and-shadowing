...
#define GXGL_GetProcAddress(name) _glGetProcAddress(name)
...
#define SAFE_GET_PROC( func, type, name) \
																		\
	func = (type)GXGL_GetProcAddress (name)
...
// - DC - 
#if !defined(SDL) && !defined (__glx__) && !defined (GXGL)
...
#define	MAXSHADOWLIGHTS	1 //256 //Maximum number of (client side) lights in a map
#define MAX_VOLUME_VERTICES 1 //10000 //should be multiple of 4 because this is used as a vertex array
								 //with GL_QUADS
#define MAXUSEDSHADOWLIGHS 1 //128 //Maximum number of lights that can be used in a single frame
