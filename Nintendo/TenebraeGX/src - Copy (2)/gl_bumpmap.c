...
// DRS TODO: I don't care about this right now
#ifndef GXGL
...
void PrintScreenPos(vec3_t v) {
	...
	gxgl_glGetDoublev (GL_MODELVIEW_MATRIX, Dworld_matrix);
	gxgl_glGetDoublev (GL_PROJECTION_MATRIX, Dproject_matrix);
...
// DRS TODO: Dit moet even opnieuw in simpele vorm, enkel texmap
#ifndef GXGL	
	GL_DrawAlpha();
	GL_EnableDiffuseShader ();
