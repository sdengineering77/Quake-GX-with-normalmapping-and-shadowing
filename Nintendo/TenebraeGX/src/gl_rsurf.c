...
// DRS TODO: doable, from: http://www.opengl.org/wiki/Mathematics_of_glTexGen
//  for(i=0; i<totalverts; i++)
// {
//   myTexCoord[i].s = dot4D(myVertex[i], myPlane_S);
//   myTexCoord[i].t = dot4D(myVertex[i], myPlane_T);
// } 
// In GX this calculates to TEXMTX2D = 
// myPlane_S[0], myPlane_S[1], myPlane_S[2], myPlane_S[3]
// myPlane_T[0], myPlane_T[1], myPlane_T[2], myPlane_T[3]
// TexCoordGen(TEXMTX2D, GX_POS);                    
