# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
# 27 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
...
# 28 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c" 2


vec3_t object_vieworg;
# 40 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void GL_EnableDiffuseShader () {
 ...
 glDisable(0x0DE1);
 glEnable(0x8513);
 glBindTexture(0x8513, normcube_texture_object);
 ...
 glTexEnvf (0x2300, 0x2200, 0x8570);
    ...
    glTexEnvf (0x2300, 0x8581, 0x1702);
    glTexEnvf (0x2300, 0x8571, 0x86AF);
}
...
void GL_EnableSpecularShader () {
 ...
 if ( gl_cardtype == GEFORCE || gl_cardtype == GEFORCE3 ) {
  ...
  qglCombinerParameteriNV(0x854E, 2);
  qglCombinerParameterfvNV(0x852A, &scaler[0]);


  qglCombinerInputNV(0x8550, 0x1907, 0x8523, 0x84C1, 0x8538, 0x1907);
  qglCombinerInputNV(0x8550, 0x1907, 0x8524, 0x84C0, 0x8538, 0x1907);
  qglCombinerOutputNV(0x8550, 0x1907, 0x852E, 0x8530, 0x8530, 0x0, 0x0, 0x1, 0x0, 0x0);


  qglCombinerOutputNV(0x8550, 0x1906, 0x8530, 0x8530, 0x8530, 0x0, 0x0, 0x0, 0x0, 0x0);


  qglCombinerOutputNV(0x8551, 0x1907, 0x8530, 0x8530, 0x8530, 0x0, 0x0, 0x0, 0x0, 0x0);


  qglCombinerInputNV(0x8551, 0x1906, 0x8523, 0x852E, 0x8536, 0x1905);
  qglCombinerInputNV(0x8551, 0x1906, 0x8524, 0x852E, 0x8536, 0x1905);
  qglCombinerInputNV(0x8551, 0x1906, 0x8525, 0x852A, 0x853D, 0x1905);
  qglCombinerInputNV(0x8551, 0x1906, 0x8526, 0x0, 0x8537, 0x1906);
  qglCombinerOutputNV(0x8551, 0x1906, 0x8530, 0x8530, 0x852E, 0x853F, 0x0, 0x0, 0x0, 0x0);



  qglFinalCombinerInputNV(0x8529, 0x852E, 0x8536, 0x1906);
...
void GL_EnableColorShader (qboolean specular) {
# 164 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 GL_SelectTexture(0x84C0);
...
void GL_DisableColorShader (qboolean specular) {
# 188 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 GL_DisableMultitexture();
 glEnable(0x0DE1);
...
# 294 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_WorldToObjectMatrix(entity_t *e, matrix_4x4 result)
{
 matrix_4x4 world;
 ...
 glLoadIdentity();
 R_RotateForEntity (e);
 glGetFloatv (0x0BA6, &world[0][0]);
 glPopMatrix();
 MatrixAffineInverse(world,result);
}
# 314 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void GL_SetupCubeMapMatrix(qboolean world) {
...
# 354 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawWorldLLV(lightcmd_t *lightCmds) {
 ...
 {lightOr[0]=currentshadowlight->origin[0];lightOr[1]=currentshadowlight->origin[1];lightOr[2]=currentshadowlight->origin[2];};
 ...
 while (1) {
  ...
  for (i=0; i<num; i++, v+= 7) {
   ...
   lightPos+=2;
# 408 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
   glTexCoord3fv(&lightCmds[lightPos].asFloat);
   lightPos+=3;

   qglMultiTexCoord2fARB(0x84C1, v[3], v[4]);
   glVertex3fv(&v[0]);
  }
  glEnd();
 }
...
# 428 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawWorldHAV(lightcmd_t *lightCmds) {
 ...
 while (1) {
  ...
  for (i=0; i<num; i++, v+= 7) {
   ...
   {lightDir[0]=lightP[0];lightDir[1]=lightP[1];lightDir[2]=lightP[2];};
   VectorNormalize(lightDir);
   lightPos+=3;


   {H[0]=r_refdef.vieworg[0]-v[0];H[1]=r_refdef.vieworg[1]-v[1];H[2]=r_refdef.vieworg[2]-v[2];};
   VectorNormalize(H);


   if (surf->flags & 2) {
    tsH[2] = -(H[0]*surf->plane->normal[0]+H[1]*surf->plane->normal[1]+H[2]*surf->plane->normal[2]);
   } else {
    tsH[2] = (H[0]*surf->plane->normal[0]+H[1]*surf->plane->normal[1]+H[2]*surf->plane->normal[2]);
   }

   tsH[1] = -(H[0]*surf->texinfo->vecs[1][0]+H[1]*surf->texinfo->vecs[1][1]+H[2]*surf->texinfo->vecs[1][2]);
   tsH[0] = (H[0]*surf->texinfo->vecs[0][0]+H[1]*surf->texinfo->vecs[0][1]+H[2]*surf->texinfo->vecs[0][2]);

   {tsH[0]=lightDir[0]+tsH[0];tsH[1]=lightDir[1]+tsH[1];tsH[2]=lightDir[2]+tsH[2];};
...
# 504 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
...
# 560 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawWorldWV(lightcmd_t *lightCmds, qboolean specular) {
...
# 618 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
...
# 664 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
...
# 710 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
...
# 756 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawBrushWV(entity_t *e, qboolean specular) {
...
# 805 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawBrushObjectLight(entity_t *e,void (*BrushGeoSender) (entity_t *e)) {
...
void R_DrawAliasFrameLLV (aliashdr_t *paliashdr, aliasframeinstant_t *instant)
{
 ...
 glVertexPointer(3, 0x1406, 0, instant->vertices);
 glEnableClientState(0x8074);

 qglClientActiveTextureARB(0x84C0);
 glTexCoordPointer(3, 0x1406, 0, linstant->tslights);
 glEnableClientState(0x8078);

 qglClientActiveTextureARB(0x84C1);
 glTexCoordPointer(2, 0x1406, 0, texcoords);
 glEnableClientState(0x8078);

 glDrawElements(0x0004,linstant->numtris*3,0x1405,&linstant->indecies[0]);
# 865 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
...
void R_DrawAliasFrameHAV (aliashdr_t *paliashdr, aliasframeinstant_t *instant)
{
 ...
 qglClientActiveTextureARB(0x84C0);
 glTexCoordPointer(3, 0x1406, 0, linstant->tshalfangles);
 glEnableClientState(0x8078);
 ...
 glDrawElements(0x0004,linstant->numtris*3,0x1405,&linstant->indecies[0]);
# 906 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 glDisableClientState(0x8074);
 glDisableClientState(0x8078);
 qglClientActiveTextureARB(0x84C0);
 glDisableClientState(0x8078);
...
# 921 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawAliasFrameWV (aliashdr_t *paliashdr, aliasframeinstant_t *instant, qboolean specular) {
 ...
 qglClientActiveTextureARB(0x84C0);
 glTexCoordPointer(3, 0x1406, 0, instant->vertices);
 glEnableClientState(0x8078);
 ...
 if ( gl_cardtype == GENERIC || gl_cardtype == GEFORCE ) {
  ...
  glNormalPointer(0x1406, 0, instant->normals);
  glEnableClientState(0x8075);

  glEnableClientState(0x8076);
  glColorPointer(3, 0x1406, 0, linstant->colors);
 }

 glDrawElements(0x0004,linstant->numtris*3,0x1405,&linstant->indecies[0]);
# 967 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 if ( gl_cardtype == GENERIC || gl_cardtype == GEFORCE ) {
...
void PrintScreenPos(vec3_t v) {
 ...
 gxgl_glGetDoublev (0x0BA6, Dworld_matrix);
 gxgl_glGetDoublev (0x0BA7, Dproject_matrix);
 glGetIntegerv (0x0BA2, Iviewport);
 gluProject(v[0], v[1], v[2],
       Dworld_matrix, Dproject_matrix, Iviewport, &px, &py, &pz);
 Con_Printf("Pos: %f %f %f\n", px, py, pz);
}
# 1001 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawAliasObjectLight(entity_t *e,void (*AliasGeoSender) (aliashdr_t *paliashdr, aliasframeinstant_t* instant))
{
 ...
 for (i=0;i<maxnumsurf;++i){
  ...
  {oldlightpos[0]=currentshadowlight->origin[0];oldlightpos[1]=currentshadowlight->origin[1];oldlightpos[2]=currentshadowlight->origin[2];};
  {currentshadowlight->oldlightorigin[0]=currentshadowlight->origin[0];currentshadowlight->oldlightorigin[1]=currentshadowlight->origin[1];currentshadowlight->oldlightorigin[2]=currentshadowlight->origin[2];};
...
# 1071 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawSpriteModelWV (entity_t *e)
{
 vec3_t point;
 ...
 qglMultiTexCoord2fARB(0x84C1, 0, 1);
 VectorMA (e->origin, frame->down, up, point);
 VectorMA (point, frame->left, right, point);
 glTexCoord3fv(point);
 glVertex3fv (point);

 qglMultiTexCoord2fARB(0x84C1, 0, 0);
 VectorMA (e->origin, frame->up, up, point);
 VectorMA (point, frame->left, right, point);
 glTexCoord3fv(point);
 glVertex3fv (point);

 qglMultiTexCoord2fARB(0x84C1, 1, 0);
 VectorMA (e->origin, frame->up, up, point);
 VectorMA (point, frame->right, right, point);
 glTexCoord3fv(point);
 glVertex3fv (point);

 qglMultiTexCoord2fARB(0x84C1, 1, 1);
 VectorMA (e->origin, frame->down, up, point);
 VectorMA (point, frame->right, right, point);
 glTexCoord3fv(point);
 glVertex3fv (point);
...
# 1139 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawWorldBumpedGF() {
 ...
 glDepthMask (0);
 glShadeModel (0x1D01);
# 1208 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 glColorMask(1, 1, 1, 0);
 glBlendFunc (0x1, 0x1);
 glEnable (0x0BE2);
 ...
 R_DrawWorldWV(currentshadowlight->lightCmds, 0);
 GL_DisableColorShader (0);
# 1276 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 glColor3f (1,1,1);
 glDisable (0x0BE2);
...
# 1381 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
void R_DrawAliasBumped(aliashdr_t *paliashdr, aliasframeinstant_t *instant) {
# 1402 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
 glColorMask(1, 1, 1, 0);
 glBlendFunc (0x1, 0x1);
 glEnable (0x0BE2);
 ...
 GL_EnableColorShader (0);
 R_DrawAliasFrameWV(paliashdr,instant, 0);
 GL_DisableColorShader (0);
# 1455 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpmap.c"
}
