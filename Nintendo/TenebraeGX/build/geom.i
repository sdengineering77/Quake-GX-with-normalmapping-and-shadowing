# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
# 42 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/include/gluos.h" 1
# 43 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 44 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c" 2
...
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c" 2
...
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
        ...
        GLUvertex *v );
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c" 2
...
GLdouble __gl_edgeEval( GLUvertex *u, GLUvertex *v, GLUvertex *w )
{
# 66 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
  GLdouble gapL, gapR;

  (((((u)->s < (v)->s) || ((u)->s == (v)->s && (u)->t <= (v)->t)) && (((v)->s < (w)->s) || ((v)->s == (w)->s && (v)->t <= (w)->t))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c", 68, __FUNCTION__, "VertLeq( u, v ) && VertLeq( v, w )"));
...
GLdouble __gl_edgeSign( GLUvertex *u, GLUvertex *v, GLUvertex *w )
{
  ...
  (((((u)->s < (v)->s) || ((u)->s == (v)->s && (u)->t <= (v)->t)) && (((v)->s < (w)->s) || ((v)->s == (w)->s && (v)->t <= (w)->t))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c", 92, __FUNCTION__, "VertLeq( u, v ) && VertLeq( v, w )"));
...
GLdouble __gl_transEval( GLUvertex *u, GLUvertex *v, GLUvertex *w )
{
# 121 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
  GLdouble gapL, gapR;

  (((((u)->t < (v)->t) || ((u)->t == (v)->t && (u)->s <= (v)->s)) && (((v)->t < (w)->t) || ((v)->t == (w)->t && (v)->s <= (w)->s))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c", 123, __FUNCTION__, "TransLeq( u, v ) && TransLeq( v, w )"));
...
GLdouble __gl_transSign( GLUvertex *u, GLUvertex *v, GLUvertex *w )
{
  ...
  (((((u)->t < (v)->t) || ((u)->t == (v)->t && (u)->s <= (v)->s)) && (((v)->t < (w)->t) || ((v)->t == (w)->t && (v)->s <= (w)->s))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c", 147, __FUNCTION__, "TransLeq( u, v ) && TransLeq( v, w )"));
...
# 210 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
    GLUvertex *o2, GLUvertex *d2,
    GLUvertex *v )
...
{
  GLdouble z1, z2;
# 228 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.c"
