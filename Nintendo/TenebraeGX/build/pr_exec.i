# 1 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
# 21 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
...
# 22 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c" 2
...
# 150 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
...
# 222 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
void PR_Profile_f (void)
{
 dfunction_t *f, *best;
 int max;
...
# 261 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
void PR_RunError (char *error, ...)
{
 va_list argptr;
 char string[1024];
...
# 294 "d:/Data/Nintendo/TenebraeGX/src/pr_exec.c"
int PR_EnterFunction (dfunction_t *f)
{
 ...
 for (i=0 ; i<f->numparms ; i++)
 {
  ...
  {
   ((int *)pr_globals)[o] = ((int *)pr_globals)[4 +i*3+j];
   o++;
  }
 }
...
void PR_ExecuteProgram (func_t fnum)
{
 ...
 if (!fnum || fnum >= progs->numfunctions)
 {
  if (pr_global_struct->self)
   ED_Print (((edict_t *)((byte *)sv.edicts + pr_global_struct->self)));
...
while (1)
{
 ...
 case OP_NOT_FNC:
  ...
  break;
 case OP_NOT_ENT:
  c->_float = (((edict_t *)((byte *)sv.edicts + a->edict)) == sv.edicts);
  break;
 ...
 case OP_ADDRESS:
  ed = ((edict_t *)((byte *)sv.edicts + a->edict));
 ...
 case OP_DONE:
 case OP_RETURN:
  pr_globals[1] = pr_globals[st->a];
  pr_globals[1 +1] = pr_globals[st->a+1];
  pr_globals[1 +2] = pr_globals[st->a+2];
