# 1 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
# 21 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
# 22 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c" 2
# 33 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
char *PF_VarString (int first)
{
 ...
 {
  strcat (out, (pr_strings + *(string_t *)&pr_globals[(4 +i*3)]));
 }
 return out;
}
# 57 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_error (void)
{
 char *s;
 edict_t *ed;
 ...
 ed = ((edict_t *)((byte *)sv.edicts + pr_global_struct->self));
 ED_Print (ed);

 Host_Error ("Program error");
}
# 81 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
# 106 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_makevectors (void)
{
 AngleVectors ((&pr_globals[4]), pr_global_struct->v_forward, pr_global_struct->v_right, pr_global_struct->v_up);
}
# 120 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_setorigin (void)
{
 edict_t *e;
 float *org;

 e = ((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4]));
 org = (&pr_globals[7]);
 {e->v.origin[0]=org[0];e->v.origin[1]=org[1];e->v.origin[2]=org[2];};
 SV_LinkEdict (e, 0);
}
...
void SetMinMaxSize (edict_t *e, float *min, float *max, qboolean rotate)
{
 ...
 if (!rotate)
 {
  {rmin[0]=min[0];rmin[1]=min[1];rmin[2]=min[2];};
  {rmax[0]=max[0];rmax[1]=max[1];rmax[2]=max[2];};
 }
 else
 {
  ...
  a = angles[1]/180 * 3.14159265358979323846;
  ...
  {bounds[0][0]=min[0];bounds[0][1]=min[1];bounds[0][2]=min[2];};
  {bounds[1][0]=max[0];bounds[1][1]=max[1];bounds[1][2]=max[2];};
 ...
 {e->v.mins[0]=rmin[0];e->v.mins[1]=rmin[1];e->v.mins[2]=rmin[2];};
 {e->v.maxs[0]=rmax[0];e->v.maxs[1]=rmax[1];e->v.maxs[2]=rmax[2];};
 {e->v.size[0]=max[0]-min[0];e->v.size[1]=max[1]-min[1];e->v.size[2]=max[2]-min[2];};

 SV_LinkEdict (e, 0);
}
# 215 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
# 234 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_setmodel (void)
{
 ...
 e = ((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4]));
 m = (pr_strings + *(string_t *)&pr_globals[7]);
...
# 274 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_bprint (void)
{
 char *s;
...
# 291 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_sprint (void)
{
 char *s;
 client_t *client;
 ...
 entnum = NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4])));
 s = PF_VarString(1);
 ...
 MSG_WriteChar (&client->message,8);
 MSG_WriteString (&client->message, s );
}
# 322 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_centerprint (void)
{
 ...
 MSG_WriteChar (&client->message,26);
 MSG_WriteString (&client->message, s );
}
# 351 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_normalize (void)
{
 ...
 {(&pr_globals[1])[0]=newvalue[0];(&pr_globals[1])[1]=newvalue[1];(&pr_globals[1])[2]=newvalue[2];};
}
# 382 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_vlen (void)
{
 float *value1;
 float new;
...
# 402 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_vectoyaw (void)
{
 ...
 {
  yaw = (int) (atan2(value1[1], value1[0]) * 180 / 3.14159265358979323846);
  if (yaw < 0)
   yaw += 360;
 }
...
# 429 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_vectoangles (void)
{
 ...
 else
 {
  ...
  pitch = (int) (atan2(value1[2], forward) * 180 / 3.14159265358979323846);
  if (pitch < 0)
   pitch += 360;
 }

 (pr_globals[1 +0]) = pitch;
 (pr_globals[1 +1]) = yaw;
 (pr_globals[1 +2]) = 0;
}
# 479 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_random (void)
{
 float num;
...
# 495 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
# 515 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_BasicEmitter(void)
{
 ...
 org = (&pr_globals[4]);
 pcount = (pr_globals[7]);
 name = (pr_strings + *(string_t *)&pr_globals[10]);

 size = 8 + strlen(name) + 16;


 if (sv.datagram.cursize > 16384 -size)
  return;

 MSG_WriteByte(&sv.datagram, 35);
...
# 547 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_ExtendedEmitter(void)
{
 ...
 org = (&pr_globals[4]);
 vel = (&pr_globals[7]);
 pcount = (pr_globals[10]);
 tick = (pr_globals[13]);
 life = (pr_globals[16]);
 name = (pr_strings + *(string_t *)&pr_globals[19]);
...
void PF_ambientsound (void)
{
 ...
 pos = (&pr_globals[4]);
 samp = (pr_strings + *(string_t *)&pr_globals[7]);
 vol = (pr_globals[10]);
 attenuation = (pr_globals[13]);
...
# 638 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_sound (void)
{
 char *sample;
 int channel;
 ...
 entity = ((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4]));
 channel = (pr_globals[7]);
 sample = (pr_strings + *(string_t *)&pr_globals[10]);
 volume = (pr_globals[13]) * 255;
 attenuation = (pr_globals[16]);
...
# 671 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_break (void)
{
...
# 689 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_traceline (void)
{
 ...
 v1 = (&pr_globals[4]);
 v2 = (&pr_globals[7]);
 nomonsters = (pr_globals[10]);
 ent = ((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[13]));
 ...
 {pr_global_struct->trace_endpos[0]=trace.endpos[0];pr_global_struct->trace_endpos[1]=trace.endpos[1];pr_global_struct->trace_endpos[2]=trace.endpos[2];};
 {pr_global_struct->trace_plane_normal[0]=trace.plane.normal[0];pr_global_struct->trace_plane_normal[1]=trace.plane.normal[1];pr_global_struct->trace_plane_normal[2]=trace.plane.normal[2];};
 pr_global_struct->trace_plane_dist = trace.plane.dist;
 if (trace.ent)
  pr_global_struct->trace_ent = ((byte *)trace.ent - (byte *)sv.edicts);
 else
  pr_global_struct->trace_ent = ((byte *)sv.edicts - (byte *)sv.edicts);
}
# 758 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
int PF_newcheckclient (int check)
{
 ...
 {org[0]=ent->v.origin[0]+ent->v.view_ofs[0];org[1]=ent->v.origin[1]+ent->v.view_ofs[1];org[2]=ent->v.origin[2]+ent->v.view_ofs[2];};
...
# 832 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
void PF_checkclient (void)
{
 ...
 {
  (((int *)pr_globals)[1] = ((byte *)sv.edicts - (byte *)sv.edicts));
  return;
 }


 self = ((edict_t *)((byte *)sv.edicts + pr_global_struct->self));
 {view[0]=self->v.origin[0]+self->v.view_ofs[0];view[1]=self->v.origin[1]+self->v.view_ofs[1];view[2]=self->v.origin[2]+self->v.view_ofs[2];};
...
c_invis++;
 (((int *)pr_globals)[1] = ((byte *)ent - (byte *)sv.edicts));
}
# 884 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_stuffcmd (void)
{
 ...
 str = (pr_strings + *(string_t *)&pr_globals[7]);
...
# 910 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_localcmd (void)
{
 char *str;

 str = (pr_strings + *(string_t *)&pr_globals[4]);
 Cbuf_AddText (str);
}
# 925 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_cvar (void)
{
 char *str;
 ...
 (pr_globals[1]) = Cvar_VariableValue (str);
}
# 941 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_cvar_set (void)
{
 char *var, *val;

 var = (pr_strings + *(string_t *)&pr_globals[4]);
 val = (pr_strings + *(string_t *)&pr_globals[7]);

 Cvar_Set (var, val);
}
# 960 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_findradius (void)
{
 ...
 ent = ((edict_t *)( (byte *)sv.edicts + pr_edict_size));
 for (i=1 ; i<sv.num_edicts ; i++, ent = ((edict_t *)( (byte *)ent + pr_edict_size)))
 {
  if (ent->free)
   continue;
  if (ent->v.solid == 0)
  ...
  ent->v.chain = ((byte *)chain - (byte *)sv.edicts);
  chain = ent;
 }

 (((int *)pr_globals)[1] = ((byte *)chain - (byte *)sv.edicts));
}
...
static char pr_string_temp[16][128];
...
static char *PR_GetTempString(void)
{
 ...
 pr_string_tempindex = (pr_string_tempindex + 1) % 16;
 return s;
}
...
void PF_vtos (void)
{
 char *s;
 s = PR_GetTempString();
 sprintf (s, "'%5.1f %5.1f %5.1f'", (&pr_globals[4])[0], (&pr_globals[4])[1], (&pr_globals[4])[2]);
 (*(int *)&pr_globals[1]) = s - pr_strings;
}
# 1051 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_Spawn (void)
{
 edict_t *ed;
 ed = ED_Alloc();
 (((int *)pr_globals)[1] = ((byte *)ed - (byte *)sv.edicts));
}
...
void PF_Remove (void)
{
 ...
 ed = ((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4]));
 ED_Free (ed);
}
...
void PF_Find (void)
# 1118 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
{
 int e;
 int f;
 char *s, *t;
 ...
 e = NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4])));
 f = (*(int *)&pr_globals[7]);
 s = (pr_strings + *(string_t *)&pr_globals[10]);
 if (!s)
...
{
 (*(int *)&pr_globals[1]) = (*(int *)&pr_globals[4]);
}
...
void PF_precache_sound (void)
{
 ...
 s = (pr_strings + *(string_t *)&pr_globals[4]);
 (*(int *)&pr_globals[1]) = (*(int *)&pr_globals[4]);
...
void PF_eprint (void)
{
 ED_PrintNum (NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4]))));
}
# 1239 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_walkmove (void)
{
 ...
 ent = ((edict_t *)((byte *)sv.edicts + pr_global_struct->self));
 yaw = (pr_globals[4]);
 dist = (pr_globals[7]);

 if ( !( (int)ent->v.flags & (512|1|2) ) )
 {
  (pr_globals[1]) = 0;
  return;
 }

 yaw = yaw*3.14159265358979323846*2 / 360;
 ...
 (pr_globals[1]) = SV_movestep(ent, move, 1);
...
# 1282 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_droptofloor (void)
{
 ...
 {end[0]=ent->v.origin[0];end[1]=ent->v.origin[1];end[2]=ent->v.origin[2];};
 end[2] -= 256;
 ...
 {
  {ent->v.origin[0]=trace.endpos[0];ent->v.origin[1]=trace.endpos[1];ent->v.origin[2]=trace.endpos[2];};
  SV_LinkEdict (ent, 0);
...
# 1314 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_lightstyle (void)
{
 ...
 for (j=0, client = svs.clients ; j<svs.maxclients ; j++, client++)
  ...
  {
   MSG_WriteChar (&client->message, 12);
...
void PF_rint (void)
{
 ...
 f = (pr_globals[4]);
 if (f > 0)
  (pr_globals[1]) = (int)(f + 0.5);
 else
  (pr_globals[1]) = (int)(f - 0.5);
}
void PF_floor (void)
{
 (pr_globals[1]) = floor((pr_globals[4]));
}
void PF_ceil (void)
{
 (pr_globals[1]) = ceil((pr_globals[4]));
}
...
void PF_checkbottom (void)
{
 ...
 ent = ((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4]));

 (pr_globals[1]) = SV_CheckBottom (ent);
}
...
void PF_pointcontents (void)
{
 ...
 (pr_globals[1]) = SV_PointContents (v);
}
# 1394 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_nextent (void)
{
 int i;
 edict_t *ent;

 i = NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[4])));
 while (1)
 {
  i++;
  if (i == sv.num_edicts)
...
# 1425 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
void PF_aim (void)
{
 ...
 {start[0]=ent->v.origin[0];start[1]=ent->v.origin[1];start[2]=ent->v.origin[2];};
 start[2] += 20;


 {dir[0]=pr_global_struct->v_forward[0];dir[1]=pr_global_struct->v_forward[1];dir[2]=pr_global_struct->v_forward[2];};
 VectorMA (start, 2048, dir, end);
 tr = SV_Move (start, vec3_origin, vec3_origin, end, 0, ent);
 if (tr.ent && tr.ent->v.takedamage == 2
 && (!teamplay.value || ent->v.team <=0 || ent->v.team != tr.ent->v.team) )
 {
  {(&pr_globals[1])[0]=pr_global_struct->v_forward[0];(&pr_globals[1])[1]=pr_global_struct->v_forward[1];(&pr_globals[1])[2]=pr_global_struct->v_forward[2];};
  return;
 }
 ...
 check = ((edict_t *)( (byte *)sv.edicts + pr_edict_size));
 for (i=1 ; i<sv.num_edicts ; i++, check = ((edict_t *)( (byte *)check + pr_edict_size)) )
 {
  ...
  {dir[0]=end[0]-start[0];dir[1]=end[1]-start[1];dir[2]=end[2]-start[2];};
  VectorNormalize (dir);
  dist = (dir[0]*pr_global_struct->v_forward[0]+dir[1]*pr_global_struct->v_forward[1]+dir[2]*pr_global_struct->v_forward[2]);
  if (dist < bestdist)
   continue;
  tr = SV_Move (start, vec3_origin, vec3_origin, end, 0, ent);
  if (tr.ent == check)
 ...
 if (bestent)
 {
  {dir[0]=bestent->v.origin[0]-ent->v.origin[0];dir[1]=bestent->v.origin[1]-ent->v.origin[1];dir[2]=bestent->v.origin[2]-ent->v.origin[2];};
  dist = (dir[0]*pr_global_struct->v_forward[0]+dir[1]*pr_global_struct->v_forward[1]+dir[2]*pr_global_struct->v_forward[2]);
  VectorScale (pr_global_struct->v_forward, dist, end);
  end[2] = dir[2];
  VectorNormalize (end);
  {(&pr_globals[1])[0]=end[0];(&pr_globals[1])[1]=end[1];(&pr_globals[1])[2]=end[2];};
 }
 else
 {
  {(&pr_globals[1])[0]=bestdir[0];(&pr_globals[1])[1]=bestdir[1];(&pr_globals[1])[2]=bestdir[2];};
 }
}
# 1505 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
# 1599 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
sizebuf_t *WriteDest (void)
{
 ...
 case 1:
  ent = ((edict_t *)((byte *)sv.edicts + pr_global_struct->msg_entity));
...
{
 MSG_WriteByte (WriteDest(), (pr_globals[7]));
}

void PF_WriteChar (void)
{
 MSG_WriteChar (WriteDest(), (pr_globals[7]));
}

void PF_WriteShort (void)
{
 MSG_WriteShort (WriteDest(), (pr_globals[7]));
}

void PF_WriteLong (void)
{
 MSG_WriteLong (WriteDest(), (pr_globals[7]));
}

void PF_WriteAngle (void)
{
 MSG_WriteAngle (WriteDest(), (pr_globals[7]));
}

void PF_WriteCoord (void)
{
 MSG_WriteCoord (WriteDest(), (pr_globals[7]));
}

void PF_WriteString (void)
{
 MSG_WriteString (WriteDest(), (pr_strings + *(string_t *)&pr_globals[7]));
}


void PF_WriteEntity (void)
{
 MSG_WriteShort (WriteDest(), NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts+ *(int *)&pr_globals[7]))));
}
...
# 1702 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
 MSG_WriteByte (&sv.signon, (int)((eval_alpha ? (*((float*)((char*)&ent->v + eval_alpha))) : 0)*255));
 MSG_WriteByte (&sv.signon, (eval_style ? (*((float*)((char*)&ent->v + eval_style))) : 0));
 MSG_WriteShort (&sv.signon, (eval_light_lev ? (*((float*)((char*)&ent->v + eval_light_lev))) : 300));
 MSG_WriteByte (&sv.signon, (eval_pflags ? (*((float*)((char*)&ent->v + eval_pflags))) : 0));

 for (i=0 ; i<3 ; i++)
 {
  MSG_WriteCoord(&sv.signon, ent->v.origin[i]);
  MSG_WriteAngle(&sv.signon, ent->v.angles[i]);
  MSG_WriteByte(&sv.signon, (int)((eval_color ? (*((vec3_t*)((char*)&ent->v + eval_color))) : vec3_origin)[i]*255));
 }


 ED_Free (ent);
}
# 1725 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
...
{
# 1765 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
 char *s;
...
# 1934 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
void PF_Fixme (void)
{
...
PF_WriteString,
PF_WriteEntity,
# 2014 "d:/Data/Nintendo/TenebraeGX/src/pr_cmds.c"
PF_Fixme,
PF_Fixme,
PF_Fixme,
PF_Fixme,
