# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
# 9 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
...
# 10 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c" 2
...
# 38 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
void GX_InitGXExt() {
 gxCurrentShader = gx_noShader;
 currentBumpShaderLight = ((void *)0);
 currentBumpShaderEntity = ((void *)0);



 GX_SetVtxAttrFmt(1, 9, 1, 4, 0);
 GX_SetVtxAttrFmt(1, 13, 1, 4, 0);
 GX_SetVtxAttrFmt(1, 14, 1, 4, 0);


 GX_SetVtxAttrFmt(2, 9, 1, 4, 0);
 GX_SetVtxAttrFmt(2, 13, 1, 4, 0);
 GX_SetVtxAttrFmt(2, 14, 1, 4, 0);


 GX_SetVtxAttrFmt(3, 9, 1, 4, 0);


}
# 82 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
void GX_BindGLTex(u8 gxTexmap, int texnr) {
...
# 96 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
int GX_AsGXPrimitiveType(GLenum type) {
 u8 _type;
 switch(type) {
...
# 126 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
void GX_SetupGLRender(void) {
 ...
 GX_SetZCompLoc(1);
 GX_SetAlphaCompare(7, 1.0f, 0, 7, 1.0f);


 GXColor col;
 col.r = 0; col.g = 0; col.b = 0; col.a = 0;
 GX_SetFog(0, 0, 0x00ffffff, 0.1f, 1.0f, col);
...
# 169 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
void GX_InitAmbientShader(_Bool hasLuma) {
 ...
 if (gxCurrentShader != gx_ambientShader) {
  ...
  GX_SetTexCoordGen(0x1, 1, 5, 60);


  GX_SetTevColorIn(0, 15, 8, 13, 15);
  GX_SetTevColorOp(0, 0, 0, 0, 1, 0);
  GX_SetTevOrder(0, 0x0, 0, 6);
  GX_SetTevDirect(0);

  GX_SetTevColorIn(1, 15, 9, 0, 15);
  GX_SetTevColorOp(1, 0, 0, 0, 1, 0);
  GX_SetTevOrder(1, 0x1, 1, 6);
  GX_SetTevDirect(1);

  GX_SetTevColorIn(2, 15, 9, 12, 0);
  GX_SetTevColorOp(2, 0, 0, 0, 1, 0);
  GX_SetTevOrder(2, 0x0, 2, 6);
  GX_SetTevDirect(2);
...
# 246 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
void GX_InitWorldBumpShader(shadowlight_t *light, entity_t *entity) {
 ...
 if (gxCurrentShader != gx_worldBumpShader) {
  ...
  GX_BindGLTex(1, glow_texture_object);
  ...
  GX_SetTexCoordGen(0x0, 1, 4, 60);
  GX_SetTexCoordGen(0x1, 1, 5, 60);
  GX_SetTexCoordGen2(0x2, 0, 0, 30, 0, 64);


  GX_SetTevColorIn(0, 15, 8, 6, 15);
  GX_SetTevColorOp(0, 0, 0, 0, 1, 1);
  GX_SetTevOrder(0, 0x1, 1, 4);
  GX_SetTevDirect(0);

  GX_SetTevColorIn(1, 15, 8, 2, 15);
  GX_SetTevColorOp(1, 0, 0, 1, 1, 0);
  GX_SetTevOrder(1, 0x0, 0, 6);
  GX_SetTevDirect(1);

  GX_SetTevColorIn(2, 8, 15, 0, 15);
  GX_SetTevColorOp(2, 15, 0, 0, 0, 0);
  GX_SetTevOrder(2, 0x2, 5, 6);
  GX_SetTevDirect(2);
 ...
 if (currentBumpShaderLight != light) {
  ...
  memcpy(&prMtx, GX_GetCurrGLPrjMtx(), sizeof(Mtx44));
  c0 = 0.5f*prMtx[0][0];
  c1 = -0.5f*prMtx[1][1];
  ss = (float) light->scizz.coords[0];
  st = (float) light->scizz.coords[1];
  s = -0.5f + ss/((float) glwidth);
  ...
  GX_LoadTexMtxImm(tpMtx, 64, 1);

 }

}
# 354 "d:/Data/Nintendo/TenebraeGX/src/gl_qgxext.c"
void GX_InitShadowShader(_Bool add, _Bool invertOp) {
 ...
 if (gxCurrentShader != gx_shadowShader) {
  ...
  color.b = 0x00;
  color.a = 0x04;
  GX_SetTevKColor(0, color);
  GX_SetTevKAlphaSel(0, 0x1C);
  GX_SetTevColorIn(0, 15, 15, 15, 15);
  GX_SetTevColorOp(0, 0, 0, 0, 1, 0);
  GX_SetTevAlphaIn(0, 7, 7, 7, 6);
  GX_SetTevAlphaOp(0, 0, 0, 0, 1, 0);
  GX_SetTevOrder(0, 0xff, 0x100, 6);
  GX_SetTevDirect(0);
