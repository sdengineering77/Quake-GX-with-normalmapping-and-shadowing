# 1 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c" 2
# 42 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 135 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
qboolean SV_RunThink (edict_t *ent)
{
 ...
 pr_global_struct->self = ((byte *)ent - (byte *)sv.edicts);
 pr_global_struct->other = ((byte *)sv.edicts - (byte *)sv.edicts);
 PR_ExecuteProgram (ent->v.think);
 return !ent->free;
}
# 162 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 199 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 238 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
int SV_FlyMove (edict_t *ent, float time, trace_t *steptrace)
{
 ...
 blocked = 0;
 {original_velocity[0]=ent->v.velocity[0];original_velocity[1]=ent->v.velocity[1];original_velocity[2]=ent->v.velocity[2];};
 {primal_velocity[0]=ent->v.velocity[0];primal_velocity[1]=ent->v.velocity[1];primal_velocity[2]=ent->v.velocity[2];};
 numplanes = 0;
 ...
 for (bumpcount=0 ; bumpcount<numbumps ; bumpcount++)
 {
  ...
  if (trace.allsolid)
  {
   {ent->v.velocity[0]=vec3_origin[0];ent->v.velocity[1]=vec3_origin[1];ent->v.velocity[2]=vec3_origin[2];};
   return 3;
  }
  ...
  {planes[numplanes][0]=trace.plane.normal[0];planes[numplanes][1]=trace.plane.normal[1];planes[numplanes][2]=trace.plane.normal[2];};
  numplanes++;
  ...
  if (i != numplanes)
  {
   {ent->v.velocity[0]=new_velocity[0];ent->v.velocity[1]=new_velocity[1];ent->v.velocity[2]=new_velocity[2];};
  }
  else
  {
   if (numplanes != 2)
...
# 380 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 417 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
trace_t SV_PushEntity (edict_t *ent, vec3_t push)
{
 trace_t trace;
 vec3_t end;

 {end[0]=ent->v.origin[0]+push[0];end[1]=ent->v.origin[1]+push[1];end[2]=ent->v.origin[2]+push[2];};

 if (ent->v.movetype == 9)
  trace = SV_Move (ent->v.origin, ent->v.mins, ent->v.maxs, end, 2, ent);
 else if (ent->v.solid == 1 || ent->v.solid == 0)

  trace = SV_Move (ent->v.origin, ent->v.mins, ent->v.maxs, end, 1, ent);
 else
  trace = SV_Move (ent->v.origin, ent->v.mins, ent->v.maxs, end, 0, ent);
...
# 448 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_PushMove (edict_t *pusher, float movetime)
{
 ...
 int num_moved;
 edict_t *moved_edict[2048];
 vec3_t moved_from[2048];
 float solid_backup;
 ...
 {pushorig[0]=pusher->v.origin[0];pushorig[1]=pusher->v.origin[1];pushorig[2]=pusher->v.origin[2];};



 {pusher->v.origin[0]=pusher->v.origin[0]+move[0];pusher->v.origin[1]=pusher->v.origin[1]+move[1];pusher->v.origin[2]=pusher->v.origin[2]+move[2];};
 pusher->v.ltime += movetime;
 ...
 for (e=1 ; e<sv.num_edicts ; e++, check = ((edict_t *)( (byte *)check + pr_edict_size)))
 {
  ...
  if ( ! ( ((int)check->v.flags & 512)
  && ((edict_t *)((byte *)sv.edicts + check->v.groundentity)) == pusher) )
  {
  ...
  if (check->v.movetype != 3)
   check->v.flags = (int)check->v.flags & ~512;

  {entorig[0]=check->v.origin[0];entorig[1]=check->v.origin[1];entorig[2]=check->v.origin[2];};
  {moved_from[num_moved][0]=check->v.origin[0];moved_from[num_moved][1]=check->v.origin[1];moved_from[num_moved][2]=check->v.origin[2];};
  ...
  if (block)
  {
   ...
   if (check->v.solid == 0 || check->v.solid == 1)
   {
    ...
    {check->v.maxs[0]=check->v.mins[0];check->v.maxs[1]=check->v.mins[1];check->v.maxs[2]=check->v.mins[2];};
    continue;
   }

   {check->v.origin[0]=entorig[0];check->v.origin[1]=entorig[1];check->v.origin[2]=entorig[2];};
   SV_LinkEdict (check, 1);

   {pusher->v.origin[0]=pushorig[0];pusher->v.origin[1]=pushorig[1];pusher->v.origin[2]=pushorig[2];};
   SV_LinkEdict (pusher, 0);
   pusher->v.ltime -= movetime;
   ...
   {
    {moved_edict[i]->v.origin[0]=moved_from[i][0];moved_edict[i]->v.origin[1]=moved_from[i][1];moved_edict[i]->v.origin[2]=moved_from[i][2];};
...
# 589 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 627 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_PushRotate (edict_t *pusher, float movetime)
{
 ...
 {a[0]=vec3_origin[0]-amove[0];a[1]=vec3_origin[1]-amove[1];a[2]=vec3_origin[2]-amove[2];};
 AngleVectors (a, forward, right, up);

 {pushorig[0]=pusher->v.angles[0];pushorig[1]=pusher->v.angles[1];pushorig[2]=pusher->v.angles[2];};



 {pusher->v.angles[0]=pusher->v.angles[0]+amove[0];pusher->v.angles[1]=pusher->v.angles[1]+amove[1];pusher->v.angles[2]=pusher->v.angles[2]+amove[2];};
 pusher->v.ltime += movetime;
 SV_LinkEdict (pusher, 0);
 ...
 for (e=1 ; e<sv.num_edicts ; e++, check = ((edict_t *)( (byte *)check + pr_edict_size)))
 {
  ...
  {org[0]=check->v.origin[0]-pusher->v.origin[0];org[1]=check->v.origin[1]-pusher->v.origin[1];org[2]=check->v.origin[2]-pusher->v.origin[2];};
  ...
  {move[0]=org2[0]-org[0];move[1]=org2[1]-org[1];move[2]=org2[2]-org[2];};
  ...
  if (block)
  {
   ...
   {pusher->v.angles[0]=pushorig[0];pusher->v.angles[1]=pushorig[1];pusher->v.angles[2]=pushorig[2];};
   SV_LinkEdict (pusher, 0);
   pusher->v.ltime -= movetime;
   ...
   {
    {moved_edict[i]->v.origin[0]=moved_from[i][0];moved_edict[i]->v.origin[1]=moved_from[i][1];moved_edict[i]->v.origin[2]=moved_from[i][2];};
    {moved_edict[i]->v.angles[0]=moved_edict[i]->v.angles[0]-amove[0];moved_edict[i]->v.angles[1]=moved_edict[i]->v.angles[1]-amove[1];moved_edict[i]->v.angles[2]=moved_edict[i]->v.angles[2]-amove[2];};
    SV_LinkEdict (moved_edict[i], 0);
   }
   return;
  }
  ...
  {
   {check->v.angles[0]=check->v.angles[0]+amove[0];check->v.angles[1]=check->v.angles[1]+amove[1];check->v.angles[2]=check->v.angles[2]+amove[2];};
  }
 }


}
# 767 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 866 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_CheckStuck (edict_t *ent)
{
 ...
 {
  {ent->v.oldorigin[0]=ent->v.origin[0];ent->v.oldorigin[1]=ent->v.origin[1];ent->v.oldorigin[2]=ent->v.origin[2];};
  return;
 }

 {org[0]=ent->v.origin[0];org[1]=ent->v.origin[1];org[2]=ent->v.origin[2];};
 {ent->v.origin[0]=ent->v.oldorigin[0];ent->v.origin[1]=ent->v.oldorigin[1];ent->v.origin[2]=ent->v.oldorigin[2];};
 if (!SV_TestEntityPosition(ent))
 {
  Con_DPrintf ("Unstuck.\n");
  SV_LinkEdict (ent, 1);
 ...
 {ent->v.origin[0]=org[0];ent->v.origin[1]=org[1];ent->v.origin[2]=org[2];};
...
# 960 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
 }
...
void SV_WallFriction (edict_t *ent, trace_t *trace)
{
 ...
 i = (trace->plane.normal[0]*ent->v.velocity[0]+trace->plane.normal[1]*ent->v.velocity[1]+trace->plane.normal[2]*ent->v.velocity[2]);
 VectorScale (trace->plane.normal, i, into);
 {side[0]=ent->v.velocity[0]-into[0];side[1]=ent->v.velocity[1]-into[1];side[2]=ent->v.velocity[2]-into[2];};

 ent->v.velocity[0] = side[0] * (1 + d);
 ent->v.velocity[1] = side[1] * (1 + d);
}
# 1005 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
int SV_TryUnstick (edict_t *ent, vec3_t oldvel)
{
 ...
 {oldorg[0]=ent->v.origin[0];oldorg[1]=ent->v.origin[1];oldorg[2]=ent->v.origin[2];};
 ...
 for (i=0 ; i<8 ; i++)
 {
  ...
  {ent->v.origin[0]=oldorg[0];ent->v.origin[1]=oldorg[1];ent->v.origin[2]=oldorg[2];};
 }

 {ent->v.velocity[0]=vec3_origin[0];ent->v.velocity[1]=vec3_origin[1];ent->v.velocity[2]=vec3_origin[2];};
 return 7;
}
# 1062 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_WalkMove (edict_t *ent)
{
 ...
 oldonground = (int)ent->v.flags & 512;
 ent->v.flags = (int)ent->v.flags & ~512;

 {oldorg[0]=ent->v.origin[0];oldorg[1]=ent->v.origin[1];oldorg[2]=ent->v.origin[2];};
 {oldvel[0]=ent->v.velocity[0];oldvel[1]=ent->v.velocity[1];oldvel[2]=ent->v.velocity[2];};
 ...
 if ( (int)sv_player->v.flags & 2048 )
  return;

 {nosteporg[0]=ent->v.origin[0];nosteporg[1]=ent->v.origin[1];nosteporg[2]=ent->v.origin[2];};
 {nostepvel[0]=ent->v.velocity[0];nostepvel[1]=ent->v.velocity[1];nostepvel[2]=ent->v.velocity[2];};
 ...
 {upmove[0]=vec3_origin[0];upmove[1]=vec3_origin[1];upmove[2]=vec3_origin[2];};
 {downmove[0]=vec3_origin[0];downmove[1]=vec3_origin[1];downmove[2]=vec3_origin[2];};
 upmove[2] = 18;
 downmove[2] = -18 + oldvel[2]*host_frametime;
 ...
 if (downtrace.plane.normal[2] > 0.7)
 {
  ...
  {
   ent->v.flags = (int)ent->v.flags | 512;
   ent->v.groundentity = ((byte *)downtrace.ent - (byte *)sv.edicts);
  }
 }
 else
 {
  ...
  {ent->v.origin[0]=nosteporg[0];ent->v.origin[1]=nosteporg[1];ent->v.origin[2]=nosteporg[2];};
  {ent->v.velocity[0]=nostepvel[0];ent->v.velocity[1]=nostepvel[1];ent->v.velocity[2]=nostepvel[2];};
 }
}
# 1163 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_Physics_Client (edict_t *ent, int num)
{
 ...
 case 3:
  if (!SV_RunThink (ent))
   return;
  if (!SV_CheckWater (ent) && ! ((int)ent->v.flags & 2048) )
   SV_AddGravity (ent);
  SV_CheckStuck (ent);
 ...
 case 5:
  if (!SV_RunThink (ent))
   return;
  SV_FlyMove (ent, host_frametime, ((void *)0));
  break;
...
# 1246 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_Physics_None (edict_t *ent)
{

 SV_RunThink (ent);
}
# 1276 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 1302 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_CheckWaterTransition (edict_t *ent)
{
 int cont;
# 1313 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
 ...
 {
  if ((ent->v.watertype != -1)&&(ent->v.watertype != -2))
...
# 1350 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_Physics_Toss (edict_t *ent)
{
 trace_t trace;
 vec3_t move;
 float backoff;
# 1366 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
 if (!SV_RunThink (ent))
  return;
# 1389 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
 if ( ((int)ent->v.flags & 512) )
  return;
 ...
 if (trace.plane.normal[2] > 0.7)
 {
...

  {
   ...
   ent->v.groundentity = ((byte *)trace.ent - (byte *)sv.edicts);
   {ent->v.velocity[0]=vec3_origin[0];ent->v.velocity[1]=vec3_origin[1];ent->v.velocity[2]=vec3_origin[2];};
   {ent->v.avelocity[0]=vec3_origin[0];ent->v.avelocity[1]=vec3_origin[1];ent->v.avelocity[2]=vec3_origin[2];};
  }
 }
...
# 1573 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
...
# 1612 "d:/Data/Nintendo/TenebraeGX/src/sv_phys.c"
void SV_Physics (void)
{
 int i;
 edict_t *ent;
 ...
 pr_global_struct->self = ((byte *)sv.edicts - (byte *)sv.edicts);
 pr_global_struct->other = ((byte *)sv.edicts - (byte *)sv.edicts);
 pr_global_struct->time = sv.time;
