# 1 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.c" 2
...
# 24 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.c" 2
...
int VCR_GetMessage (qsocket_t *sock)
{
 ...
 if (host_time != next.time || next.op != 2 || next.session != *(long *)(&sock->driverdata))
...
int VCR_SendMessage (qsocket_t *sock, sizebuf_t *data)
{
 int ret;
        (void)data;
 if (host_time != next.time || next.op != 3 || next.session != *(long *)(&sock->driverdata))
  Sys_Error ("VCR missmatch");
...
qboolean VCR_CanSendMessage (qsocket_t *sock)
{
 ...
 if (host_time != next.time || next.op != 4 || next.session != *(long *)(&sock->driverdata))
  Sys_Error ("VCR missmatch");
...
qsocket_t *VCR_CheckNewConnections (void)
{
 ...
 if (host_time != next.time || next.op != 1)
  Sys_Error ("VCR missmatch");
