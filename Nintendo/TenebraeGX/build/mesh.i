# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
# 42 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/include/gluos.h" 1
# 43 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c" 2
...
# 44 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c" 2
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c" 2
...
# 47 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c" 2
   ...
   GLUhalfEdge *eOrig, GLUvertex *vNext )
{
  ...
  ((vNew != ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 144, __FUNCTION__, "vNew != NULL"));
...
static void MakeFace( GLUface *newFace, GLUhalfEdge *eOrig, GLUface *fNext )
{
  ...
  ((fNew != ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 177, __FUNCTION__, "fNew != NULL"));
...
# 326 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
int __gl_meshSplice( GLUhalfEdge *eOrg, GLUhalfEdge *eDst )
{
  int joiningLoops = 0;
...
# 382 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
int __gl_meshDelete( GLUhalfEdge *eDel )
{
...
# 444 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
GLUhalfEdge *__gl_meshAddEdgeVertex( GLUhalfEdge *eOrg )
{
  GLUhalfEdge *eNewSym;
...
# 506 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
GLUhalfEdge *__gl_meshConnect( GLUhalfEdge *eOrg, GLUhalfEdge *eDst )
{
  GLUhalfEdge *eNewSym;
  int joiningLoops = 0;
...
# 553 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
void __gl_meshZapFace( GLUface *fZap )
{
...
# 709 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
void __gl_meshDeleteMesh( GLUmesh *mesh )
{
  GLUface *f, *fNext;
  GLUvertex *v, *vNext;
...
void __gl_meshCheckMesh( GLUmesh *mesh )
{
  ...
  for( fPrev = fHead ; (f = fPrev->next) != fHead; fPrev = f) {
    ((f->prev == fPrev) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 751, __FUNCTION__, "f->prev == fPrev"));
    e = f->anEdge;
    do {
      ((e->Sym != e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 754, __FUNCTION__, "e->Sym != e"));
      ((e->Sym->Sym == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 755, __FUNCTION__, "e->Sym->Sym == e"));
      ((e->Lnext->Onext->Sym == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 756, __FUNCTION__, "e->Lnext->Onext->Sym == e"));
      ((e->Onext->Sym->Lnext == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 757, __FUNCTION__, "e->Onext->Sym->Lnext == e"));
      ((e->Lface == f) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 758, __FUNCTION__, "e->Lface == f"));
      e = e->Lnext;
    } while( e != f->anEdge );
  }
  ((f->prev == fPrev && f->anEdge == ((void *)0) && f->data == ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 762, __FUNCTION__, "f->prev == fPrev && f->anEdge == NULL && f->data == NULL"));

  vPrev = vHead;
  for( vPrev = vHead ; (v = vPrev->next) != vHead; vPrev = v) {
    ((v->prev == vPrev) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 766, __FUNCTION__, "v->prev == vPrev"));
    e = v->anEdge;
    do {
      ((e->Sym != e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 769, __FUNCTION__, "e->Sym != e"));
      ((e->Sym->Sym == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 770, __FUNCTION__, "e->Sym->Sym == e"));
      ((e->Lnext->Onext->Sym == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 771, __FUNCTION__, "e->Lnext->Onext->Sym == e"));
      ((e->Onext->Sym->Lnext == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 772, __FUNCTION__, "e->Onext->Sym->Lnext == e"));
      ((e->Org == v) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 773, __FUNCTION__, "e->Org == v"));
      e = e->Onext;
    } while( e != v->anEdge );
  }
  ((v->prev == vPrev && v->anEdge == ((void *)0) && v->data == ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 777, __FUNCTION__, "v->prev == vPrev && v->anEdge == NULL && v->data == NULL"));

  ePrev = eHead;
  for( ePrev = eHead ; (e = ePrev->next) != eHead; ePrev = e) {
    ((e->Sym->next == ePrev->Sym) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 781, __FUNCTION__, "e->Sym->next == ePrev->Sym"));
    ((e->Sym != e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 782, __FUNCTION__, "e->Sym != e"));
    ((e->Sym->Sym == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 783, __FUNCTION__, "e->Sym->Sym == e"));
    ((e->Org != ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 784, __FUNCTION__, "e->Org != NULL"));
    ((e->Sym->Org != ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 785, __FUNCTION__, "e->Dst != NULL"));
    ((e->Lnext->Onext->Sym == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 786, __FUNCTION__, "e->Lnext->Onext->Sym == e"));
    ((e->Onext->Sym->Lnext == e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c", 787, __FUNCTION__, "e->Onext->Sym->Lnext == e"));
  }
  ((e->Sym->next == ePrev->Sym && e->Sym == &mesh->eHeadSym && e->Sym->Sym == e && e->Org == ((void *)0) && e->Sym->Org == ((void *)0) && e->Lface == ((void *)0) && e->Sym->Lface == ((void *)0)) ? (void)0 : __assert_func (



 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
# 789 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
  ,
 ...
 793
# 789 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.c"
  , __FUNCTION__, "e->Sym->next == ePrev->Sym && e->Sym == &mesh->eHeadSym && e->Sym->Sym == e && e->Org == NULL && e->Dst == NULL && e->Lface == NULL && e->Rface == NULL"))
