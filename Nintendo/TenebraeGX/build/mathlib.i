# 1 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/src/quakedef.h" 1
# 44 "d:/Data/Nintendo/TenebraeGX/src/quakedef.h"
...
# 24 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c" 2
...
void ProjectPointOnPlane( vec3_t dst, const vec3_t p, const vec3_t normal )
{
 ...
 inv_denom = 1.0F / (normal[0]*normal[0]+normal[1]*normal[1]+normal[2]*normal[2]);
...
# 77 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
...
void RotatePointAroundVector( vec3_t dst, const vec3_t dir, const vec3_t point, float degrees )
{
 ...
 zrot[0][0] = cos( ( ( (degrees) * 3.14159265358979323846 ) / 180.0F ) );
 zrot[0][1] = sin( ( ( (degrees) * 3.14159265358979323846 ) / 180.0F ) );
 zrot[1][0] = -sin( ( ( (degrees) * 3.14159265358979323846 ) / 180.0F ) );
 zrot[1][1] = cos( ( ( (degrees) * 3.14159265358979323846 ) / 180.0F ) );
...
# 192 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
float anglemod(float a)
{
...
# 211 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
void BOPS_Error (void)
{
 Sys_Error ("BoxOnPlaneSide:  Bad signbits");
}
# 226 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
int BoxOnPlaneSide (vec3_t emins, vec3_t emaxs, mplane_t *p)
{
 float dist1, dist2;
 int sides;
# 245 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
 switch (p->signbits)
 {
 case 0:
...
# 312 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
 sides = 0;
 if (dist1 >= p->dist)
  sides = 1;
 if (dist2 < p->dist)
...
# 537 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
void FloorDivMod (double numer, double denom, int *quotient,
  int *rem)
{
 int q, r;
...
# 613 "d:/Data/Nintendo/TenebraeGX/src/mathlib.c"
fixed16_t Invert24To16(fixed16_t val)
{
 if (val < 256)
  return (0xFFFFFFFF);
