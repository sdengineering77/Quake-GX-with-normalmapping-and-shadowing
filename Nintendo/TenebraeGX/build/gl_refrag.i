# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c" 2

mnode_t *r_pefragtopnode;
# 37 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
efrag_t **lastlink;

vec3_t r_emins, r_emaxs;

entity_t *r_addent;
# 51 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
void R_RemoveEfrags (entity_t *ent)
{
...
void R_SplitEntityOnNode (mnode_t *node)
{
 ...
 sides = (((splitplane)->type < 3)? ( ((splitplane)->dist <= (r_emins)[(splitplane)->type])? 1 : ( ((splitplane)->dist >= (r_emaxs)[(splitplane)->type])? 2 : 3 ) ) : BoxOnPlaneSide( (r_emins), (r_emaxs), (splitplane)));
...
# 163 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
void R_AddEfrags (entity_t *ent)
{
 model_t *entmodel;
 int i;
...
# 205 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
void R_StoreEfrags (efrag_t **ppefrag)
{
 entity_t *pent;
 model_t *clmodel;
...
# 300 "d:/Data/Nintendo/TenebraeGX/src/gl_refrag.c"
