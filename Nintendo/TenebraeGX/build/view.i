# 1 "d:/Data/Nintendo/TenebraeGX/src/view.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/view.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/view.c" 2
# 33 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 78 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 111 "d:/Data/Nintendo/TenebraeGX/src/view.c"
float V_CalcBob (void)
{
 ...
 if (cycle < cl_bobup.value)
  cycle = 3.14159265358979323846 * cycle / cl_bobup.value;
 else
  cycle = 3.14159265358979323846 + 3.14159265358979323846*(cycle-cl_bobup.value)/(1.0 - cl_bobup.value);
...
# 181 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_DriftPitch (void)
{
 ...
 delta = cl.idealpitch - cl.viewangles[0];
...
# 253 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 315 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_ParseDamage (void)
{
 int armor, blood;
 vec3_t from;
 ...
 cl.cshifts[1].percent += 3*count;
 if (cl.cshifts[1].percent < 0)
  cl.cshifts[1].percent = 0;
 if (cl.cshifts[1].percent > 150)
  cl.cshifts[1].percent = 150;
 ...
 {
  cl.cshifts[1].destcolor[0] = 220;
  cl.cshifts[1].destcolor[1] = 50;
  cl.cshifts[1].destcolor[2] = 50;
 }
 else
 {
 ...
 {from[0]=from[0]-ent->origin[0];from[1]=from[1]-ent->origin[1];from[2]=from[2]-ent->origin[2];};
 VectorNormalize (from);

 AngleVectors (ent->angles, forward, right, up);

 side = (from[0]*right[0]+from[1]*right[1]+from[2]*right[2]);
 v_dmg_roll = count*side*v_kickroll.value;

 side = (from[0]*forward[0]+from[1]*forward[1]+from[2]*forward[2]);
...
# 402 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 417 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_SetContentsColor (int contents)
{
 switch (contents)
 {
 case -1:
 case -2:
  cl.cshifts[0] = cshift_empty;
  break;
 case -5:
  cl.cshifts[0] = cshift_lava;
  break;
 case -4:
  cl.cshifts[0] = cshift_slime;
  break;
 default:
  cl.cshifts[0] = cshift_empty;
 }
...
void V_CalcPowerupCshift (void)
{
 if (cl.items & 4194304)
 {
  cl.cshifts[3].destcolor[0] = 0;
  cl.cshifts[3].destcolor[1] = 0;
  cl.cshifts[3].destcolor[2] = 255;
  cl.cshifts[3].percent = 30;
 }
 else if (cl.items & 2097152)
 {
  cl.cshifts[3].destcolor[0] = 0;
  cl.cshifts[3].destcolor[1] = 255;
  cl.cshifts[3].destcolor[2] = 0;
  cl.cshifts[3].percent = 20;
 }
 else if (cl.items & 524288)
 {
  cl.cshifts[3].destcolor[0] = 100;
  cl.cshifts[3].destcolor[1] = 100;
  cl.cshifts[3].destcolor[2] = 100;
  cl.cshifts[3].percent = 100;
 }
 else if (cl.items & 1048576)
 {
  cl.cshifts[3].destcolor[0] = 255;
  cl.cshifts[3].destcolor[1] = 255;
  cl.cshifts[3].destcolor[2] = 0;
  cl.cshifts[3].percent = 30;
 }
 ...
 for (j=0 ; j<4 ; j++)
 {
  if (!gl_cshiftpercent.value)
   continue;
                ...
                a2 = (cl.cshifts[j].percent * gl_cshiftpercent.value) * 0.000039215686;
...
# 531 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_UpdatePalette (void)
{
 int i, j;
 qboolean new;
 ...
 cl.cshifts[1].percent -= host_frametime*150;
 if (cl.cshifts[1].percent <= 0)
  cl.cshifts[1].percent = 0;


 cl.cshifts[2].percent -= host_frametime*100;
 if (cl.cshifts[2].percent <= 0)
...
# 696 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 797 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_AddIdle (void)
{
...
# 812 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
# 841 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_CalcIntermissionRefdef (void)
{
 ...
 {r_refdef.vieworg[0]=ent->origin[0];r_refdef.vieworg[1]=ent->origin[1];r_refdef.vieworg[2]=ent->origin[2];};

 {r_refdef.viewangles[0]=ent->angles[0];r_refdef.viewangles[1]=ent->angles[1];r_refdef.viewangles[2]=ent->angles[2];};
 view->model = ((void *)0);
...
void V_CalcRefdef (void)
{
 ...
 {r_refdef.viewangles[0]=cl.viewangles[0];r_refdef.viewangles[1]=cl.viewangles[1];r_refdef.viewangles[2]=cl.viewangles[2];};
 V_CalcViewRoll ();
 V_AddIdle ();
 ...
 {view->angles[0]=cl.viewangles[0];view->angles[1]=cl.viewangles[1];view->angles[2]=cl.viewangles[2];};

 CalcGunAngle ();

 {view->origin[0]=ent->origin[0];view->origin[1]=ent->origin[1];view->origin[2]=ent->origin[2];};
 ...
 view->model = cl.model_precache[cl.stats[2]];
 view->frame = cl.stats[5];
 view->colormap = vid.colormap;


 {r_refdef.viewangles[0]=r_refdef.viewangles[0]+cl.punchangle[0];r_refdef.viewangles[1]=r_refdef.viewangles[1]+cl.punchangle[1];r_refdef.viewangles[2]=r_refdef.viewangles[2]+cl.punchangle[2];};
...
# 998 "d:/Data/Nintendo/TenebraeGX/src/view.c"
...
void V_RenderView (void)
{
 ...
 if (lcd_x.value)
 {
  ...
  r_refdef.viewangles[1] -= lcd_yaw.value;
  for (i=0 ; i<3 ; i++)
  ...
  r_refdef.viewangles[1] += lcd_yaw.value*2;
  for (i=0 ; i<3 ; i++)
...
# 1076 "d:/Data/Nintendo/TenebraeGX/src/view.c"
void V_Init (void)
{
