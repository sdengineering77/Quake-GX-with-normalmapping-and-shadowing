# 1 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/cmd.c" 2
...
qboolean cmd_wait;
# 53 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cmd_Wait_f (void)
{
 cmd_wait = 1;
}
# 66 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
sizebuf_t cmd_text;
...
# 86 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cbuf_AddText (char *text)
{
 int l;
...
# 111 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cbuf_InsertText (char *text)
{
 char *temp;
 int templen;
...
# 213 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
...
# 318 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
 Con_Printf ("execing %s\n",Cmd_Argv(1));

 Cbuf_InsertText (f);
 Hunk_FreeToLowMark (mark);
}
# 332 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
...
# 349 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
...
# 420 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
...
# 500 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cmd_TokenizeString (char *text)
{
 int i;
...
# 607 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
char *Cmd_CompleteCommand (char *partial)
{
 cmd_function_t *cmd;
 int len;
...
# 706 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
char *Cmd_CompleteAlias (char *partial)
{
 cmdalias_t *alias;
 int len;
...
# 803 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cmd_ExecuteString (char *text, cmd_source_t src)
{
 cmd_function_t *cmd;
 cmdalias_t *a;
...
# 849 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cmd_ForwardToServer (void)
{
...
# 882 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
int Cmd_CheckParm (char *parm)
{
 int i;
...
# 903 "d:/Data/Nintendo/TenebraeGX/src/cmd.c"
void Cmd_List_f (void)
{
 cmd_function_t *cmd;
 char *partial;
