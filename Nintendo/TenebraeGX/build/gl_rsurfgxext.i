# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c"
# 9 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c"
...
# 10 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c" 2
...
# 25 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c"
void DrawTextureChainsGX (void)
{
 ...
 for (i=0 ; i<cl.worldmodel->numtextures ; i++)
 {
  ...
  }
  {
   ...
   GX_BindGLTex(0, tani->gl_texturenum);


   hasLuma = t->gl_lumitex ? 1 : 0;
   if (hasLuma) {
    GX_BindGLTex(2, t->gl_lumitex);
   }



   while (s) {
    GX_BindGLTex(1, lightmap_textures + s->lightmaptexturenum);
    GX_InitAmbientShader(hasLuma);

    p = s->polys;
    v = (float *)(&globalVertexTable[p->firstvertex]);

    GX_Begin(0xA0, 1, p->numverts);
...
# 123 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c"
void R_RenderBrushPoly (msurface_t *fa)
{
 ...
 GX_BindGLTex(0, t->gl_texturenum);
 ...
 GX_BindGLTex(1, lightmap_textures + fa->lightmaptexturenum);
 GX_InitAmbientShader(hasLuma);
...
# 180 "d:/Data/Nintendo/TenebraeGX/src/gl_rsurfgxext.c"
void R_DrawBrushModel (entity_t *e)
{
    vec3_t mins, maxs;
    int i;
