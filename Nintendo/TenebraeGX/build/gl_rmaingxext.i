# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
...
# 41 "c:/utils/devkitPro/libogc/include/ogc/system.h"
...
# 42 "c:/utils/devkitPro/libogc/include/ogc/system.h" 2
...
# 45 "c:/utils/devkitPro/libogc/include/ogc/system.h" 2
...
# 46 "c:/utils/devkitPro/libogc/include/ogc/system.h" 2
...
# 4 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c" 2
...
# 5 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c" 2
...
# 28 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
void SHADOW_InitTex(int width, int height) {
 int size = width * height;
 shadowtexbuf = (byte *) align32(malloc(size+32));
 GX_InitTexObj(&shadowtexobj, shadowtexbuf, width, height, 0x1, 0, 0, 0);



 GX_InitTexCacheRegion(&shadowtexregion, 0, 0x80000, 2, 0, 3);
 GX_LoadTexObjPreloaded(&shadowtexobj, &shadowtexregion, 5);
}
# 48 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
void R_RenderScene (void)
{
 int i, scizzX, scizzY, scizzW,scizzH;
 shadowlight_t *l = ((void *)0);
...
# 114 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
  ...
  if (l->castShadow)
  {
   ...
   if (sh_worldshadows.value) {
    GX_InitShadowShader(1, 0);
    R_DrawShadowVolume(l);


    GX_InitShadowShader(0, 0);
    R_DrawShadowVolume(l);
   }
   ...
   if (sh_entityshadows.value) {
    ...
    GX_InitShadowShader(1, 1);
    R_DrawEntitiesShadowVolumes(mod_alias);

    GX_InitShadowShader(0, 1);
    R_DrawEntitiesShadowVolumes(mod_alias);

   }


   GX_GrabEFB(scizzX, scizzY, scizzW, scizzH, (0x7|0x20), 1, 0, 1, shadowtexbuf);
...
# 202 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
}
...
# 228 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
 num = paliashdr->numtris * 3;
...
# 253 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
void R_DrawAliasSurface (aliashdr_t *paliashdr, float bright, aliasframeinstant_t *instant) {
 ...
 if (!busy_caustics) {
  ...
  if (currententity->colormap != vid.colormap && !gl_nocolors.value) {
   ...
   if (i >= 1 && i<=cl.maxclients ) {
    GX_BindGLTex(0, playertextures - 1 + i);

   }
  } else {
   anim = (int)(cl.time*10) & 3;
   GX_BindGLTex(0, paliashdr->gl_texturenum[currententity->skinnum][anim]);
  }
 }
 ...
 if ( !busy_caustics ) {
  ...
  _Bool hasLuma = paliashdr->gl_lumatex[currententity->skinnum][anim] != 0;
  GX_InitAmbientShader(hasLuma);

  anim = (int)(cl.time*10) & 3;
  if (hasLuma) {
   GX_BindGLTex(2, paliashdr->gl_lumatex[currententity->skinnum][anim]);
  }
...
# 307 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
 c_alias_polys += paliashdr->numtris;


}
# 321 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
void R_DrawAliasModel (float bright)
{
 int i,maxnumsurf;
 aliashdr_t *paliashdr;
...
# 372 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
...
# 449 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
...
# 480 "d:/Data/Nintendo/TenebraeGX/src/gl_rmaingxext.c"
    {r_entorigin[0]=currententity->origin[0];r_entorigin[1]=currententity->origin[1];r_entorigin[2]=currententity->origin[2];};
    {modelorg[0]=r_origin[0]-r_entorigin[0];modelorg[1]=r_origin[1]-r_entorigin[1];modelorg[2]=r_origin[2]-r_entorigin[2];};
