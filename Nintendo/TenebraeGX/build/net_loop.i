# 1 "d:/Data/Nintendo/TenebraeGX/src/net_loop.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/net_loop.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/net_loop.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/net_loop.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/src/net_loop.h" 1
# 22 "d:/Data/Nintendo/TenebraeGX/src/net_loop.h"
int Loop_Init (void);
...
# 24 "d:/Data/Nintendo/TenebraeGX/src/net_loop.c" 2

qboolean localconnectpending = 0;
qsocket_t *loop_client = ((void *)0);
qsocket_t *loop_server = ((void *)0);
...
qsocket_t *Loop_Connect (char *host)
{
 ...
 if (!loop_client)
 {
  if ((loop_client = NET_NewQSocket ()) == ((void *)0))
  {
 ...
 if (!loop_server)
 {
  if ((loop_server = NET_NewQSocket ()) == ((void *)0))
  {
   Con_Printf("Loop_Connect: no qsocket available\n");
   return ((void *)0);
  }
...
int Loop_SendMessage (qsocket_t *sock, sizebuf_t *data)
{
 ...
 if ((*bufferLength + data->cursize + 4) > 16384)
...
int Loop_SendUnreliableMessage (qsocket_t *sock, sizebuf_t *data)
{
 ...
 if ((*bufferLength + data->cursize + sizeof(byte) + sizeof(short)) > 16384)
  return 0;
...
{
 if (sock->driverdata)
  ((qsocket_t *)sock->driverdata)->driverdata = ((void *)0);
