# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c"
...
# 2 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
# 3 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
# 4 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
# 5 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
# 6 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
# 8 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
# 11 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c" 2
...
void GrowStack(Stack *p, size_t n)
{
 ...
 if(p->begin == ((void *)0))
 {
  _glSetErrorEx(0x0505, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c", 62);
  p->begin = old.begin;
  return;
 }
...
void Pop(Stack *p)
{
 ...
 {
  p->cur = 0;
  _glSetErrorEx(0x0504, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c", 82);
  return;
 }
 --(p->cur);
}
...
void Push(Stack *p)
{
 ...
 {
  p->cur = p->size-1;
  _glSetErrorEx(0x0503, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c", 93);
  return;
 }
...
void * Top(Stack *p)
{
 ...
 {
  p->cur = 0;
  _glSetErrorEx(0x0504, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c", 112);
 }
 if(p->cur > p->size-1)
 {
  p->cur = p->size-1;
  _glSetErrorEx(0x0503, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/mat_stack.c", 117);
 }
