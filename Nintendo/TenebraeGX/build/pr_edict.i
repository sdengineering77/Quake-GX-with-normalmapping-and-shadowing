# 1 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c" 2
...
static gefv_cache gefvCache[2] = {{((void *)0), ""}, {((void *)0), ""}};
...
# 119 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
...
# 135 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_ClearEdict (edict_t *e)
{
 memset (&e->v, 0, progs->entityfields * 4);
 e->free = 0;
}
# 152 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
edict_t *ED_Alloc (void)
{
 int i;
 edict_t *e;
...
# 187 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_Free (edict_t *ed)
{
 SV_UnlinkEdict (ed);
 ...
 ed->v.skin = 0;
 ed->v.frame = 0;
 {ed->v.origin[0]=vec3_origin[0];ed->v.origin[1]=vec3_origin[1];ed->v.origin[2]=vec3_origin[2];};
 {ed->v.angles[0]=vec3_origin[0];ed->v.angles[1]=vec3_origin[1];ed->v.angles[2]=vec3_origin[2];};
 ed->v.nextthink = -1;
 ed->v.solid = 0;

 ed->freetime = sv.time;
}
# 213 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
...
# 345 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
char *PR_ValueString (etype_t type, eval_t *val)
{
 ...
 case ev_string:
  ...
  break;
 case ev_entity:
  sprintf (line, "entity %i", NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts + val->edict))) );
  break;
 case ev_function:
...
# 397 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
char *PR_UglyValueString (etype_t type, eval_t *val)
{
 ...
 case ev_string:
  ...
  break;
 case ev_entity:
  sprintf (line, "%i", NUM_FOR_EDICT(((edict_t *)((byte *)sv.edicts + val->edict))));
  break;
 case ev_function:
  f = pr_functions + val->function;
  sprintf (line, "%s", pr_strings + f->s_name);
...
# 446 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
...
# 500 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_Print (edict_t *ed)
{
 int l;
 ddef_t *d;
...
# 550 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_Write (FILE *f, edict_t *ed)
{
 ddef_t *d;
 int *v;
...
# 602 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_PrintEdicts (void)
{
 int i;
...
# 618 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
...
# 638 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_Count (void)
{
 int i;
 edict_t *ent;
...
# 681 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_WriteGlobals (FILE *f)
{
 ddef_t *def;
 int i;
...
# 758 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
char *ED_NewString (char *string)
{
 char *new, *new_p;
 int i,l;
...
# 793 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
qboolean ED_ParseEpair (void *base, ddef_t *key, char *s)
{
 int i;
 char string[128];
 ...
 case ev_entity:
  *(int *)d = ((byte *)EDICT_NUM(atoi (s)) - (byte *)sv.edicts);
  break;
...
# 867 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
char *ED_ParseEdict (char *data, edict_t *ent)
{
 ddef_t *key;
 qboolean anglehack;
...
# 970 "d:/Data/Nintendo/TenebraeGX/src/pr_edict.c"
void ED_LoadFromFile (char *data)
{
 edict_t *ent;
 int inhibit;
 ...
 while (1)
 {
  ...
  if (deathmatch.value)
  {
   if (((int)ent->v.spawnflags & 2048))
   {

    if (strcmp (pr_strings + ent->v.classname, "light") &&
     strcmp (pr_strings + ent->v.classname, "light_lev") ) {
     ED_Free (ent);
     inhibit++;
     continue;
  ...
  else if ((current_skill == 0 && ((int)ent->v.spawnflags & 256))
    || (current_skill == 1 && ((int)ent->v.spawnflags & 512))
    || (current_skill >= 2 && ((int)ent->v.spawnflags & 1024)) )
  {
   ED_Free (ent);
   inhibit++;
   continue;
...
void PR_LoadProgs (void)
{
 ...
 if (progs->version != 6)
  Sys_Error ("progs.dat has wrong version number (%i should be %i)", progs->version, 6);
