# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c"
# 42 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/include/gluos.h" 1
# 43 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c" 2
...
# 44 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c" 2
...
# 9 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/setjmp.h" 3
...
# 10 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/setjmp.h" 2 3
...
void __attribute__((visibility("default"))) __gl_noCombineData( GLdouble coords[3], void *data[4],
    GLfloat weight[4], void **outData,
    void *polygonData );
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c" 2
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c" 2
...
# 47 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 48 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c" 2
...
static void Normalize( GLdouble v[3] )
{
  ...
  ((len > 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c", 58, __FUNCTION__, "len > 0"));
  len = sqrt( len );
  v[0] /= len;
  v[1] /= len;
  v[2] /= len;
...
static int LongAxis( GLdouble v[3] )
{
  ...
  if( ((v[1]) < 0 ? -(v[1]) : (v[1])) > ((v[0]) < 0 ? -(v[0]) : (v[0])) ) { i = 1; }
  if( ((v[2]) < 0 ? -(v[2]) : (v[2])) > ((v[i]) < 0 ? -(v[i]) : (v[i])) ) { i = 2; }
  return i;
}
...
static void ComputeNormal( GLUtesselator *tess, GLdouble norm[3] )
{
  ...
  maxVal[0] = maxVal[1] = maxVal[2] = -2 * 1.0e150;
  minVal[0] = minVal[1] = minVal[2] = 2 * 1.0e150;
...
# 198 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c"
void __gl_projectPolygon( GLUtesselator *tess )
{
  GLUvertex *v, *vHead = &tess->mesh->vHead;
  GLdouble w, norm[3];
  GLdouble *sUnit, *tUnit;
  int i, computedNormal = 0;
  ...
  tUnit = tess->tUnit;
  i = LongAxis( norm );
# 240 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/normal.c"
  sUnit[i] = 0;
  sUnit[(i+1)%3] = 1.0;
  sUnit[(i+2)%3] = 0.0;

  tUnit[i] = 0;
  tUnit[(i+1)%3] = (norm[i] > 0) ? -0.0 : 0.0;
