# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_rlight.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_rlight.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/gl_rlight.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/gl_rlight.c" 2
...
void ProjectVector(const vec3_t b,const vec3_t a,vec3_t c) {
   ...
   dpa = (a[0]*a[0]+a[1]*a[1]+a[2]*a[2]);
   dpab = (a[0]*b[0]+a[1]*b[1]+a[2]*b[2])/dpa;
   c[0] = a[0] * dpab;
   c[1] = a[1] * dpab;
   c[2] = a[2] * dpab;
}
...
void ProjectPlane(const vec3_t src,const vec3_t v1,const vec3_t v2,vec3_t dst) {
 ...
 {dst[0]=t1[0]+t2[0];dst[1]=t1[1]+t2[1];dst[2]=t1[2]+t2[2];};
}
...
# 84 "d:/Data/Nintendo/TenebraeGX/src/gl_rlight.c"
mplane_t *lightplane;
vec3_t lightspot;
...
int RecursiveLightPoint (mnode_t *node, vec3_t start, vec3_t end)
{
 ...
 {lightspot[0]=mid[0];lightspot[1]=mid[1];lightspot[2]=mid[2];};
 lightplane = plane;
 ...
 for (i=0 ; i<node->numsurfaces ; i++, surf++)
 {
  ...
  s = (mid[0]*tex->vecs[0][0]+mid[1]*tex->vecs[0][1]+mid[2]*tex->vecs[0][2]) + tex->vecs[0][3];
  t = (mid[0]*tex->vecs[1][0]+mid[1]*tex->vecs[1][1]+mid[2]*tex->vecs[1][2]) + tex->vecs[1][3];;
