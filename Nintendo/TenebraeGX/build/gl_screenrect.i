# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_screenrect.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_screenrect.c"
# 28 "d:/Data/Nintendo/TenebraeGX/src/gl_screenrect.c"
...
# 29 "d:/Data/Nintendo/TenebraeGX/src/gl_screenrect.c" 2
...
# 61 "d:/Data/Nintendo/TenebraeGX/src/gl_screenrect.c"
void R_RectsAdd(screenrect_t *add, screenrect_t *res) {
 res->coords[0] = (res->coords[0]<add->coords[0]?res->coords[0]:add->coords[0]);
 res->coords[1] = (res->coords[1]<add->coords[1]?res->coords[1]:add->coords[1]);
 res->coords[2] = (res->coords[2]>add->coords[2]?res->coords[2]:add->coords[2]);
 res->coords[3] = (res->coords[3]>add->coords[3]?res->coords[3]:add->coords[3]);
}
...
# 88 "d:/Data/Nintendo/TenebraeGX/src/gl_screenrect.c"
...
screenrect_t *recList;
screenrect_t totalRect;
int recsUsed;
...
qboolean R_CheckRectList(screenrect_t *rec) {
 ...
 r = recList;
 while (r) {
  if (R_RectOverlap(rec,r)) return 0;
  r = r->next;
 }
 return 1;
}
