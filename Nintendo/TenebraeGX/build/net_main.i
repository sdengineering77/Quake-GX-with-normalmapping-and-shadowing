# 1 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/net_main.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.h" 1
# 28 "d:/Data/Nintendo/TenebraeGX/src/net_vcr.h"
int VCR_Init (void);
...
# 24 "d:/Data/Nintendo/TenebraeGX/src/net_main.c" 2

qsocket_t *net_activeSockets = ((void *)0);
qsocket_t *net_freeSockets = ((void *)0);
int net_numsockets = 0;

qboolean serialAvailable = 0;
qboolean ipxAvailable = 0;
qboolean tcpipAvailable = 0;
...
static qboolean listening = 0;

qboolean slistInProgress = 0;
qboolean slistSilent = 0;
qboolean slistLocal = 1;
static double slistStartTime;
static int slistLastShown;

static void Slist_Send(void);
static void Slist_Poll(void);
PollProcedure slistSendProcedure = {((void *)0), 0.0, Slist_Send};
PollProcedure slistPollProcedure = {((void *)0), 0.0, Slist_Poll};
...
# 110 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
qsocket_t *NET_NewQSocket (void)
{
 qsocket_t *sock;

 if (net_freeSockets == ((void *)0))
  return ((void *)0);
...
# 365 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
int hostCacheCount = 0;
hostcache_t hostcache[8];
...
# 450 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
struct
{
 double time;
 int op;
 ...
 for (net_driverlevel=0 ; net_driverlevel<net_numdrivers; net_driverlevel++)
 {
  ...
  if (ret)
  {
   if (recording)
   {
    ...
    Sys_FileWrite (vcrFile, ret->address, 64);
   }
   return ret;
  }
 }
...
# 529 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
struct
{
 double time;
 int op;
...
int NET_GetMessage (qsocket_t *sock)
{
 ...
 {
# 571 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
...
# 630 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
struct
{
 double time;
 int op;
...
# 708 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
qboolean NET_CanSendMessage (qsocket_t *sock)
{
 int r;
...
# 817 "d:/Data/Nintendo/TenebraeGX/src/net_main.c"
void NET_Init (void)
{
 int i;
 int controlSocket;
...
static PollProcedure *pollProcedureList = ((void *)0);
...
void SchedulePollProcedure(PollProcedure *proc, double timeOffset)
{
 ...
 for (pp = pollProcedureList, prev = ((void *)0); pp; pp = pp->next)
 {
