# 1 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c"
...
# 80 "c:/utils/devkitPro/libogc/include/ogc/dsp.h"
...
# 16 "c:/utils/devkitPro/libogc/include/ogc/lwp_queue.h"
...
# 51 "c:/utils/devkitPro/libogc/include/ogc/arqueue.h"
enum {
 ARQ_TASK_READY = 0,
 ARQ_TASK_RUNNING,
 ARQ_TASK_FINISHED
...
# 33 "c:/utils/devkitPro/libogc/include/ogc/cast.h"
...
# 111 "c:/utils/devkitPro/libogc/include/ogc/dvd.h"
...
# 146 "c:/utils/devkitPro/libogc/include/ogc/exi.h"
...
# 69 "c:/utils/devkitPro/libogc/include/ogc/si.h"
...
# 30 "c:/utils/devkitPro/libogc/include/ogc/context.h"
...
# 51 "c:/utils/devkitPro/libogc/include/ogc/mutex.h"
typedef u32 mutex_t;
...
# 58 "c:/utils/devkitPro/libogc/include/ogc/message.h"
typedef u32 mqbox_t;
...
# 52 "c:/utils/devkitPro/libogc/include/ogc/semaphore.h"
typedef u32 sem_t;
...
# 46 "c:/utils/devkitPro/libogc/include/ogc/pad.h"
...
# 10 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/time.h" 3
...
# 11 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/time.h" 2 3
...
# 12 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/time.h" 2 3
...
# 30 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/time.h" 2 3
...
# 138 "c:/utils/devkitPro/libogc/include/ogc/system.h"
typedef u32 syswd_t;
...
# 10 "c:/utils/devkitPro/libogc/include/ogc/usbgecko.h"
...
# 45 "c:/utils/devkitPro/libogc/include/ogc/texconv.h"
...
# 56 "c:/utils/devkitPro/libogc/include/ogc/ipc.h"
...
# 60 "c:/utils/devkitPro/libogc/include/ogc/es.h"
typedef u32 sigtype;
...
# 50 "c:/utils/devkitPro/libogc/include/ogc/stm.h"
...
# 48 "c:/utils/devkitPro/libogc/include/ogc/ios.h"
...
# 101 "c:/utils/devkitPro/libogc/include/ogc/usb.h"
...
# 22 "c:/utils/devkitPro/libogc/include/ogc/isfs.h"
...
# 50 "c:/utils/devkitPro/libogc/include/ogc/conf.h"
enum {
 CONF_BIGARRAY = 1,
 CONF_SMALLARRAY,
 CONF_BYTE,
...
# 65 "c:/utils/devkitPro/libogc/include/ogc/wiilaunch.h"
...
# 3 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp.h" 1
# 4 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_threadq.h" 1




# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_tqdata.h" 1
# 20 "c:/utils/devkitPro/libogc/include/ogc/lwp_tqdata.h"
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_queue.h" 1
# 21 "c:/utils/devkitPro/libogc/include/ogc/lwp_tqdata.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_priority.h" 1




# 1 "c:/utils/devkitPro/libogc/include/ogc/machine/processor.h" 1




# 1 "c:/utils/devkitPro/libogc/include/ogc/machine/asm.h" 1
# 6 "c:/utils/devkitPro/libogc/include/ogc/machine/processor.h" 2
# 173 "c:/utils/devkitPro/libogc/include/ogc/machine/processor.h"
...
# 6 "c:/utils/devkitPro/libogc/include/ogc/lwp_priority.h" 2
# 14 "c:/utils/devkitPro/libogc/include/ogc/lwp_priority.h"
...
# 22 "c:/utils/devkitPro/libogc/include/ogc/lwp_tqdata.h" 2

typedef struct _lwpthrqueue {
 union {
  lwp_queue fifo;
  lwp_queue priority[4];
 } queues;
 u32 sync_state;
 u32 mode;
 u32 state;
...
# 6 "c:/utils/devkitPro/libogc/include/ogc/lwp_threadq.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h" 1
...
# 6 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_states.h" 1
# 7 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_tqdata.h" 1
# 8 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_watchdog.h" 1
# 65 "c:/utils/devkitPro/libogc/include/ogc/lwp_watchdog.h"
...
# 9 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_objmgr.h" 1
# 15 "c:/utils/devkitPro/libogc/include/ogc/lwp_objmgr.h"
...
# 10 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h" 2
# 19 "c:/utils/devkitPro/libogc/include/ogc/lwp_threads.h"
typedef enum
{
...
u32 __lwp_thread_init(lwp_cntrl *,void *,u32,u32,u32,_Bool);
...
# 7 "c:/utils/devkitPro/libogc/include/ogc/lwp_threadq.h" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_watchdog.h" 1
# 8 "c:/utils/devkitPro/libogc/include/ogc/lwp_threadq.h" 2
...
# 5 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_mutex.h" 1




# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_threadq.h" 1
# 6 "c:/utils/devkitPro/libogc/include/ogc/lwp_mutex.h" 2
# 31 "c:/utils/devkitPro/libogc/include/ogc/lwp_mutex.h"
...
# 6 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:/utils/devkitPro/libogc/include/ogc/lwp_watchdog.h" 1
# 7 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 42 "c:/utils/devkitPro/libogc/include/bte/bd_addr.h"
struct bd_addr {
  u8 addr[6];
};
# 6 "c:/utils/devkitPro/libogc/include/bte/bte.h" 2
# 73 "c:/utils/devkitPro/libogc/include/bte/bte.h"
struct l2cap_pcb;
struct ctrl_req_t;
...
# 694 "c:/utils/devkitPro/libogc/include/wiiuse/wiiuse.h"
...
# 143 "c:/utils/devkitPro/libogc/include/wiiuse/wpad.h"
...
# 8 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:/utils/devkitPro/libogc/include/ogcsys.h" 1
# 35 "c:/utils/devkitPro/libogc/include/ogcsys.h"
int nanosleep(struct timespec *tb);
# 9 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2

# 1 "c:/utils/devkitPro/libogc/include/fat.h" 1
# 39 "c:/utils/devkitPro/libogc/include/fat.h"
...
extern _Bool fatInit (uint32_t cacheSize, _Bool setAsDefaultDevice);




extern _Bool fatInitDefault (void);
...
extern _Bool fatMountSimple (const char* name, const DISC_INTERFACE* interface);
# 89 "c:/utils/devkitPro/libogc/include/fat.h"
extern _Bool fatMount (const char* name, const DISC_INTERFACE* interface, sec_t startSector, uint32_t cacheSize, uint32_t SectorsPerPage);
...
# 11 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/unistd.h" 1 3



# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 1 3
# 13 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 3
# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/include/stddef.h" 1 3 4
# 14 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 2 3
...
# 130 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 3
...
pid_t vfork (void );
# 223 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 3
int ftruncate (int __fd, off_t __length);
int truncate (const char *, off_t __length);
# 242 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 3
ssize_t readlink (const char *__path, char *__buf, size_t __buflen);



int symlink (const char *__name1, const char *__name2);
# 5 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/unistd.h" 2 3
# 12 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
# 1 "c:/utils/devkitPro/libogc/include/network.h" 1




# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/time.h" 1 3
# 17 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/time.h" 3
struct timeval {
  time_t tv_sec;
  suseconds_t tv_usec;
};
...
# 37 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/time.h" 3
struct itimerval {
  struct timeval it_interval;
  struct timeval it_value;
};
# 74 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/time.h" 3
...
int setitimer (int __which, const struct itimerval *__value, struct itimerval *__ovalue)
                                 ;
# 6 "c:/utils/devkitPro/libogc/include/network.h" 2
# 48 "c:/utils/devkitPro/libogc/include/network.h"
struct linger {
       int l_onoff;
       int l_linger;
};
# 211 "c:/utils/devkitPro/libogc/include/network.h"
struct in_addr {
  u32 s_addr;
};
...
s32 if_config( char *local_ip, char *netmask, char *gateway,_Bool use_dhcp);
s32 if_configex(struct in_addr *local_ip,struct in_addr *netmask,struct in_addr *gateway,_Bool use_dhcp);
...
# 13 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 15 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 48 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/stdio.h" 3
...
# 16 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 18 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 10 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/iosupport.h" 3
...
# 14 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/statvfs.h" 3
struct statvfs {
...
# 30 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/dirent.h" 3
 struct dirent {
  ino_t d_ino;
...
# 19 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 20 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 15 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/errno.h" 3
...
# 21 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
# 34 "d:/Data/Nintendo/TenebraeGX/src/common.h"
...
# 25 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c" 2
...
static const double TB_TIMERCLOCK_SEC_INV = ((double)1)/((double)(243000000u/4000)*1000);
 ...
 if (dirdata && filter){
  ...
  while ((entry = readdir (dir))){
   ...
   if (uxdata->lsize == uxdata->count) {
    list = Z_Malloc (sizeof(struct dirent *) * (uxdata->lsize += 10));
  ...
  if (uxdata->count) {
   ...
   uxdata_free (uxdata);
   Sys_Printf("No entries in system");
  }
 }
 return ((void *)0);
}
 ...
 if (dirdata){
  ...
  if (uxdata) {
   ...
   if (uxdata->count<uxdata->lsize){
    strncpy (dirdata->entry+uxdata->pathlen, uxdata->list[uxdata->count]->d_name, sizeof(dirdata->entry)-uxdata->pathlen);
    return dirdata;
   }
...
# 209 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c"
FILE *sys_handles[10];
...
int Sys_FileOpenWrite (char *path)
{
 ...
 f = fopen(path, "wb");
 if (!f)
  Sys_Error ("Error opening %s: %s", path,strerror((*__errno())));
 sys_handles[i] = f;
...
# 332 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c"
void Sys_MakeCodeWriteable (unsigned long startaddr, unsigned long length)
{
}
...
void Sys_Error (char *error, ...) {
 ...
 vsnprintf (msg, MAX_CHARS_SYSPRINTF-1, error, argptr);
...
void Sys_Printf (char *fmt, ...) {
 ...
 vsnprintf (msg, MAX_CHARS_SYSPRINTF-1, fmt, argptr);
...
void Sys_AcceptLogTerminal(void) {
 ...
 if_config ( localip, netmask, gateway, 1);




 sock = net_socket (2, 1, 0);
...
# 526 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c"
void *align32 (void *p)
{
...
void testRead(int *i) {
 ...
 struct dirent *entry;
 struct stat statbuf;
# 549 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c"
 FILE *file = fopen("/apps/TenebraeGX/id1/PAK1.PAK", "rb");

    int num = 100;
 int res;
 int dest;
    if (!file ) Sys_Error("Error!");
 while((res = fread ((byte *) &dest, 1, 1, file)) >= 0 && num-- > 0) {
  printf("%5d %02X -%c -", res, (byte) dest, dest);
...
static void *quakeMain (void *_void) {
 unsigned int level, real_heap_size;
 char *heap;
 double prevTime, currTime, deltaTime;
 ...
 { register u32 _disable_mask = 0; level = 0; __asm__ __volatile__ ( "mfmsr %0\n" "rlwinm %1,%0,0,17,15\n" "mtmsr %1\n" "extrwi %0,%0,1,16" : "=&r" ((level)), "=&r" ((_disable_mask)) : "0" ((level)), "1" ((_disable_mask)) ); };
 ...
 {
  { register u32 _enable_mask = 0; __asm__ __volatile__ ( "    cmpwi %0,0\n" "    beq 1f\n" "    mfmsr %1\n" "    ori %1,%1,0x8000\n" "    mtmsr %1\n" "1:" : "=r"((level)),"=&r" ((_enable_mask)) : "0"((level)),"1" ((_enable_mask)) ); };
 ...
 parms.basedir = "/apps/TenebraeGX";
    parms.argc = local_argc;
    parms.argv = local_argv;
 parms.membase = heap;

 Sys_Printf("main membase %p, size %d\n", parms.membase, parms.memsize);
...
# 658 "d:/Data/Nintendo/TenebraeGX/src/sys_ogc.c"
 local_argc = argc;
 local_argv = argv;
