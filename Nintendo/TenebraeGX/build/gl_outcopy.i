# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c"
...
# 2 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c" 2
...
# 3 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c" 2
...
# 4 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c" 2

void glReadBuffer( GLenum mode )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 7); return; };
 ...
 case 0x0402:
  ...
  break;
 default:
  _glSetErrorEx(0x0502, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 21);
  return;
 }
};
...
static void write_rgb(void *pixel, GLenum format, GLenum type, u8 *rgba)
{
 ...
 switch(type)
 {
  ...
  case 0x1A00:
  default:
   ((0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 310, __FUNCTION__, "0"));
   break;
 }

 ((fun) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 314, __FUNCTION__, "fun"));
 ...
 switch(format)
 {
  ...
  case 0x1902:
  default:
   ((0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 357, __FUNCTION__, "0"));
   break;
 }
}
...
void glReadPixels( GLint x, GLint y,
                                    ...
                                    GLvoid *pixels )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 390); return; };

 if(width < 0 || height < 0)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 394);
  return;
 }
 ...
 switch(format)
 {
  ...
  case 0x1902:
  default:
   _glSetErrorEx(0x0500, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 416);
   return;
   break;
 }
 ...
 switch(type)
 {
  ...
  case 0x1A00:
  default:
   _glSetErrorEx(0x0500, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 446);
   return;
   break;
 }
...
void glGetTexImage( GLenum target, GLint level,
                                     ...
                                     GLvoid *pixels )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/TenebraeGX/gl2gx/source/gl_outcopy.c", 524); return; };
};
