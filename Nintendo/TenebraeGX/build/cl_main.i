# 1 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c" 2
...
cvar_t sbar_updateperframe = {"sbar_updateperframe","1", 1};


client_static_t cls;
client_state_t cl;

efrag_t cl_efrags[640];
entity_t cl_entities[2048];
entity_t cl_static_entities[128];
lightstyle_t cl_lightstyle[64];
dlight_t cl_dlights[32];

int cl_numvisedicts;
entity_t *cl_visedicts[256];


int cl_numlightvisedicts;
entity_t *cl_lightvisedicts[256];
...
void CL_ClearState (void)
{
 ...
 cl.free_efrags[i].entnext = ((void *)0);
}
# 105 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void CL_Disconnect (void)
{
...
# 154 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void CL_EstablishConnection (char *host)
{
...
# 181 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void CL_SignonReply (void)
{
 char str[8192];
...
# 229 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void CL_NextDemo (void)
{
 char str[1024];
 ...
 if (cls.demonum > 2) cls.demonum = 0;
# 252 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
 sprintf (str,"playdemo demo%d\n", cls.demonum+1);
 Cbuf_InsertText (str);
 cls.demonum++;
}
...
# 288 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void SetPal (int i)
{
# 322 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
}
...
# 378 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void CL_DecayLights (void)
{
 int i;
 dlight_t *dl;
...
# 407 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
...
# 460 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
void CL_RelinkEntities (void)
{
 ...
 for (i=1,ent=cl_entities+1 ; i<cl.num_entities ; i++,ent++)
 {
  ...
  {oldorg[0]=ent->origin[0];oldorg[1]=ent->origin[1];oldorg[2]=ent->origin[2];};
  ...
  if (ent->effects & 16)
  {
   ...
   {dl->color[0]=ent->color[0];dl->color[1]=ent->color[1];dl->color[2]=ent->color[2];};
   ...
   {dl->angles[0]=ent->angles[0];dl->angles[1]=ent->angles[1];dl->angles[2]=ent->angles[2];};

   dl->pflags = ent->pflags;
  }
  if ((ent->effects & (64 | 128)) == (64 | 128))
  {
   dl = CL_AllocDlight (i);
   {dl->origin[0]=ent->origin[0];dl->origin[1]=ent->origin[1];dl->origin[2]=ent->origin[2];};
   dl->radius = 200 + (rand()&31);
...
# 714 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
  if (ent->model->flags & 4)
   R_RocketTrail (oldorg, ent->origin, 2);
  else if (ent->model->flags & 32)
   R_RocketTrail (oldorg, ent->origin, 4);
  else if (ent->model->flags & 16)
   R_RocketTrail (oldorg, ent->origin, 3);
  else if (ent->model->flags & 64)
   R_RocketTrail (oldorg, ent->origin, 5);
  else if (ent->model->flags & 1)
  {
...
# 779 "d:/Data/Nintendo/TenebraeGX/src/cl_main.c"
int CL_ReadFromServer (void)
{
 int ret;
