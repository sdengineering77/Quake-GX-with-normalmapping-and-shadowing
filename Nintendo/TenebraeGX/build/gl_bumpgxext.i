# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c"
...
# 3 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c" 2
# 12 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c"
void R_DrawWorldBumped() {
 ...
 while (1) {
  ...
  diffuse = R_TextureAnimation (surf->texinfo->texture);
     GX_BindGLTex(0, diffuse->gl_texturenum);
  ...
  color.a = 255 * b;
  GX_SetTevColor(3, color);

  lightPos+=4;

  GX_Begin(GX_AsGXPrimitiveType(command), 2, num);
  for (i=0; i<num; i++, v+= 7) {
   float *attnVertices = &lightCmds[lightPos].asFloat;
   GX_Position3f32(v[0], v[1], v[2]);
   GX_TexCoord2f32(v[3], v[4]);
   GX_TexCoord2f32(attnVertices[0], attnVertices[1]);
...
# 91 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c"
void R_DrawBrushBumped(entity_t *e) {
 GXColor color;
...
# 161 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c"
...
# 195 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c"
void R_DrawLightEntities (shadowlight_t *l)
{
    int i;
  ...
  return;
    ...
    if (!currentshadowlight->visible)
  return;
# 239 "d:/Data/Nintendo/TenebraeGX/src/gl_bumpgxext.c"
