# 1 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
# 27 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
...
# 28 "d:/Data/Nintendo/TenebraeGX/src/keys.c" 2
# 40 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
...
keyname_t keynames[] =
{
 ...
 {"MOUSE2", 201},
 {"MOUSE3", 202},
# 142 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
 {"JOY1", 203},
 {"JOY2", 204},
 {"JOY3", 205},
 {"JOY4", 206},
...
# 206 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
void Key_Console (int key)
{
 char *cmd = 0;
# 304 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
 if (key == 13)
 {
...
# 483 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
 if (key < 32 || key > 127)
  return;

 if (key_linepos < 256 -1)
 {
...
# 559 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
int Key_StringToKeynum (char *str)
{
 ...
 if (!str[1])
  return str[0];
# 581 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
...
# 598 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
char *Key_KeynumToString (int keynum)
{
 keyname_t *kn;
...
# 735 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
void Key_WriteBindings (FILE *f)
{
 int i;
...
void Key_Init (void)
{
 ...
 consolekeys['`'] = 0;
 consolekeys['~'] = 0;
# 804 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
 for (i=0 ; i<256 ; i++)
  keyshift[i] = i;
 for (i='a' ; i<='z' ; i++)
  keyshift[i] = i - 'a' + 'A';
...
# 852 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
void Key_Event (int key, qboolean down)
{
 char *kb;
 char cmd[1024];
 ...
 if (down)
 {
# 881 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
  key_repeats[key]++;
  if ((key < 127 || key > 131) && key != 255 && key_repeats[key] > 1)
...
# 927 "d:/Data/Nintendo/TenebraeGX/src/keys.c"
 if (!down)
 {
  kb = keybindings[key];
  if (kb && kb[0] == '+')
