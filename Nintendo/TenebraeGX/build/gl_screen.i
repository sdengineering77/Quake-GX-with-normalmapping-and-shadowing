# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
# 23 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 24 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c" 2
extern int numUsedShadowLights;
# 74 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
cvar_t gl_triplebuffer = {"gl_triplebuffer", "1", 1 };
...
# 129 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 144 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_CenterPrint (char *str)
{
...
# 232 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
float CalcFov (float fov_x, float width, float height)
{
        float a;
        float x;
        ...
        x = width/tan(fov_x/360*3.14159265358979323846);

        a = atan (height/x);

        a = a*360/3.14159265358979323846;

        return a;
}
# 257 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 344 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_SizeUp_f (void)
{
 Cvar_SetValue ("viewsize",scr_viewsize.value+10);
 vid.recalc_refdef = 1;
}
# 358 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_SizeDown_f (void)
{
 Cvar_SetValue ("viewsize",scr_viewsize.value-10);
 vid.recalc_refdef = 1;
}
# 371 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_Init (void)
{
...
# 405 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 486 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 507 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 586 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_SetUpToDrawConsole (void)
{
 ...
 con_forcedup = !cl.worldmodel || cls.signon != 4;
...
# 660 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
...
# 675 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_ScreenShot_f (void)
{
 byte *buffer;
 char pcxname[80];
 char checkname[128];
 int i;
# 694 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
        int c, temp;
...
# 761 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
 ...
 glReadPixels (glx, gly, glwidth, glheight, 0x1907, 0x1401, buffer+18 );
...
# 796 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_BeginLoadingPlaque (void)
{
 S_StopAllSounds (1);
...
# 879 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
int SCR_ModalMessage (char *text)
{
 ...
 do
 {
  key_count = -1;
  Sys_SendKeyEvents ();
 } while (key_lastpress != 'y' && key_lastpress != 'n' && key_lastpress != 27);
...
# 916 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_BringDownConsole (void)
{
 int i;
...
# 964 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
void SCR_UpdateScreen (void)
{
 int i;
...
# 1038 "d:/Data/Nintendo/TenebraeGX/src/gl_screen.c"
 SCR_TileClear ();
