# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c" 2

const char *gl_vendor;
const char *gl_renderer;
const char *gl_version;
const char *gl_extensions;
qboolean fullsbardraw = 0;


float vid_gamma = 1.0;

qboolean is8bit = 0;
qboolean isPermedia = 0;
qboolean gl_mtexable = 0;
qcardtype gl_cardtype = GENERIC;
qboolean gl_var = 0;
qboolean gl_texcomp = 0;
int gl_twosidedstencil = 0;
...
# 78 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
qboolean gl_palettedtex = 0;


qboolean gl_texturefilteranisotropic = 0;
...
# 100 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
...
# 235 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
void CheckMultiTextureExtensions(void)
{
     if (strstr(gl_extensions, "GL_ARB_multitexture")) {

          qglActiveTextureARB = (PFNGLACTIVETEXTUREARBPROC)_glGetProcAddress("glActiveTextureARB");
          qglClientActiveTextureARB = (PFNGLCLIENTACTIVETEXTUREARBPROC)_glGetProcAddress("glClientActiveTextureARB");
          qglMultiTexCoord1fARB = (PFNGLMULTITEXCOORD1FARBPROC)_glGetProcAddress("glMultiTexCoord1fARB");
          qglMultiTexCoord2fARB = (PFNGLMULTITEXCOORD2FARBPROC)_glGetProcAddress("glMultiTexCoord2fARB");
          qglMultiTexCoord2fvARB = (PFNGLMULTITEXCOORD2FVARBPROC)_glGetProcAddress("glMultiTexCoord2fvARB");
          qglMultiTexCoord3fARB = (PFNGLMULTITEXCOORD3FARBPROC)_glGetProcAddress("glMultiTexCoord3fARB");
          qglMultiTexCoord3fvARB = (PFNGLMULTITEXCOORD3FVARBPROC)_glGetProcAddress("glMultiTexCoord3fvARB");
          gl_mtexable = 1;
...
{
# 280 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
{
# 306 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
{
# 360 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
{
# 390 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
     gl_var = 0;
...
{
# 423 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}

void CheckParheliaExtensions(void)
{
# 447 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}


void CheckARBFragmentExtensions(void)
{
# 473 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}

void CheckNV3xFragmentExtensions(void)
{
# 525 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}

void CheckGL2FragmentExtensions(void)
{
# 552 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}


void CheckAnisotropicExtension(void)
{
# 578 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
# 603 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
void CheckTwoSidedStencil(void)
{
 if (COM_CheckParm ("-notwosidedstencil"))
  return;
# 624 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
void GL_Init (void)
{
     ...
     gl_vendor = (const char*)glGetString (0x1F00);
     Con_Printf ("GL_VENDOR: %s\n", gl_vendor);
     gl_renderer = (const char*)glGetString (0x1F01);
     Con_Printf ("GL_RENDERER: %s\n", gl_renderer);

     gl_version = (const char*)glGetString (0x1F02);
     Con_Printf ("GL_VERSION: %s\n", gl_version);
     gl_extensions = (const char*)glGetString (0x1F03);
  ...
  CheckTwoSidedStencil();
     ...
     glGetIntegerv (0x84E2,&supportedTmu);
...
# 765 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
...
{
# 828 "d:/Data/Nintendo/TenebraeGX/src/gl_common.c"
}
