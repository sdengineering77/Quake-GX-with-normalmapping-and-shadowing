# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
# 42 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/include/gluos.h" 1
# 43 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 44 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c" 2
...
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c" 2
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h" 1
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h"
...
# 47 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h" 2
...
void __attribute__((visibility("default"))) __gl_noCombineData( GLdouble coords[3], void *data[4],
    GLfloat weight[4], void **outData,
    void *polygonData );
# 47 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c" 2
...
# 48 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c" 2
# 56 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
struct FaceCount {
  long size;
  GLUhalfEdge *eStart;
...
# 85 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
void __gl_renderMesh( GLUtesselator *tess, GLUmesh *mesh )
{
  GLUface *f;
  ...
  for( f = mesh->fHead.next; f != &mesh->fHead; f = f->next ) {
    ...
    if( f->inside && ! f->marked ) {
      ...
      ((f->marked) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c", 103, __FUNCTION__, "f->marked"));
    }
  }
...
# 161 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
static struct FaceCount MaximumFan( GLUhalfEdge *eOrig )
{
...
static struct FaceCount MaximumStrip( GLUhalfEdge *eOrig )
{
# 200 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
...
static void RenderTriangle( GLUtesselator *tess, GLUhalfEdge *e, long size )
{
  ...
  ((size == 1) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c", 246, __FUNCTION__, "size == 1"));
...
static void RenderFan( GLUtesselator *tess, GLUhalfEdge *e, long size )
{
  ...
  ((size == 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c", 303, __FUNCTION__, "size == 0"));
  if (tess->callEndData != &__gl_noEndData) (*tess->callEndData)(tess->polygonData); else (*tess->callEnd)();;
}
...
static void RenderStrip( GLUtesselator *tess, GLUhalfEdge *e, long size )
{
  ...
  ((size == 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c", 331, __FUNCTION__, "size == 0"));
  if (tess->callEndData != &__gl_noEndData) (*tess->callEndData)(tess->polygonData); else (*tess->callEnd)();;
}
# 342 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
void __gl_renderBoundary( GLUtesselator *tess, GLUmesh *mesh )
{
  GLUface *f;
  GLUhalfEdge *e;
...
# 374 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
{
  ...
  int sign = 0;
# 394 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
  if( ! check ) {
...
# 444 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/render.c"
GLboolean __gl_renderCache( GLUtesselator *tess )
{
  CachedVertex *v0 = tess->cache;
  CachedVertex *vn = v0 + tess->cacheCount;
