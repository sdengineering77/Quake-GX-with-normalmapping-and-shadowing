# 1 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/sbar.c" 2
...
# 75 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 90 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 260 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
void Sbar_DrawPic (int x, int y, qpic_t *pic)
{
 if (cl.gametype == 1)
  Draw_Pic (x , y + (vid.height-24), pic);
 else
  Draw_Pic (x + ((vid.width - 320)>>1), y + (vid.height-24), pic);
}
...
void Sbar_DrawTransPic (int x, int y, qpic_t *pic)
{
 if (cl.gametype == 1)
  ...
  Draw_TransPic (x + ((vid.width - 320)>>1), y + (vid.height-24), pic);
}
# 288 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
void Sbar_DrawCharacter (int x, int y, int num)
{
 if (cl.gametype == 1)
  Draw_Character ( x + 4 , y + vid.height-24, num);
 else
  Draw_Character ( x + ((vid.width - 320)>>1) + 4 , y + vid.height-24, num);
}
...
void Sbar_DrawString (int x, int y, char *str)
{
 if (cl.gametype == 1)
  ...
  Draw_String (x + ((vid.width - 320)>>1), y+ vid.height-24, str);
}
...
char scoreboardtext[64][20];
int scoreboardtop[64];
int scoreboardbottom[64];
int scoreboardcount[64];
int scoreboardlines;
...
# 457 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
void Sbar_SoloScoreboard (void)
{
 ...
 sprintf (str,"Monsters:%3i /%3i", cl.stats[14], cl.stats[12]);
 Sbar_DrawString (8, 4, str);

 sprintf (str,"Secrets :%3i /%3i", cl.stats[13], cl.stats[11]);
...
# 537 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
}
# 546 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 766 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 828 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
void Sbar_Draw (void)
{
 ...
 else if (sb_lines)
 {
  ...
  else
  {
   if (rogue)
   {
    Sbar_DrawNum (24, 0, cl.stats[4], 3,
        cl.stats[4] <= 25);
    if (cl.items & 33554432)
     Sbar_DrawPic (0, 0, sb_armor[2]);
    else if (cl.items & 16777216)
     Sbar_DrawPic (0, 0, sb_armor[1]);
    else if (cl.items & 8388608)
   ...
   else
   {
    ...
    if (cl.items & 32768)
     Sbar_DrawPic (0, 0, sb_armor[2]);
    else if (cl.items & 16384)
     Sbar_DrawPic (0, 0, sb_armor[1]);
    else if (cl.items & 8192)
     Sbar_DrawPic (0, 0, sb_armor[0]);
   }
  }
  ...
  Sbar_DrawNum (136, 0, cl.stats[0], 3
  , cl.stats[0] <= 25);
  ...
  if (rogue)
  {
   ...
   else if (cl.items & 256)
    Sbar_DrawPic (224, 0, sb_ammo[1]);
   else if (cl.items & 512)
    Sbar_DrawPic (224, 0, sb_ammo[2]);
   else if (cl.items & 1024)
    Sbar_DrawPic (224, 0, sb_ammo[3]);
   else if (cl.items & 67108864)
    Sbar_DrawPic (224, 0, rsb_ammo[0]);
   else if (cl.items & 134217728)
    Sbar_DrawPic (224, 0, rsb_ammo[1]);
   else if (cl.items & 268435456)
  ...
  else
  {
   if (cl.items & 256)
    ...
    Sbar_DrawPic (224, 0, sb_ammo[2]);
   else if (cl.items & 2048)
    Sbar_DrawPic (224, 0, sb_ammo[3]);
  }

  Sbar_DrawNum (248, 0, cl.stats[3], 3,
       cl.stats[3] <= 10);
 }
...
# 1059 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 1160 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
# 1261 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
...
void Sbar_IntermissionOverlay (void)
{
 ...
 Sbar_IntermissionNumber ((vid.width/2), (vid.height/2)- 16, cl.stats[13], 3, 0);
 Draw_TransPic ((vid.width/2)+72,(vid.height/2)- 16,sb_slash);
 Sbar_IntermissionNumber ((vid.width/2)+80, (vid.height/2)- 16, cl.stats[11], 3, 0);

 Sbar_IntermissionNumber ((vid.width/2), (vid.height/2)+ 24, cl.stats[14], 3, 0);
 Draw_TransPic ((vid.width/2)+72,(vid.height/2)+ 24,sb_slash);
 Sbar_IntermissionNumber ((vid.width/2)+80, (vid.height/2)+ 24, cl.stats[12], 3, 0);
}
# 1318 "d:/Data/Nintendo/TenebraeGX/src/sbar.c"
void Sbar_FinaleOverlay (void)
{
 qpic_t *pic;
