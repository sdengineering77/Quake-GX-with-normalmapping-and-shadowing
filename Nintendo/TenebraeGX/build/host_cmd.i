# 1 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
# 21 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 22 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c" 2

extern cvar_t pausable;

int current_skill;

cvar_t useprofiles = {"useprofiles","1"};
...
# 115 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
void Host_God_f (void)
{
 ...
 sv_player->v.flags = (int)sv_player->v.flags ^ 64;
 if (!((int)sv_player->v.flags & 64) )
...
void Host_Notarget_f (void)
{
 ...
 sv_player->v.flags = (int)sv_player->v.flags ^ 128;
 if (!((int)sv_player->v.flags & 128) )
...
void Host_Noclip_f (void)
{
 ...
 if (sv_player->v.movetype != 8)
 {
  noclip_anglehack = 1;
  sv_player->v.movetype = 8;
...
# 185 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 215 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 258 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 313 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
void Host_Changelevel_f (void)
{
# 343 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
 char level[64];
...
# 368 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 398 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
void Host_Reconnect_f (void)
{
 SCR_BeginLoadingPlaque ();
 cls.signon = 0;
}
# 411 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 444 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
void Host_SavegameComment (char *text)
{
 ...
 sprintf (kills,"kills:%3i/%3i", cl.stats[14], cl.stats[12]);
...
# 912 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
void Host_Name_f (void)
{
 ...
 MSG_WriteByte (&sv.reliable_datagram, 13);
...
void Host_Version_f (void)
{
 ...
 Con_Printf ("Exe: ""16:14:02"" ""Sep 23 2012""\n");

 Con_Printf ("Modified by Charles 'Pentagram' Hollemeersch\n");
}
# 1047 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
void Host_Color_f(void)
{
 ...
 MSG_WriteByte (&sv.reliable_datagram, 17);
 MSG_WriteByte (&sv.reliable_datagram, host_client - svs.clients);
...
void Host_Kill_f (void)
{
 ...
 pr_global_struct->self = ((byte *)sv_player - (byte *)sv.edicts);
...
void Host_Pause_f (void)
{
 ...
 else
 {
  ...
  MSG_WriteByte (&sv.reliable_datagram, 24);
  MSG_WriteByte (&sv.reliable_datagram, sv.paused);
 }
}
# 1293 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
void Host_PreSpawn_f (void)
{
 ...
 MSG_WriteByte (&host_client->message, 25);
...
void Host_Spawn_f (void)
{
 ...
 MSG_WriteByte (&host_client->message, 7);
 MSG_WriteFloat (&host_client->message, sv.time);

 for (i=0, client = svs.clients ; i<svs.maxclients ; i++, client++)
 {
  MSG_WriteByte (&host_client->message, 13);
  MSG_WriteByte (&host_client->message, i);
  MSG_WriteString (&host_client->message, client->name);
  MSG_WriteByte (&host_client->message, 14);
  MSG_WriteByte (&host_client->message, i);
  MSG_WriteShort (&host_client->message, client->old_frags);
  MSG_WriteByte (&host_client->message, 17);
  MSG_WriteByte (&host_client->message, i);
 ...
 for (i=0 ; i<64 ; i++)
 {
  MSG_WriteByte (&host_client->message, 12);
 ...
 MSG_WriteByte (&host_client->message, 11);
...
# 1424 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
 ent = EDICT_NUM( 1 + (host_client - svs.clients) );
 MSG_WriteByte (&host_client->message, 10);
 for (i=0 ; i < 2 ; i++)
...
# 1463 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 1555 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
 ...
 switch (t[0])
 {
   ...
   case '9':
      ...
      if (hipnotic)
      {
         ...
         {
            if (t[1] == 'a')
               sv_player->v.items = (int)sv_player->v.items | (1<<16);
            else
               sv_player->v.items = (int)sv_player->v.items | 16;
         }
         else if (t[0] == '9')
            sv_player->v.items = (int)sv_player->v.items | (1<<23);
         else if (t[0] == '0')
            sv_player->v.items = (int)sv_player->v.items | (1<<7);
         else if (t[0] >= '2')
            sv_player->v.items = (int)sv_player->v.items | (1 << (t[0] - '2'));
      }
      else
      {
         if (t[0] >= '2')
...
# 1849 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 1888 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 1905 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
...
# 1922 "d:/Data/Nintendo/TenebraeGX/src/host_cmd.c"
extern cvar_t pausedemo;
void Host_InitCommands (void)
{
