# 1 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
# 21 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
...
# 22 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c" 2

void CL_FinishTimeDemo (void);
# 45 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
void CL_StopPlayback (void)
{
 if (!cls.demoplayback)
  return;
...
# 66 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
...
# 94 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
int CL_GetMessage (void)
{
 int r, i;
 float f;
 ...
 if (cls.demoplayback)
 {
  ...
  {cl.mviewangles[1][0]=cl.mviewangles[0][0];cl.mviewangles[1][1]=cl.mviewangles[0][1];cl.mviewangles[1][2]=cl.mviewangles[0][2];};
  for (i=0 ; i<3 ; i++)
  {
 ...
 while (1)
 {
  ...
  if (net_message.cursize == 1 && net_message.data[0] == 1)
...
# 174 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
void CL_Stop_f (void)
{
...
# 204 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
void CL_Record_f (void)
{
 int c;
 char name[128];
...
# 276 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
void CL_PlayDemo_f (void)
{
 char name[256];
 int c;
 ...
 while ((c = (--(cls.demofile)->_r < 0 ? __srget_r(_impure_ptr, cls.demofile) : (int)(*(cls.demofile)->_p++))) != '\n')
  if (c == '-')
   neg = 1;
  else
...
# 355 "d:/Data/Nintendo/TenebraeGX/src/cl_demo.c"
void CL_TimeDemo_f (void)
{
 if (cmd_source != src_command)
  return;
