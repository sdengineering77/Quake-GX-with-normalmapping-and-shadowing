# 1 "d:/Data/Nintendo/TenebraeGX/src/console.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/console.c"
# 27 "d:/Data/Nintendo/TenebraeGX/src/console.c"
...
# 9 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 2 3
# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/types.h" 1 3
# 25 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/types.h" 3
...
# 26 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/types.h" 2 3
# 61 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/types.h" 3
# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/_types.h" 1 3
# 13 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/_types.h" 3
...
# 62 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/types.h" 2 3
...
# 10 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/unistd.h" 2 3
...
# 28 "d:/Data/Nintendo/TenebraeGX/src/console.c" 2



# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/fcntl.h" 1 3
# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/fcntl.h" 1 3


# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/_default_fcntl.h" 1 3
# 154 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/_default_fcntl.h" 3
struct flock {
 short l_type;
 short l_whence;
 long l_start;
...
# 9 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/stat.h" 3
...
# 21 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/reent.h" 3
...
# 10 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/stat.h" 2 3
...
# 181 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/_default_fcntl.h" 2 3

extern int open (const char *, int, ...);
extern int creat (const char *, mode_t);
extern int fcntl (int, int, ...);
# 4 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/sys/fcntl.h" 2 3
# 1 "c:\\utils\\devkitpro\\devkitppc\\bin\\../lib/gcc/powerpc-eabi/4.6.3/../../../../powerpc-eabi/include/fcntl.h" 2 3
# 32 "d:/Data/Nintendo/TenebraeGX/src/console.c" 2
...
# 33 "d:/Data/Nintendo/TenebraeGX/src/console.c" 2
...
cvar_t con_spiral = {"con_spiral","0", 1};
...
# 102 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_Clear_f (void)
{
    if (con_text)
 Q_memset (con_text, ' ', 65536);
}
...
# 129 "d:/Data/Nintendo/TenebraeGX/src/console.c"
...
# 158 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_CheckResize (void)
{
 ...
 width = 38;
 con_linewidth = width;
 con_totallines = 65536 / con_linewidth;
 Q_memset (con_text, ' ', 65536);
    }
    else
    {
...
# 218 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_Init (void)
{
    ...
    if (con_debuglog)
    {
 if (strlen (com_gamedir) < (1000 - strlen (t2)))
 {
    ...
    con_text = Hunk_AllocName (65536, "context");
...
# 289 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_Print (char *txt)
{
    int y;
    int c, l;
 ...
 if (!con_x)
 {
     ...
     if (con_current >= 0)
  con_times[con_current % 4] = realtime;
 }
...
# 377 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_DebugLog(char *file, char *fmt, ...)
{
    va_list argptr;
    ...
    fd = open(file, 1 | 0x0200 | 0x0008, 0666);
    write(fd, data, strlen(data));
    close(fd);
}
# 410 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_Printf(char *fmt, ...)
{
    va_list argptr;
    char msg[4096];
 ...
 return;
    ...
    if (cls.signon != 4 && !scr_disabled_for_loading )
    {
...
# 465 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_DPrintf (char *fmt, ...)
{
    va_list argptr;
    char msg[4096];
...
# 493 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_SafePrintf (char *fmt, ...)
{
    va_list argptr;
    char msg[1024];
...
# 526 "d:/Data/Nintendo/TenebraeGX/src/console.c"
...
# 566 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_DrawNotify (void)
{
    int x, v;
    char *text;
    ...
    v = 0;
    for (i= con_current-4 +1 ; i<=con_current ; i++)
    {
 if (i < 0)
     continue;
...
# 633 "d:/Data/Nintendo/TenebraeGX/src/console.c"
void Con_DrawConsole (int lines, qboolean drawinput)
{
    int i, x, y;
    int rows;
