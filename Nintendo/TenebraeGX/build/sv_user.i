# 1 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c" 2
...
# 53 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
void SV_SetIdealPitch (void)
{
 ...
 if (!((int)sv_player->v.flags & 512))
  return;

 angleval = sv_player->v.angles[1] * 3.14159265358979323846*2 / 360;
 sinval = sin(angleval);
 cosval = cos(angleval);
 ...
 for (j=1 ; j<i ; j++)
 {
  ...
  if (dir && ( step-dir > 0.1 || step-dir < -0.1 ) )
   return;
...
# 122 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
...
# 190 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
...
void SV_AirAccelerate (vec3_t wishveloc)
{
 ...
 if (wishspd > 30)
  wishspd = 30;
 currentspeed = (velocity[0]*wishveloc[0]+velocity[1]*wishveloc[1]+velocity[2]*wishveloc[2]);
...
void SV_WaterJump (void)
{
 ...
 {
  sv_player->v.flags = (int)sv_player->v.flags & ~2048;
  sv_player->v.teleport_time = 0;
 }
 sv_player->v.velocity[0] = sv_player->v.movedir[0];
 sv_player->v.velocity[1] = sv_player->v.movedir[1];
}
# 326 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
void SV_AirMove (void)
{
 ...
 if ( (int)sv_player->v.movetype != 3)
  wishvel[2] = cmd.upmove;
 else
  wishvel[2] = 0;

 {wishdir[0]=wishvel[0];wishdir[1]=wishvel[1];wishdir[2]=wishvel[2];};
 ...
 {
  {velocity[0]=wishvel[0];velocity[1]=wishvel[1];velocity[2]=wishvel[2];};
 }
 else if ( onground )
 {
  SV_UserFriction ();
...
# 383 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
void SV_ClientThink (void)
{
 vec3_t v_angle;

 if (sv_player->v.movetype == 0)
  return;

 onground = (int)sv_player->v.flags & 512;
 ...
 {v_angle[0]=sv_player->v.v_angle[0]+sv_player->v.punchangle[0];v_angle[1]=sv_player->v.v_angle[1]+sv_player->v.punchangle[1];v_angle[2]=sv_player->v.v_angle[2]+sv_player->v.punchangle[2];};
...
void SV_ReadClientMove (usercmd_t *move)
{
 ...
 host_client->ping_times[host_client->num_pings%16]
 ...
 {host_client->edict->v.v_angle[0]=angle[0];host_client->edict->v.v_angle[1]=angle[1];host_client->edict->v.v_angle[2]=angle[2];};
...
# 485 "d:/Data/Nintendo/TenebraeGX/src/sv_user.c"
