# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
# 42 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/include/gluos.h" 1
# 43 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 44 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
...
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
...
# 47 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2

# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.h" 1
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.h"
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.h" 2
...
# 121 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.h"
struct GLUvertex {
  GLUvertex *next;
  GLUvertex *prev;
  GLUhalfEdge *anEdge;
...
# 170 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.h"
struct GLUmesh {
  GLUvertex vHead;
  GLUface fHead;
  GLUhalfEdge eHead;
...
# 254 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/mesh.h"
...
# 49 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.h" 1
# 80 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/geom.h"
...
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
        ...
        GLUvertex *v );
# 50 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h" 1
# 48 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/dict.h" 1
# 67 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/dict.h"
...
# 95 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/dict.h"
struct DictListNode {
  DictListKey key;
  DictListNode *next;
  DictListNode *prev;
...
# 49 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h" 2
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq.h" 1
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq.h"
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq.h" 2
# 100 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq.h"
...
# 50 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/tess.h" 2
...
void __attribute__((visibility("default"))) __gl_noCombineData( GLdouble coords[3], void *data[4],
    GLfloat weight[4], void **outData,
    void *polygonData );
# 51 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
...
# 54 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.h" 1
# 53 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.h"
int __gl_computeInterior( GLUtesselator *tess );
# 66 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.h"
struct ActiveRegion {
  GLUhalfEdge *eUp;
  DictListNode *nodeUp;
  int windingNumber;
...
# 55 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c" 2
# 104 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
...
static int EdgeLeq( GLUtesselator *tess, ActiveRegion *reg1,
      ActiveRegion *reg2 )
# 121 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
...
static void DeleteRegion( GLUtesselator *tess, ActiveRegion *reg )
{
  if( reg->fixUpperEdge ) {
    ...
    ((reg->eUp->winding == 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 159, __FUNCTION__, "reg->eUp->winding == 0"));
  }
...
{
  ((reg->fixUpperEdge) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 172, __FUNCTION__, "reg->fixUpperEdge"));
...
static GLboolean IsWindingInside( GLUtesselator *tess, int n )
{
  ...
  ((0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 254, __FUNCTION__, "FALSE"));
...
# 298 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
...
static void AddRightEdges( GLUtesselator *tess, ActiveRegion *regUp,
       ...
       GLboolean cleanUp )
# 353 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
  ActiveRegion *reg, *regPrev;
  GLUhalfEdge *e, *ePrev;
  int firstTime = 1;
  ...
  e = eFirst;
  do {
    (((((e->Org)->s < (e->Sym->Org)->s) || ((e->Org)->s == (e->Sym->Org)->s && (e->Org)->t <= (e->Sym->Org)->t))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 361, __FUNCTION__, "VertLeq( e->Org, e->Dst )"));
  ...
  regPrev->dirty = 1;
  ((regPrev->windingNumber - e->winding == reg->windingNumber) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 403, __FUNCTION__, "regPrev->windingNumber - e->winding == reg->windingNumber"));
...
static int CheckForRightSplice( GLUtesselator *tess, ActiveRegion *regUp )
# 525 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
...
# 575 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
  ActiveRegion *regLo = ((ActiveRegion *) (((((regUp)->nodeUp)->prev))->key));
  GLUhalfEdge *eUp = regUp->eUp;
  GLUhalfEdge *eLo = regLo->eUp;
  ...
  ((! ((eUp->Sym->Org)->s == (eLo->Sym->Org)->s && (eUp->Sym->Org)->t == (eLo->Sym->Org)->t)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 581, __FUNCTION__, "! VertEq( eUp->Dst, eLo->Dst )"));
...
# 616 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
  ActiveRegion *regLo = ((ActiveRegion *) (((((regUp)->nodeUp)->prev))->key));
  GLUhalfEdge *eUp = regUp->eUp;
  GLUhalfEdge *eLo = regLo->eUp;
  ...
  ((! ((dstLo)->s == (dstUp)->s && (dstLo)->t == (dstUp)->t)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 628, __FUNCTION__, "! VertEq( dstLo, dstUp )"));
  ((__gl_edgeSign(dstUp,tess->event,orgUp) <= 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 629, __FUNCTION__, "EdgeSign( dstUp, tess->event, orgUp ) <= 0"));
  ((__gl_edgeSign(dstLo,tess->event,orgLo) >= 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 630, __FUNCTION__, "EdgeSign( dstLo, tess->event, orgLo ) >= 0"));
  ((orgUp != tess->event && orgLo != tess->event) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 631, __FUNCTION__, "orgUp != tess->event && orgLo != tess->event"));
  ((! regUp->fixUpperEdge && ! regLo->fixUpperEdge) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 632, __FUNCTION__, "! regUp->fixUpperEdge && ! regLo->fixUpperEdge"));
  ...
  ((((orgUp->t) <= (dstUp->t) ? (orgUp->t) : (dstUp->t)) <= isect.t) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 651, __FUNCTION__, "MIN( orgUp->t, dstUp->t ) <= isect.t"));
  ((isect.t <= ((orgLo->t) >= (dstLo->t) ? (orgLo->t) : (dstLo->t))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 652, __FUNCTION__, "isect.t <= MAX( orgLo->t, dstLo->t )"));
  ((((dstLo->s) <= (dstUp->s) ? (dstLo->s) : (dstUp->s)) <= isect.s) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 653, __FUNCTION__, "MIN( dstLo->s, dstUp->s ) <= isect.s"));
  ((isect.s <= ((orgLo->s) >= (orgUp->s) ? (orgLo->s) : (orgUp->s))) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 654, __FUNCTION__, "isect.s <= MAX( orgLo->s, orgUp->s )"));
...
# 744 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
  if (__gl_meshSplitEdge( eUp->Sym ) == ((void *)0)) longjmp(tess->env,1);
  if (__gl_meshSplitEdge( eLo->Sym ) == ((void *)0)) longjmp(tess->env,1);
  if ( !__gl_meshSplice( eLo->Sym->Lnext, eUp ) ) longjmp(tess->env,1);
  eUp->Org->s = isect.s;
...
static void WalkDirtyRegions( GLUtesselator *tess, ActiveRegion *regUp )
# 769 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
  ActiveRegion *regLo = ((ActiveRegion *) (((((regUp)->nodeUp)->prev))->key));
  GLUhalfEdge *eUp, *eLo;
 ...
 if( regLo->fixUpperEdge ) {
   ...
   && ! regUp->fixUpperEdge && ! regLo->fixUpperEdge
      ...
      {
# 825 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
...
# 880 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
  GLUhalfEdge *eNew;
...
# 941 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
...

{
  ...
  if( ((e->Org)->s == (vEvent)->s && (e->Org)->t == (vEvent)->t)) {
    ...
    ((0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 957, __FUNCTION__, "TOLERANCE_NONZERO"));
  ...
  ((0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 978, __FUNCTION__, "TOLERANCE_NONZERO"));
  regUp = TopRightRegion( regUp );
  ...
  if( reg->fixUpperEdge ) {
    ...
    ((eTopLeft != eTopRight) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 987, __FUNCTION__, "eTopLeft != eTopRight"));
    DeleteRegion( tess, reg );
...
# 1017 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
...
# 1101 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
...
# 1128 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
...
static void DoneEdgeDict( GLUtesselator *tess )
{
  ...
  while( (reg = (ActiveRegion *)((((tess->dict)->head.next))->key)) != ((void *)0) ) {
    ...
    if( ! reg->sentinel ) {
      ((reg->fixUpperEdge) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 1186, __FUNCTION__, "reg->fixUpperEdge"));
      ((++fixedEdges == 1) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 1187, __FUNCTION__, "++fixedEdges == 1"));
    }
    ((reg->windingNumber == 0) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 1189, __FUNCTION__, "reg->windingNumber == 0"));
    DeleteRegion( tess, reg );
...
# 1280 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
{
  GLUface *f, *fNext;
  GLUhalfEdge *e;
  ...
  for( f = mesh->fHead.next; f != &mesh->fHead; f = fNext ) {
    fNext = f->next;
    e = f->anEdge;
    ((e->Lnext != e) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c", 1288, __FUNCTION__, "e->Lnext != e"));
...
# 1342 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/sweep.c"
