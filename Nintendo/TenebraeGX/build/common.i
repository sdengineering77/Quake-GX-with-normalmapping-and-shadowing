# 1 "d:/Data/Nintendo/TenebraeGX/src/common.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/common.c"
# 28 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 29 "d:/Data/Nintendo/TenebraeGX/src/common.c" 2




static char *largv[50 + 7 + 1];
static char *argvdummy = " ";


static char *safeargvs[7] =
...
char com_cmdline[1024];


qboolean standard_quake = 1, rogue, hipnotic;
...
# 135 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void ClearLink (link_t *l)
{
        l->prev = l->next = l;
}
...
# 175 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void Q_memset (void *dest, int fill, int count)
{
 int i;
...
# 511 "d:/Data/Nintendo/TenebraeGX/src/common.c"
qboolean bigendien;
...
# 607 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void MSG_WriteChar (sizebuf_t *sb, int c)
{
 byte *buf;
...
# 928 "d:/Data/Nintendo/TenebraeGX/src/common.c"
char *COM_SkipPath (char *pathname)
{
 char *last;
...
# 1031 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_DefaultExtension (char *path, char *extension)
{
 char *src;
...
# 1063 "d:/Data/Nintendo/TenebraeGX/src/common.c"
char *COM_Parse (char *data)
{
 int c;
 int len;
...
# 1147 "d:/Data/Nintendo/TenebraeGX/src/common.c"
int COM_CheckParm (char *parm)
{
 int i;
...
# 1179 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 1234 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_InitArgv (int argc, char **argv)
{
 qboolean safe;
 int i, j, n;
 ...
 for (j=0 ; (j<50) && (j< argc) ; j++)
 {
  i = 0;


  while ((n < (1024 - 1)) && argv[j][i])
  {
 ...
 for (com_argc=0 ; (com_argc<50) && (com_argc < argc) ;
   com_argc++)
 {
...
# 1314 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_Init (char *basedir)
{
 byte swaptest[2] = {1,0};

Sys_Printf("exec COM_Init");
...
# 1369 "d:/Data/Nintendo/TenebraeGX/src/common.c"
char *va(char *format, ...)
{
 va_list argptr;
...
# 1408 "d:/Data/Nintendo/TenebraeGX/src/common.c"
int com_filesize;
# 1418 "d:/Data/Nintendo/TenebraeGX/src/common.c"
typedef struct
{
 char name[64];
 int filepos, filelen;
...
char com_cachedir[128];
char com_gamedir[128];
...
# 1482 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_Path_f (void)
{
 searchpath_t *s;
...
# 1507 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_WriteFile (char *filename, void *data, int len)
{
 int handle;
 char name[128];
...
# 1538 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 1565 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 1601 "d:/Data/Nintendo/TenebraeGX/src/common.c"
int COM_FindFile (const char *filename, int *handle, FILE **file)
{
 searchpath_t *search;
 char netpath[128];
 ...
 for ( ; search ; search = search->next)
 {
  ...
  {
# 1669 "d:/Data/Nintendo/TenebraeGX/src/common.c"
   if (filename[0] != '/')
...
# 1739 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_FindAllExt (char *filedir, char *fileext, void (*callback)(const char *))
{
 searchpath_t *search;
 char netpath[128];
...
# 1780 "d:/Data/Nintendo/TenebraeGX/src/common.c"
   if (Sys_Findfirst(netpath,sysfileext,&dirdata))
   {
    do
    {
     callback(dirdata.entry);
                } while (Sys_Findnext( &dirdata ) != ((void *)0));
   }
  }

 }
}
# 1803 "d:/Data/Nintendo/TenebraeGX/src/common.c"
int COM_OpenFile (const char *filename, int *handle)
{
 return COM_FindFile (filename, handle, ((void *)0));
}
# 1817 "d:/Data/Nintendo/TenebraeGX/src/common.c"
int COM_FOpenFile (const char *filename, FILE **file)
{
 return COM_FindFile (filename, ((void *)0), file);
}
# 1831 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_CloseFile (int h)
{
 searchpath_t *s;
...
# 1854 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 1957 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 2040 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_AddGameDirectory (char *dir)
{
 searchpath_t *search,*otherpaths=((void *)0);
 pack_t *pak;
 char *filename;
 dirdata_t dirdata;
...
# 2110 "d:/Data/Nintendo/TenebraeGX/src/common.c"
...
# 2154 "d:/Data/Nintendo/TenebraeGX/src/common.c"
void COM_InitFilesystem (void)
{
 int i,j;
 char basedir[128];
...
# 2223 "d:/Data/Nintendo/TenebraeGX/src/common.c"
 i = COM_CheckParm ("-path");
 if (i)
 {
  com_modified = 1;
  com_searchpaths = ((void *)0);
  while (++i < com_argc)
  {
