# 1 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
# 22 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
...
# 23 "d:/Data/Nintendo/TenebraeGX/src/zone.c" 2
...
# 64 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
memzone_t *mainzone;
 ...
 *(int *)((byte *)base + base->size - 4) = 0x1d4a11;
...
# 293 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void Hunk_Check (void)
{
 hunk_t *h;
...
# 315 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
...
# 528 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void *Hunk_TempAlloc (int size)
{
 void *buf;
...
# 557 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
...
# 606 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void Cache_FreeLow (int new_low_hunk)
{
 cache_system_t *c;
...
# 628 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void Cache_FreeHigh (int new_high_hunk)
{
...
void Cache_UnlinkLRU (cache_system_t *cs)
{
 ...
 cs->lru_prev = cs->lru_next = ((void *)0);
}
...
# 680 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
cache_system_t *Cache_TryAlloc (int size, qboolean nobottom)
{
...
# 759 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void Cache_Flush (void)
{
 while (cache_head.next != &cache_head)
  Cache_Free ( cache_head.next->user );
}
# 772 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
...
# 825 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void Cache_Free (cache_user_t *c)
{
 cache_system_t *cs;
 ...
 cs->next = cs->prev = ((void *)0);

 c->data = ((void *)0);

 Cache_UnlinkLRU (cs);
}
# 850 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void *Cache_Check (cache_user_t *c)
{
 cache_system_t *cs;
...
# 914 "d:/Data/Nintendo/TenebraeGX/src/zone.c"
void Memory_Init (void *buf, int size)
{
 int p;
 int zonesize = 0xc000;
