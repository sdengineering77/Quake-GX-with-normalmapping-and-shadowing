# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c"
# 1 "d:\\Data\\Nintendo\\TenebraeGX\\build//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c"
# 42 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c"
...
# 43 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c" 2
...
void __assert_func (const char *, int, const char *, const char *) __attribute__ ((__noreturn__))
                                 ;
# 44 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c" 2
...
# 45 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c" 2
...
# 46 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c" 2
...
void __gl_edgeIntersect( GLUvertex *o1, GLUvertex *d1,
        ...
        GLUvertex *v );
# 52 "d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c" 2
...
static void FloatDown( PriorityQHeap *pq, long curr )
{
  ...
  for( ;; ) {
    ...
    ((child <= pq->max) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c", 109, __FUNCTION__, "child <= pq->max"));
...
PQHeapHandle __gl_pqHeapInsert(PriorityQHeap *pq,PQHeapKey keyNew)
{
  ...
  ((free != 2147483647L) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c", 204, __FUNCTION__, "free != LONG_MAX"));
  return free;
}
...
void __gl_pqHeapDelete(PriorityQHeap *pq,PQHeapHandle hCurr)
{
  ...
  ((hCurr >= 1 && hCurr <= pq->max && h[hCurr].key != ((void *)0)) ? (void)0 : __assert_func ("d:/Data/Nintendo/TenebraeGX/gl2gx/source/libtess/priorityq-heap.c", 238, __FUNCTION__, "hCurr >= 1 && hCurr <= pq->max && h[hCurr].key != NULL"));
