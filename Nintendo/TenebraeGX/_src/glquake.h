...
//DRS TODO: tweak
#define	MAXSHADOWLIGHTS	128 //Maximum number of (client side) lights in a map
...
#define MAX_VOLUME_VERTICES 10000 //should be multiple of 4 because this is used as a vertex array
								 //with GL_QUADS
// DRS TODO: tweak
#define MAXUSEDSHADOWLIGHS 24 //Maximum number of lights that can be used in a single frame
