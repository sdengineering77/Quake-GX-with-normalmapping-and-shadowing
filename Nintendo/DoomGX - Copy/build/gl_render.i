# 1 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c"
...
# 2 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c" 2
...
# 3 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c" 2
...
# 4 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c" 2
...
# 5 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c" 2
...
# 7 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c" 2
...
# 10 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c" 2



static u8 prevGXCompareFunc = 0;
...
void glBegin(GLenum type) {
 ...
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 60); return; };
 ...
 switch(type)
 {
  ...
  default:
   _GLtype = 0x0500;
   _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 88);
   cur_state &= ~GL_STATE_BEGIN;
   return;
 };
}
...
# 570 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c"
BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_UPLOAD_VERTEX_REC, (2, (Array, index) ))




BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_UPLOAD_VERTEX_REC, (2, (BOOST_PP_CAT(Elem, GLubyte), *(((GLubyte *)elemIndex)+index)) ))
BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_UPLOAD_VERTEX_REC, (2, (BOOST_PP_CAT(Elem, GLushort), *(((GLushort *)elemIndex)+index)) ))
BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_UPLOAD_VERTEX_REC, (2, (BOOST_PP_CAT(Elem, GLuint), *(((GLuint *)elemIndex)+index)) ))
# 608 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c"
void ResetArrays()
{
 int i = 0;
 int j = 0;
...
static void SetTev()
{
 ...
 if(lighting)
 {
  ...
  int lightcounter = 0;
# 736 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c"
...
void gxSetupAlphaCompare() {
 bool update;
 u8 gxCompareFunc;
 u8 gxZCompLoc;
 if (_alphatest_enabled) {
  if (_alphatest_dirty) {
   update = true;
   _alphatest_dirty = false;
   switch(_alphatest_func) {
    case 0x0200:
     gxCompareFunc = 0;
     gxZCompLoc = 0;
     break;
 ...
 if (update) {
  ...
  GX_SetAlphaCompare(gxCompareFunc, (float) _alphatest_ref, 0, 7, 0);
  prevGXCompareFunc = gxCompareFunc;
 }
}
# 909 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c"
Mtx44 *GX_GetCurrGLPrjMtx(void) {
 return TopMtx44(&projection_stack);
}

Mtx *GX_GetCurrGLModelViewMtx(void) {
 return TopMtx(&model_stack);
}
...
static __attribute__((__noinline__)) void glRender(int count) {
 ...
 int i =0;
# 1318 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c"
 int tex_count = 0;
 int all_tex_index = 1;
 int sent_verts = 0;
 for(i = 0; i < 8; ++i)
  ...
  (color_mode == 3 || !color.enable))
 {
  ...
  {
   BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_FORMAT_QUEST, (5, ((3, (norm.enable, color.enable, DO_RENDER)), (4, (PT, PNT, PCT, PNCT) ), (4, ((2,(0,0)), (2,(1,0)), (2,(0,1)), (2,(1,1)))), Array, DO_RENDER))) {}
  }
  else if(render_mode == ELEMENTS)
  {
   ...
   {
   case 0x1401:
    BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_FORMAT_QUEST, (5, ((3, (norm.enable, color.enable, DO_RENDER)), (4, (PT, PNT, PCT, PNCT) ), (4, ((2,(0,0)), (2,(1,0)), (2,(0,1)), (2,(1,1)))), BOOST_PP_CAT(Elem, GLubyte), DO_RENDER))) {}
    break;
   case 0x1403:
    BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_FORMAT_QUEST, (5, ((3, (norm.enable, color.enable, DO_RENDER)), (4, (PT, PNT, PCT, PNCT) ), (4, ((2,(0,0)), (2,(1,0)), (2,(0,1)), (2,(1,1)))), BOOST_PP_CAT(Elem, GLushort), DO_RENDER))) {}
    break;
   case 0x1405:
    BOOST_PP_REPEAT(BOOST_PP_ARRAY_SIZE((4, (PT, PNT, PCT, PNCT) )), GEN_FORMAT_QUEST, (5, ((3, (norm.enable, color.enable, DO_RENDER)), (4, (PT, PNT, PCT, PNCT) ), (4, ((2,(0,0)), (2,(1,0)), (2,(0,1)), (2,(1,1)))), BOOST_PP_CAT(Elem, GLuint), DO_RENDER))) {}
    break;
   }
  }
 }
...
void glEnd()
{
 if(!(cur_state & GL_STATE_BEGIN)) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1435); return; }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1462); return; };
switch(cap)
{
...
case 0x8079:
case 0x8077:
default: _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1471); break;
}
}

void glEnableClientState( GLenum cap )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1477); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1484); return; };
...
void glTexCoordPointer( GLint size, GLenum type,
                                         GLsizei stride, const GLvoid *ptr )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1497); return; };

 if(size < 1 || size > 4)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1501);
  return;
 }
 ...
 case 0x1406:
 case 0x140A: break;
 default: _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1511); break;
 }

 if(stride < 0)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1516);
  return;
 }
...
void glVertexPointer( GLint size, GLenum type,
                                       GLsizei stride, const GLvoid *ptr )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1551); return; };

 if(size < 2 || size > 4)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1555);
  return;
 }
 ...
 case 0x1406:
 case 0x140A: break;
 default: _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1565); break;
 }

 if(stride < 0)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1570);
  return;
 }
...
void glNormalPointer( GLenum type, GLsizei stride,
                                       const GLvoid *ptr )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1588); return; };
 ...
 case 0x1406:
 case 0x140A: break;
 default: _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1597); break;
 }

 if(stride < 0)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1602);
  return;
 }
...
void glColorPointer( GLint size,
          ...
          const GLvoid *ptr )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1622); return; };

 if(size < 3 || size > 4)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1626);
  return;
 }
 ...
 case 0x1406:
 case 0x140A: break;
 default: _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1640); break;
 }

 if(stride < 0)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1645);
  return;
 }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1747); return; };
 ...
 if(count > 32000)
 {
  ...
  default:
   ...
   _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1787);
   return;
  }
...
void glDrawRangeElementsEXT(GLenum mode,
        ...
        const GLvoid *indices)
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1872); return; };

 if(count > 32000)
 {

  _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1877);
  return;
 }
 ...
 if(end > ~((u16)0))
 {
  ...
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1884);
  return;
 }
 ...
 case 0x1403:
 case 0x1405: break;
 default: _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_render.c", 1893); break;
 }
