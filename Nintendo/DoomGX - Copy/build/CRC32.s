...
.LFE1504:
	...
	.section	".text"
	.align 2
	.globl _Z18CRC32_InitChecksumRm
	.type	_Z18CRC32_InitChecksumRm, @function
_Z18CRC32_InitChecksumRm:
.LFB2528:
	.file 2 "d:/Data/Nintendo/DoomGX/src/idlib/hashing/CRC32.cpp"
	.loc 2 137 0
.LVL1:
	.loc 2 138 0
	li 0,-1
	...
	blr
.LFE2528:
	.size	_Z18CRC32_InitChecksumRm, .-_Z18CRC32_InitChecksumRm
	.align 2
	.globl _Z12CRC32_UpdateRmh
	.type	_Z12CRC32_UpdateRmh, @function
_Z12CRC32_UpdateRmh:
.LFB2529:
	.loc 2 141 0
.LVL2:
...
.LVL3:
	...
	blr
.LFE2529:
	.size	_Z12CRC32_UpdateRmh, .-_Z12CRC32_UpdateRmh
	.align 2
	.globl _Z20CRC32_UpdateChecksumRmPKvi
	.type	_Z20CRC32_UpdateChecksumRmPKvi, @function
_Z20CRC32_UpdateChecksumRmPKvi:
.LFB2530:
	.loc 2 145 0
.LVL4:
.LBB2:
...
.LBE2:
	...
	blr
.LFE2530:
	.size	_Z20CRC32_UpdateChecksumRmPKvi, .-_Z20CRC32_UpdateChecksumRmPKvi
	.align 2
	.globl _Z20CRC32_FinishChecksumRm
	.type	_Z20CRC32_FinishChecksumRm, @function
_Z20CRC32_FinishChecksumRm:
.LFB2531:
	.loc 2 156 0
.LVL8:
	.loc 2 157 0
	...
	blr
.LFE2531:
	.size	_Z20CRC32_FinishChecksumRm, .-_Z20CRC32_FinishChecksumRm
	.align 2
	.globl _Z19CRC32_BlockChecksumPKvi
	.type	_Z19CRC32_BlockChecksumPKvi, @function
_Z19CRC32_BlockChecksumPKvi:
.LFB2532:
	.loc 2 160 0
.LVL9:
	stwu 1,-48(1)
...
.LVL14:
	...
	blr
.LFE2532:
	.size	_Z19CRC32_BlockChecksumPKvi, .-_Z19CRC32_BlockChecksumPKvi
...
.LLST17:
	...
	.4byte	0x14524
	.string	"CRC32_InitChecksum"
	.4byte	0x14557
	.string	"CRC32_Update"
	.4byte	0x14593
	.string	"CRC32_UpdateChecksum"
	.4byte	0x145ff
	.string	"CRC32_FinishChecksum"
	.4byte	0x1462c
	.string	"CRC32_BlockChecksum"
	.4byte	0x14679
...
.LASF3566:
	.string	"_Z19CRC32_BlockChecksumPKvi"
.LASF1352:
...
.LASF3644:
	.string	"IMPULSE_28"
.LASF3564:
	.string	"_Z20CRC32_FinishChecksumRm"
.LASF3674:
...
.LASF3557:
	.string	"_Z18CRC32_InitChecksumRm"
.LASF1838:
...
.LASF3771:
	.string	"d:/Data/Nintendo/DoomGX/src/idlib/hashing/CRC32.cpp"
.LASF495:
...
.LASF3562:
	.string	"_Z20CRC32_UpdateChecksumRmPKvi"
.LASF90:
