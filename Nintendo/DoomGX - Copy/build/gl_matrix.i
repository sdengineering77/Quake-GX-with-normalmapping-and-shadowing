# 1 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c"
...
# 2 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c" 2
...
# 3 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c" 2
...
# 4 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c" 2
...
# 5 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c" 2
...
# 7 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c" 2
...
# 10 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c" 2
...
void glFrustum( GLdouble left,
     ...
     GLdouble zFar )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 80); return; };
...
void glOrtho(GLdouble left,
  ...
  GLdouble farVal)
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 116); return; };

 if(left == right || bottom == top)
 {
  _glSetErrorEx(0x0501, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 120);
  return;
 }
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 158); return; };
 ...
 case 0x1702:
  ...
  break;
 default:
  _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 172);
  return;
  break;
...
void glLoadIdentity(void) {
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 181); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 222); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 270); return; };
...
void glTranslatef( GLfloat x, GLfloat y, GLfloat z ) {
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 314); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 347); return; };

 glTranslatef( (GLfloat) x, (GLfloat) y, (GLfloat) z );
}

void glRotatef (GLfloat angle, GLfloat x, GLfloat y, GLfloat z) {
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 353); return; };
...
void glScalef (GLfloat x, GLfloat y, GLfloat z){
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 398); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 431); return; };
...
void glPopMatrix (void){
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 494); return; };
...
void glPushMatrix (void){
 ...
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 501); return; };
...
void _glGetMatrixd(GLenum pname, GLdouble *params) {
 ...
 switch(pname) {
  case 0x0BA6:
   model = *TopMtx(&model_stack);
   for(j = 0; j < 4; ++j) {
    for(i = 0; i < 3; ++i) {
     *params++ = (double) model[i][j];
    }
    if (j != 3) {
     *params++ = 0.0f;
    } else {
   ...
   break;
  case 0x0BA7:
   pm = TopPrjMtx(&projection_stack);



   for(j = 0; j < 4; ++j) {
    for(i = 0; i < 4; ++i) {
     *params++ = (double) pm->mat[i][j];
    }
   }
   break;
  default:
   _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 541);
   break;
 }
...
void _glGetMatrixf( GLenum pname, GLfloat *params)
{
 ...
 case 0x0BA7:
  ...
  break;
 default:
  _glSetErrorEx(0x0500, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 587);
  break;
 }
}
...
void gluLookAt( GLdouble eyeX,
 ...
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 632); return; };
...
void gluPerspective( GLdouble fovy,
          ...
          GLdouble zNear,
       GLdouble zFar ) {
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_matrix.c", 671); return; };
