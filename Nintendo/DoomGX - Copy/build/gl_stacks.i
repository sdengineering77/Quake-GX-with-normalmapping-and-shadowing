# 1 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
# 2 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c" 2
...
# 3 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c" 2
...
# 4 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c" 2
...
# 5 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c" 2
...
# 7 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c" 2
...
# 48 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
# 125 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
# 245 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
# 370 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
typedef struct fog
{
...
# 461 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
# 585 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
# 674 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
static bool pushPolygon(void ** p, void * end)
{
 ...
 case 3:
  ...
  break;
 default:
  ((0) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 708, __FUNCTION__, "0"));
 }
...
# 827 "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c"
...
static bool resizeStack(attribStack_t * ptr)
{
 ...
 if(begin != ((void *)0))
 {
  ...
  ((ptr->begin <= ptr->cur) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1012, __FUNCTION__, "ptr->begin <= ptr->cur"));
  ((ptr->cur <= stackEnd(ptr)) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1013, __FUNCTION__, "ptr->cur <= stackEnd(ptr)"));
  return true;
 }
 else
 {
...
static void push(attribStack_t * ptr, AttribOpt * opts, size_t n_opts, GLenum mask)
{
 ...
 if(ptr->typeCur >= 16)
 {
  _glSetErrorEx(0x0503, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1043);
  return;
 }

 void * cur = ptr->cur;

 ((ptr->begin <= ptr->cur) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1049, __FUNCTION__, "ptr->begin <= ptr->cur"));
 ((ptr->cur <= stackEnd(ptr)) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1050, __FUNCTION__, "ptr->cur <= stackEnd(ptr)"));
  ...
  if((opts[i].mask & mask) == opts[i].mask)
  {
   while(!opts[i].push(&cur, stackEnd(ptr)))
   {
    ...
    if(!resizeStack(ptr))
    {
     ...
     _glSetErrorEx(0x0503, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1062);
     return;
    }
   }
  }
 ...
 ((ptr->begin <= ptr->cur) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1069, __FUNCTION__, "ptr->begin <= ptr->cur"));
 ((ptr->cur <= stackEnd(ptr)) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1070, __FUNCTION__, "ptr->cur <= stackEnd(ptr)"));
...
static void pop(attribStack_t * ptr, AttribOpt * opts, size_t n_opts)
{
 ...
 if(ptr->typeCur == 0)
 {
  _glSetErrorEx(0x0504, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1082);
  return;
 }
 ...
 ((ptr->begin <= ptr->cur) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1090, __FUNCTION__, "ptr->begin <= ptr->cur"));
 ((ptr->cur <= stackEnd(ptr)) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1091, __FUNCTION__, "ptr->cur <= stackEnd(ptr)"));
 ...
 ((ptr->begin <= ptr->cur) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1101, __FUNCTION__, "ptr->begin <= ptr->cur"));
 ((ptr->cur <= stackEnd(ptr)) ? (void)0 : __assert_func ("d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1102, __FUNCTION__, "ptr->cur <= stackEnd(ptr)"));
}

void glPushAttrib( GLbitfield mask )
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1107); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1114); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1202); return; };
...
{
 if(cur_state & GL_STATE_BEGIN) { _glSetErrorEx(0x0502, "d:/Data/Nintendo/DoomGX/gl2gx/source/gl_stacks.c", 1209); return; };
