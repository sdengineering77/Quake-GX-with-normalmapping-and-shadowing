...
/*	DRS TODO idSIMD::InitProcessor( "doom", com_forceGenericSIMD.GetBool() );
...
Sys_Printf("call ParseCommandLine( argc, argv )\r\n");
		ParseCommandLine( argc, argv );

		// init console command system
Sys_Printf("call cmdSystem->Init()\r\n");
		cmdSystem->Init();

		// init CVar system
Sys_Printf("call cvarSystem->Init()\r\n");
		cvarSystem->Init();

		// start file logging right away, before early console or whatever
Sys_Printf("call StartupVariable()\r\n");
		StartupVariable( "win_outputDebugString", false );

		// register all static CVars
Sys_Printf("call idCVar::RegisterStaticVars()\r\n");
...
Sys_Printf("call idKeyInput::Init()\r\n");
		idKeyInput::Init();

		// init the console so we can take prints
Sys_Printf("call console->Init()\r\n");
		console->Init();

		// get architecture info
Sys_Printf("call Sys_Init()\r\n");
		Sys_Init();

		// initialize networking
Sys_Printf("call Sys_InitNetworking()\r\n");
		Sys_InitNetworking();

		// override cvars from command line
		StartupVariable( NULL, false );

Sys_Printf("call !idAsyncNetwork::serverDedicated.GetInteger() && Sys_AlreadyRunning()\r\n");
		if ( !idAsyncNetwork::serverDedicated.GetInteger() && Sys_AlreadyRunning() ) {
Sys_Printf("call Sys_Quit()\r\n");
			Sys_Quit();
		}

		// initialize processor specific SIMD implementation
Sys_Printf("call InitSIMD()\r\n");
		InitSIMD();

		// init commands
Sys_Printf("call InitCommands()\r\n");
		InitCommands();
