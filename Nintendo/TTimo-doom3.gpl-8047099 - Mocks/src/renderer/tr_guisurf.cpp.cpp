...
void R_SurfaceToTextureAxis( const srfTriangles_t *tri, idVec3 &origin, idVec3 axis[3] ) {
    Sys_Printf("void R_SurfaceToTextureAxis( const srfTriangles_t *tri, idVec3 &origin, idVec3 axis[3] )\r\n");
}
...
void R_RenderGuiSurf( idUserInterface *gui, drawSurf_t *drawSurf ) {
    Sys_Printf("void R_RenderGuiSurf( idUserInterface *gui, drawSurf_t *drawSurf )\r\n");
}
...
void R_ReloadGuis_f( const idCmdArgs &args ) {
    Sys_Printf("void R_ReloadGuis_f( const idCmdArgs &args )\r\n");
}
...
void R_ListGuis_f( const idCmdArgs &args ) {
    Sys_Printf("void R_ListGuis_f( const idCmdArgs &args )\r\n");
}
