...
{
    Sys_Printf("voidwrite_file_header (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidwrite_frame_header (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidwrite_scan_header (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidwrite_file_trailer (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidwrite_tables_only (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidjinit_marker_writer (j_compress_ptr cinfo)\r\n");
}
