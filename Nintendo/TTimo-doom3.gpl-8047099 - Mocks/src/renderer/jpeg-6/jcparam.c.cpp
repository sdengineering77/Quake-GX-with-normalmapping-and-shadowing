...
{
    Sys_Printf("voidjpeg_set_defaults (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidjpeg_default_colorspace (j_compress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidjpeg_set_colorspace (j_compress_ptr cinfo, J_COLOR_SPACE colorspace)\r\n");
}
...
{
    Sys_Printf("voidjpeg_simple_progression (j_compress_ptr cinfo)\r\n");
}
