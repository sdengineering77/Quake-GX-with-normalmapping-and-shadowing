...
next_marker (j_decompress_ptr cinfo)
{
    ...
    Sys_Printf("booleannext_marker (j_decompress_ptr cinfo)\r\n");
    return retVal;
}
...
read_markers (j_decompress_ptr cinfo)
{
    ...
    Sys_Printf("intread_markers (j_decompress_ptr cinfo)\r\n");
    return retVal;
}
...
read_restart_marker (j_decompress_ptr cinfo)
{
    boolean retVal;
    memset(&retVal, 0, sizeof(boolean));
    Sys_Printf("booleanread_restart_marker (j_decompress_ptr cinfo)\r\n");
    return retVal;
}
...
jpeg_resync_to_restart (j_decompress_ptr cinfo, int desired)
{
    boolean retVal;
    memset(&retVal, 0, sizeof(boolean));
    Sys_Printf("booleanjpeg_resync_to_restart (j_decompress_ptr cinfo, int desired)\r\n");
    return retVal;
}
...
{
    Sys_Printf("voidreset_marker_reader (j_decompress_ptr cinfo)\r\n");
}
...
{
    Sys_Printf("voidjinit_marker_reader (j_decompress_ptr cinfo)\r\n");
}
