...
{
    Sys_Printf("voidinit_source (j_decompress_ptr cinfo)\r\n");
}
...
fill_input_buffer (j_decompress_ptr cinfo)
{
    ...
    Sys_Printf("booleanfill_input_buffer (j_decompress_ptr cinfo)\r\n");
    return retVal;
}
...
{
    Sys_Printf("voidjpeg_stdio_src (j_decompress_ptr cinfo, unsigned char *infile)\r\n");
}
