...
float idDeclTable::TableLookup( float index ) const {
    ...
    Sys_Printf("float idDeclTable::TableLookup( float index )\r\n");
    return retVal;
}
...
size_t idDeclTable::Size( void ) const {
    ...
    Sys_Printf("size_t idDeclTable::Size( void )\r\n");
    return retVal;
}
...
void idDeclTable::FreeData( void ) {
    Sys_Printf("void idDeclTable::FreeData( void )\r\n");
}
...
const char *idDeclTable::DefaultDefinition( void ) const {
    Sys_Printf("char *idDeclTable::DefaultDefinition( void )\r\n");
    return NULL;
}
...
bool idDeclTable::Parse( const char *text, const int textLength ) {
    ...
    Sys_Printf("bool idDeclTable::Parse( const char *text, const int textLength )\r\n");
    return retVal;
}
