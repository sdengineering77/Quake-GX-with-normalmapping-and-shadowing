...
void idListGUILocal::StateChanged() {
    Sys_Printf("void idListGUILocal::StateChanged()\r\n");
}
...
int idListGUILocal::GetNumSelections() {
    ...
    Sys_Printf("int idListGUILocal::GetNumSelections()\r\n");
    return retVal;
}
...
int idListGUILocal::GetSelection( char *s, int size, int _sel ) const {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int idListGUILocal::GetSelection( char *s, int size, int _sel )\r\n");
    return retVal;
}
...
void idListGUILocal::SetSelection( int sel ) {
    Sys_Printf("void idListGUILocal::SetSelection( int sel )\r\n");
}
...
void idListGUILocal::Add( int id, const idStr &s ) {
    Sys_Printf("void idListGUILocal::Add( int id, const idStr &s )\r\n");
}
...
void idListGUILocal::Push( const idStr& s ) {
    Sys_Printf("void idListGUILocal::Push( const idStr& s )\r\n");
}
...
bool idListGUILocal::Del(int id) {
    ...
    Sys_Printf("bool idListGUILocal::Del(int id)\r\n");
    return retVal;
}
...
void idListGUILocal::Clear() {
    Sys_Printf("void idListGUILocal::Clear()\r\n");
}
...
bool idListGUILocal::IsConfigured( void ) const {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idListGUILocal::IsConfigured( void )\r\n");
    return retVal;
}
...
void idListGUILocal::SetStateChanges( bool enable ) {
    Sys_Printf("void idListGUILocal::SetStateChanges( bool enable )\r\n");
}
...
void idListGUILocal::Shutdown( void ) {
    Sys_Printf("void idListGUILocal::Shutdown( void )\r\n");
}
