...
void idFieldWindow::CommonInit() {
    Sys_Printf("void idFieldWindow::CommonInit()\r\n");
}
...
bool idFieldWindow::ParseInternalVar(const char *_name, idParser *src) {
    ...
    Sys_Printf("bool idFieldWindow::ParseInternalVar(const char *_name, idParser *src)\r\n");
    return retVal;
}
...
void idFieldWindow::CalcPaintOffset(int len) {
    Sys_Printf("void idFieldWindow::CalcPaintOffset(int len)\r\n");
}



void idFieldWindow::Draw(int time, float x, float y) {
    Sys_Printf("void idFieldWindow::Draw(int time, float x, float y)\r\n");
}
