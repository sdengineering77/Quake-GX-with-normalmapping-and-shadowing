...
void glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels) {
    Sys_Printf("void glTexImage2D(GLenum target, GLint level, GLint internalformat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels)\r\n");
}
;
...
void GLimp_EnableLogging(bool) {
    Sys_Printf("void GLimp_EnableLogging(bool)\r\n");
}
;
...
void GLimp_SetGamma(unsigned short*a, unsigned short*b, unsigned short*c) {
    Sys_Printf("void GLimp_SetGamma(unsigned short*a, unsigned short*b, unsigned short*c)\r\n");
}
;
void GLimp_Shutdown() {
