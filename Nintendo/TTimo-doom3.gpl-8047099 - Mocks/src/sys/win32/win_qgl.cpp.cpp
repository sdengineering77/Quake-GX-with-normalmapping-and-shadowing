...
{
    Sys_Printf("char *EnumString( GLenum t )\r\n");
    return NULL;
}


static const char *FloatData( const GLfloat *v, int count ) {
    Sys_Printf("char *FloatData( const GLfloat *v, int count )\r\n");
    return NULL;
}
...
{
    Sys_Printf("void QGL_Shutdown( void )\r\n");
}
...
bool QGL_Init( const char *dllname )
{
    ...
    Sys_Printf("bool QGL_Init( const char *dllname )\r\n");
    return retVal;
}
