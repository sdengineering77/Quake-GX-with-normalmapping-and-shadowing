...
void DialogGoToLine::DoDataExchange(CDataExchange* pDX) {
    Sys_Printf("void DialogGoToLine::DoDataExchange(CDataExchange* pDX)\r\n");
}
...
void DialogGoToLine::SetRange( int firstLine, int lastLine ) {
    Sys_Printf("void DialogGoToLine::SetRange( int firstLine, int lastLine )\r\n");
}
...
int DialogGoToLine::GetLine( void ) const {
    ...
    Sys_Printf("int DialogGoToLine::GetLine( void )\r\n");
    return retVal;
}
...
BOOL DialogGoToLine::OnInitDialog()  {
    ...
    Sys_Printf("BOOL DialogGoToLine::OnInitDialog()\r\n");
    return retVal;
}
...
void DialogGoToLine::OnBnClickedOk() {
    Sys_Printf("void DialogGoToLine::OnBnClickedOk()\r\n");
}
