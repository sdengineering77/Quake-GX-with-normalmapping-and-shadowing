...
bool rvDebuggerQuickWatchDlg::DoModal ( rvDebuggerWindow* window, int callstackDepth, const char* variable )
{
    ...
    Sys_Printf("bool rvDebuggerQuickWatchDlg::DoModal ( rvDebuggerWindow* window, int callstackDepth, const char* variable )\r\n");
    return retVal;
}
...
INT_PTR CALLBACK rvDebuggerQuickWatchDlg::DlgProc ( HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam )
{
    ...
    Sys_Printf("CALLBACK rvDebuggerQuickWatchDlg::DlgProc ( HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam )\r\n");
    return retVal;
}
...
{
    Sys_Printf("void rvDebuggerQuickWatchDlg::SetVariable ( const char* varname, bool force )\r\n");
}
