...
bool rvDebuggerApp::Initialize ( HINSTANCE instance )
{
    ...
    Sys_Printf("bool rvDebuggerApp::Initialize ( HINSTANCE instance )\r\n");
    return retVal;
}
...
bool rvDebuggerApp::ProcessWindowMessages ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvDebuggerApp::ProcessWindowMessages ( void )\r\n");
    return retVal;
}
...
bool rvDebuggerApp::TranslateAccelerator ( LPMSG msg )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvDebuggerApp::TranslateAccelerator ( LPMSG msg )\r\n");
    return retVal;
}
...
int rvDebuggerApp::Run ( void )
{
    ...
    Sys_Printf("int rvDebuggerApp::Run ( void )\r\n");
    return retVal;
}
