...
bool rvDebuggerFindDlg::DoModal ( rvDebuggerWindow* parent )
{
    ...
    Sys_Printf("bool rvDebuggerFindDlg::DoModal ( rvDebuggerWindow* parent )\r\n");
    return retVal;
}
...
INT_PTR CALLBACK rvDebuggerFindDlg::DlgProc ( HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam )
{
    ...
    Sys_Printf("CALLBACK rvDebuggerFindDlg::DlgProc ( HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam )\r\n");
    return retVal;
}
