...
{
    Sys_Printf("void ShowInfoDialog(const char* pText)\r\n");
}


void HideInfoDialog()
{
    Sys_Printf("void HideInfoDialog()\r\n");
}
...
{
    Sys_Printf("void CDialogInfo::DoDataExchange(CDataExchange* pDX)\r\n");
}
...
BOOL CDialogInfo::OnInitDialog() 
{
    ...
    Sys_Printf("BOOL CDialogInfo::OnInitDialog()\r\n");
    return retVal;
}
