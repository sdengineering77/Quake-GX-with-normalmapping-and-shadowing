...
bool rvGEKeyValueModifier::Apply ( void )
{
    ...
    Sys_Printf("bool rvGEKeyValueModifier::Apply ( void )\r\n");
    return retVal;
}
...
bool rvGEKeyValueModifier::Undo ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGEKeyValueModifier::Undo ( void )\r\n");
    return retVal;
}
...
bool rvGEKeyValueModifier::Merge ( rvGEModifier* mergebase )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGEKeyValueModifier::Merge ( rvGEModifier* mergebase )\r\n");
    return retVal;
}
