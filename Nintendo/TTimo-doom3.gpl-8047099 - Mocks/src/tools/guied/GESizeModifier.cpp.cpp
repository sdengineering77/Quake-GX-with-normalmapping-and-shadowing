...
bool rvGESizeModifier::Merge ( rvGEModifier* mergebase )
{
    ...
    Sys_Printf("bool rvGESizeModifier::Merge ( rvGEModifier* mergebase )\r\n");
    return retVal;
}
...
bool rvGESizeModifier::Apply ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGESizeModifier::Apply ( void )\r\n");
    return retVal;
}
...
bool rvGESizeModifier::Undo ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGESizeModifier::Undo ( void )\r\n");
    return retVal;
}
...
bool rvGESizeModifier::IsValid ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGESizeModifier::IsValid ( void )\r\n");
    return retVal;
}
