...
bool rvGEMoveModifier::Merge ( rvGEModifier* mergebase )
{
    ...
    Sys_Printf("bool rvGEMoveModifier::Merge ( rvGEModifier* mergebase )\r\n");
    return retVal;
}
...
bool rvGEMoveModifier::Apply ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGEMoveModifier::Apply ( void )\r\n");
    return retVal;
}
...
bool rvGEMoveModifier::Undo ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGEMoveModifier::Undo ( void )\r\n");
    return retVal;
}
...
bool rvGEMoveModifier::IsValid ( void )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool rvGEMoveModifier::IsValid ( void )\r\n");
    return retVal;
}
