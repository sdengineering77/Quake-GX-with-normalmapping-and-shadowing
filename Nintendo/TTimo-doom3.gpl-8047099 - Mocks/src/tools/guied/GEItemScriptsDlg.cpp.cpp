...
LRESULT CALLBACK GEScriptEdit_WndProc ( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    Sys_Printf("CALLBACK GEScriptEdit_WndProc ( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )\r\n");
    return retVal;
}
...
bool GEItescriptsDlg_Init ( HWND hwnd )
{
    ...
    Sys_Printf("bool GEItescriptsDlg_Init ( HWND hwnd )\r\n");
    return retVal;
}
...
bool GEItescriptsDlg_Apply ( HWND hwnd )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool GEItescriptsDlg_Apply ( HWND hwnd )\r\n");
    return retVal;
}
...
INT_PTR CALLBACK GEItescriptsDlg_WndProc ( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    CALLBACK retVal;
    memset(&retVal, 0, sizeof(CALLBACK));
    Sys_Printf("CALLBACK GEItescriptsDlg_WndProc ( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )\r\n");
    return retVal;
}
...
bool GEItemScriptsDlg_DoModal ( HWND parent, idWindow* window )
{
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool GEItemScriptsDlg_DoModal ( HWND parent, idWindow* window )\r\n");
    return retVal;
}
