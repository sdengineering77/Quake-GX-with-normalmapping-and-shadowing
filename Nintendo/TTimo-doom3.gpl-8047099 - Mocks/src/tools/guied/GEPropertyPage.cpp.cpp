...
INT_PTR CALLBACK rvGEPropertyPage::WndProc ( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    Sys_Printf("CALLBACK rvGEPropertyPage::WndProc ( HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam )\r\n");
    return retVal;
}
...
int rvGEPropertyPage::HandleMessage ( UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    Sys_Printf("int rvGEPropertyPage::HandleMessage ( UINT msg, WPARAM wParam, LPARAM lParam )\r\n");
    return retVal;
}
