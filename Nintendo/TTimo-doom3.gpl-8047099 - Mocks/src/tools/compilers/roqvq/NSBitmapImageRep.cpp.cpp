...
int NSBitmapImageRep::samplesPerPixel( void ) {
    ...
    Sys_Printf("int NSBitmapImageRep::samplesPerPixel( void )\r\n");
    return retVal;
}
...
int NSBitmapImageRep::pixelsWide( void ) {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int NSBitmapImageRep::pixelsWide( void )\r\n");
    return retVal;
}
...
int NSBitmapImageRep::pixelsHigh( void ) {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int NSBitmapImageRep::pixelsHigh( void )\r\n");
    return retVal;
}


byte * NSBitmapImageRep::bitmapData( void ) {
    Sys_Printf("byte * NSBitmapImageRep::bitmapData( void )\r\n");
    return NULL;
}
...
bool NSBitmapImageRep::hasAlpha( void ) {
    ...
    Sys_Printf("bool NSBitmapImageRep::hasAlpha( void )\r\n");
    return retVal;
}
...
bool NSBitmapImageRep::isPlanar( void ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool NSBitmapImageRep::isPlanar( void )\r\n");
    return retVal;
}
