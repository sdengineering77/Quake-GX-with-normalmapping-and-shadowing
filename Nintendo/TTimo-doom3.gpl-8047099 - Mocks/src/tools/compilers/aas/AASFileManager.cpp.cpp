...
public:
    ...
    Sys_Printf("virtual~idAASFileManagerLocal( void )\r\n");
    return retVal;
}
...
idAASFile *idAASFileManagerLocal::LoadAAS( const char *fileName, unsigned int mapFileCRC ) {
    Sys_Printf("idAASFile *idAASFileManagerLocal::LoadAAS( const char *fileName, unsigned int mapFileCRC )\r\n");
    return NULL;
}
...
void idAASFileManagerLocal::FreeAAS( idAASFile *file ) {
    Sys_Printf("void idAASFileManagerLocal::FreeAAS( idAASFile *file )\r\n");
}
