...
bool idAASBuild::AllGapsLeadToOtherNode( idBrushBSPNode *nodeWithGaps, idBrushBSPNode *otherNode ) {
    ...
    Sys_Printf("bool idAASBuild::AllGapsLeadToOtherNode( idBrushBSPNode *nodeWithGaps, idBrushBSPNode *otherNode )\r\n");
    return retVal;
}
...
bool idAASBuild::MergeWithAdjacentLeafNodes( idBrushBSP &bsp, idBrushBSPNode *node ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idAASBuild::MergeWithAdjacentLeafNodes( idBrushBSP &bsp, idBrushBSPNode *node )\r\n");
    return retVal;
}
...
void idAASBuild::MergeLeafNodes_r( idBrushBSP &bsp, idBrushBSPNode *node ) {
    Sys_Printf("void idAASBuild::MergeLeafNodes_r( idBrushBSP &bsp, idBrushBSPNode *node )\r\n");
}
...
void idAASBuild::MergeLeafNodes( idBrushBSP &bsp ) {
    Sys_Printf("void idAASBuild::MergeLeafNodes( idBrushBSP &bsp )\r\n");
}
