...
void DialogAFConstraintFixed::DoDataExchange(CDataExchange* pDX) {
    Sys_Printf("void DialogAFConstraintFixed::DoDataExchange(CDataExchange* pDX)\r\n");
}
...
void DialogAFConstraintFixed::InitJointLists( void ) {
    Sys_Printf("void DialogAFConstraintFixed::InitJointLists( void )\r\n");
}
...
void DialogAFConstraintFixed::LoadFile( idDeclAF *af ) {
    Sys_Printf("void DialogAFConstraintFixed::LoadFile( idDeclAF *af )\r\n");
}
...
void DialogAFConstraintFixed::SaveFile( void ) {
    Sys_Printf("void DialogAFConstraintFixed::SaveFile( void )\r\n");
}
...
void DialogAFConstraintFixed::LoadConstraint( idDeclAF_Constraint *c ) {
    Sys_Printf("void DialogAFConstraintFixed::LoadConstraint( idDeclAF_Constraint *c )\r\n");
}
...
void DialogAFConstraintFixed::SaveConstraint( void ) {
    Sys_Printf("void DialogAFConstraintFixed::SaveConstraint( void )\r\n");
}
...
void DialogAFConstraintFixed::UpdateFile( void ) {
    Sys_Printf("void DialogAFConstraintFixed::UpdateFile( void )\r\n");
}
...
int DialogAFConstraintFixed::OnToolHitTest( CPoint point, TOOLINFO* pTI ) const {
    ...
    Sys_Printf("int DialogAFConstraintFixed::OnToolHitTest( CPoint point, TOOLINFO* pTI )\r\n");
    return retVal;
}
...
BOOL DialogAFConstraintFixed::OnToolTipNotify( UINT id, NMHDR *pNMHDR, LRESULT *pResult ) {
    ...
    Sys_Printf("BOOL DialogAFConstraintFixed::OnToolTipNotify( UINT id, NMHDR *pNMHDR, LRESULT *pResult )\r\n");
    return retVal;
}
