...
{
    Sys_Printf("void CDialogSoundGroup::DoDataExchange(CDataExchange* pDX)\r\n");
}
...
{
    Sys_Printf("void CDialogSoundGroup::OnOK()\r\n");
}
...
BOOL CDialogSoundGroup::OnInitDialog() 
{
    ...
    Sys_Printf("BOOL CDialogSoundGroup::OnInitDialog()\r\n");
    return retVal;
}
