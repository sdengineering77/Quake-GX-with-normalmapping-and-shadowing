...
void AttributeMaterialModifierString::Undo() {
    Sys_Printf("void AttributeMaterialModifierString::Undo()\r\n");
}
...
void AttributeMaterialModifierString::Redo() {
    Sys_Printf("void AttributeMaterialModifierString::Redo()\r\n");
}
...
void AttributeMaterialModifierBool::Undo() {
    Sys_Printf("void AttributeMaterialModifierBool::Undo()\r\n");
}
...
void AttributeMaterialModifierBool::Redo() {
    Sys_Printf("void AttributeMaterialModifierBool::Redo()\r\n");
}
...
void StageMoveModifier::Undo() {
    Sys_Printf("void StageMoveModifier::Undo()\r\n");
}
...
void StageMoveModifier::Redo() {
    Sys_Printf("void StageMoveModifier::Redo()\r\n");
}
...
void StageDeleteModifier::Undo() {
    Sys_Printf("void StageDeleteModifier::Undo()\r\n");
}
...
void StageDeleteModifier::Redo() {
    Sys_Printf("void StageDeleteModifier::Redo()\r\n");
}
...
void StageInsertModifier::Undo() {
    Sys_Printf("void StageInsertModifier::Undo()\r\n");
}
...
void StageInsertModifier::Redo() {
    Sys_Printf("void StageInsertModifier::Redo()\r\n");
}
...
void AddMaterialModifier::Undo() {
    Sys_Printf("void AddMaterialModifier::Undo()\r\n");
}
...
void AddMaterialModifier::Redo() {
    Sys_Printf("void AddMaterialModifier::Redo()\r\n");
}
...
void DeleteMaterialModifier::Undo() {
    Sys_Printf("void DeleteMaterialModifier::Undo()\r\n");
}
...
void DeleteMaterialModifier::Redo() {
    Sys_Printf("void DeleteMaterialModifier::Redo()\r\n");
}
...
void MoveMaterialModifier::Undo() {
    Sys_Printf("void MoveMaterialModifier::Undo()\r\n");
}
...
void MoveMaterialModifier::Redo() {
    Sys_Printf("void MoveMaterialModifier::Redo()\r\n");
}
...
void RenameMaterialModifier::Undo() {
    Sys_Printf("void RenameMaterialModifier::Undo()\r\n");
}
...
void RenameMaterialModifier::Redo() {
    Sys_Printf("void RenameMaterialModifier::Redo()\r\n");
}
...
void AddMaterialFolderModifier::Undo() {
    Sys_Printf("void AddMaterialFolderModifier::Undo()\r\n");
}
...
void AddMaterialFolderModifier::Redo() {
    Sys_Printf("void AddMaterialFolderModifier::Redo()\r\n");
}
...
void RenameMaterialFolderModifier::Undo() {
    Sys_Printf("void RenameMaterialFolderModifier::Undo()\r\n");
}
...
void RenameMaterialFolderModifier::Redo() {
    Sys_Printf("void RenameMaterialFolderModifier::Redo()\r\n");
}
...
void DeleteMaterialFolderModifier::Undo() {
    Sys_Printf("void DeleteMaterialFolderModifier::Undo()\r\n");
}
...
void DeleteMaterialFolderModifier::Redo() {
    Sys_Printf("void DeleteMaterialFolderModifier::Redo()\r\n");
}
