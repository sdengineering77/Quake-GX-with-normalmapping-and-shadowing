...
LRESULT CALLBACK MaskEdit_WndProc ( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )
{
    ...
    Sys_Printf("CALLBACK MaskEdit_WndProc ( HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam )\r\n");
    return retVal;
}
...
{
    Sys_Printf("void MaskEdit_Attach ( HWND hWnd, const char* invalid )\r\n");
}
...
{
    Sys_Printf("void NumberEdit_Attach ( HWND hWnd )\r\n");
}
