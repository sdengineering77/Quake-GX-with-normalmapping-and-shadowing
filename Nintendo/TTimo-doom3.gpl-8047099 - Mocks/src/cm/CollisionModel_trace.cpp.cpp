...
void idCollisionModelManagerLocal::TraceTrmThroughNode( cm_traceWork_t *tw, cm_node_t *node ) {
    Sys_Printf("void idCollisionModelManagerLocal::TraceTrmThroughNode( cm_traceWork_t *tw, cm_node_t *node )\r\n");
}
...
void idCollisionModelManagerLocal::TraceThroughAxialBSPTree_r( cm_traceWork_t *tw, cm_node_t *node, float p1f, float p2f, idVec3 &p1, idVec3 &p2) {
    Sys_Printf("void idCollisionModelManagerLocal::TraceThroughAxialBSPTree_r( cm_traceWork_t *tw, cm_node_t *node, float p1f, float p2f, idVec3 &p1, idVec3 &p2)\r\n");
}
...
void idCollisionModelManagerLocal::TraceThroughModel( cm_traceWork_t *tw ) {
    Sys_Printf("void idCollisionModelManagerLocal::TraceThroughModel( cm_traceWork_t *tw )\r\n");
}
