...
void make_crc_table( void ) {
    Sys_Printf("void make_crc_table( void )\r\n");
}
...
void CRC32_InitChecksum( unsigned long &crcvalue ) {
    Sys_Printf("void CRC32_InitChecksum( unsigned long &crcvalue )\r\n");
}


void CRC32_Update( unsigned long &crcvalue, const byte data ) {
    Sys_Printf("void CRC32_Update( unsigned long &crcvalue, const byte data )\r\n");
}


void CRC32_UpdateChecksum( unsigned long &crcvalue, const void *data, int length ) {
    Sys_Printf("void CRC32_UpdateChecksum( unsigned long &crcvalue, const void *data, int length )\r\n");
}


void CRC32_FinishChecksum( unsigned long &crcvalue ) {
    Sys_Printf("void CRC32_FinishChecksum( unsigned long &crcvalue )\r\n");
}
...
unsigned long CRC32_BlockChecksum( const void *data, int length ) {
    ...
    Sys_Printf("long CRC32_BlockChecksum( const void *data, int length )\r\n");
    return retVal;
}
