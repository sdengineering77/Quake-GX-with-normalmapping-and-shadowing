...
const char * idSIMD_SSE3::GetName( void ) const {
    Sys_Printf("char * idSIMD_SSE3::GetName( void )\r\n");
    return NULL;
}
...
float SSE3_Dot( const idVec4 &v1, const idVec4 &v2 ) {
    ...
    Sys_Printf("float SSE3_Dot( const idVec4 &v1, const idVec4 &v2 )\r\n");
    return retVal;
}
...
void VPCALL idSIMD_SSE3::TransformVerts( idDrawVert *verts, const int numVerts, const idJointMat *joints, const idVec4 *weights, const int *index, const int numWeights ) {
    ...
    Sys_Printf("VPCALL idSIMD_SSE3::TransformVerts( idDrawVert *verts, const int numVerts, const idJointMat *joints, const idVec4 *weights, const int *index, const int numWeights )\r\n");
    return retVal;
}
