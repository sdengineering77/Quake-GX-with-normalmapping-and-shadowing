...
void idHashIndex::Init( const int initialHashSize, const int initialIndexSize ) {
    Sys_Printf("void idHashIndex::Init( const int initialHashSize, const int initialIndexSize )\r\n");
}
...
void idHashIndex::Allocate( const int newHashSize, const int newIndexSize ) {
    Sys_Printf("void idHashIndex::Allocate( const int newHashSize, const int newIndexSize )\r\n");
}
...
void idHashIndex::Free( void ) {
    Sys_Printf("void idHashIndex::Free( void )\r\n");
}
...
void idHashIndex::ResizeIndex( const int newIndexSize ) {
    Sys_Printf("void idHashIndex::ResizeIndex( const int newIndexSize )\r\n");
}
...
int idHashIndex::GetSpread( void ) const {
    ...
    Sys_Printf("int idHashIndex::GetSpread( void )\r\n");
    return retVal;
}
