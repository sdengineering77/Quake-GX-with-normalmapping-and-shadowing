...
void idItemTeam::Spawn( void ) {
    Sys_Printf("void idItemTeam::Spawn( void )\r\n");
}
...
function_t * idItemTeam::LoadScript( const char * script ) {
    Sys_Printf("function_t * idItemTeam::LoadScript( const char * script )\r\n");
    return NULL;
}
...
void idItemTeam::Think( void ) {
    Sys_Printf("void idItemTeam::Think( void )\r\n");
}
...
bool idItemTeam::Pickup( idPlayer *player ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idItemTeam::Pickup( idPlayer *player )\r\n");
    return retVal;
}
...
bool idItemTeam::ClientReceiveEvent( int event, int time, const idBitMsg &msg ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idItemTeam::ClientReceiveEvent( int event, int time, const idBitMsg &msg )\r\n");
    return retVal;
}
...
{
    Sys_Printf("void idItemTeam::Drop( bool death )\r\n");
}
...
{
    Sys_Printf("void idItemTeam::Return( idPlayer * player )\r\n");
}
...
{
    Sys_Printf("void idItemTeam::Capture( void )\r\n");
}
...
{
    Sys_Printf("void idItemTeam::PrivateReturn( void )\r\n");
}
...
void idItemTeam::Event_TakeFlag( idPlayer * player ) {
    Sys_Printf("void idItemTeam::Event_TakeFlag( idPlayer * player )\r\n");
}
...
void idItemTeam::Event_DropFlag( bool death ) {
    Sys_Printf("void idItemTeam::Event_DropFlag( bool death )\r\n");
}
...
void idItemTeam::Event_FlagReturn( idPlayer * player ) {
    Sys_Printf("void idItemTeam::Event_FlagReturn( idPlayer * player )\r\n");
}
...
void idItemTeam::Event_FlagCapture( void ) {
    Sys_Printf("void idItemTeam::Event_FlagCapture( void )\r\n");
}
...
void idItemTeam::FreeLightDef( void ) {
    Sys_Printf("void idItemTeam::FreeLightDef( void )\r\n");
}
...
void idItemTeam::SpawnNugget( idVec3 pos ) {
    Sys_Printf("void idItemTeam::SpawnNugget( idVec3 pos )\r\n");
}
...
void idItemTeam::WriteToSnapshot( idBitMsgDelta &msg ) const {
    Sys_Printf("void idItemTeam::WriteToSnapshot( idBitMsgDelta &msg )\r\n");
}
...
void idItemTeam::ReadFromSnapshot( const idBitMsgDelta &msg ) {
    Sys_Printf("void idItemTeam::ReadFromSnapshot( const idBitMsgDelta &msg )\r\n");
}
...
void idItemTeam::UpdateGuis( void ) {
    Sys_Printf("void idItemTeam::UpdateGuis( void )\r\n");
}
...
void idItemTeam::Present( void ) {
    Sys_Printf("void idItemTeam::Present( void )\r\n");
}
...
bool idMoveableItem::Collide( const trace_t &collision, const idVec3 &velocity ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idMoveableItem::Collide( const trace_t &collision, const idVec3 &velocity )\r\n");
    return retVal;
}
