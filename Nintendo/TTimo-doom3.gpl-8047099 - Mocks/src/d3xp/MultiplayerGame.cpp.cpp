...
void idMultiplayerGame::ClearHUDStatus( void ) {
    Sys_Printf("void idMultiplayerGame::ClearHUDStatus( void )\r\n");
}
...
int idMultiplayerGame::GetFlagPoints( int team )
{
    ...
    Sys_Printf("int idMultiplayerGame::GetFlagPoints( int team )\r\n");
    return retVal;
}
...
void idMultiplayerGame::UpdateCTFScoreboard( idUserInterface *scoreBoard, idPlayer *player ) {
    Sys_Printf("void idMultiplayerGame::UpdateCTFScoreboard( idUserInterface *scoreBoard, idPlayer *player )\r\n");
}
...
int idMultiplayerGame::WinningTeam( void ) {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int idMultiplayerGame::WinningTeam( void )\r\n");
    return retVal;
}
...
bool idMultiplayerGame::PointLimitHit( void ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idMultiplayerGame::PointLimitHit( void )\r\n");
    return retVal;
}
...
void idMultiplayerGame::TeamScoreCTF( int team, int delta ) {
    Sys_Printf("void idMultiplayerGame::TeamScoreCTF( int team, int delta )\r\n");
}
...
void idMultiplayerGame::PlayerScoreCTF( int playerIdx, int delta ) {
    Sys_Printf("void idMultiplayerGame::PlayerScoreCTF( int playerIdx, int delta )\r\n");
}
...
int	idMultiplayerGame::GetFlagCarrier( int team ) {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("intidMultiplayerGame::GetFlagCarrier( int team )\r\n");
    return retVal;
}
...
void idMultiplayerGame::PlayTeamSound( int toTeam, snd_evt_t evt, const char *shader ) {
    Sys_Printf("void idMultiplayerGame::PlayTeamSound( int toTeam, snd_evt_t evt, const char *shader )\r\n");
}
...
bool idMultiplayerGame::IsGametypeFlagBased( void )  {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idMultiplayerGame::IsGametypeFlagBased( void )\r\n");
    return retVal;
}
...
idItemTeam * idMultiplayerGame::GetTeamFlag( int team ) {
    Sys_Printf("idItemTeam * idMultiplayerGame::GetTeamFlag( int team )\r\n");
    return NULL;
}
...
void idMultiplayerGame::FindTeamFlags( void ) {
    Sys_Printf("void idMultiplayerGame::FindTeamFlags( void )\r\n");
}
...
flagStatus_t idMultiplayerGame::GetFlagStatus( int team ) {
    flagStatus_t retVal;
    memset(&retVal, 0, sizeof(flagStatus_t));
    Sys_Printf("flagStatus_t idMultiplayerGame::GetFlagStatus( int team )\r\n");
    return retVal;
}
...
void idMultiplayerGame::SetFlagMsg( bool b ) {
    Sys_Printf("void idMultiplayerGame::SetFlagMsg( bool b )\r\n");
}
...
bool idMultiplayerGame::IsFlagMsgOn( void ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idMultiplayerGame::IsFlagMsgOn( void )\r\n");
    return retVal;
}
...
void idMultiplayerGame::SetBestGametype( const char * map ) {
    Sys_Printf("void idMultiplayerGame::SetBestGametype( const char * map )\r\n");
}
...
void idMultiplayerGame::ReloadScoreboard() {
    Sys_Printf("void idMultiplayerGame::ReloadScoreboard()\r\n");
}
...
idStr idMultiplayerGame::GetBestGametype( const char* map, const char* gametype ) {
    ...
    Sys_Printf("idStr idMultiplayerGame::GetBestGametype( const char* map, const char* gametype )\r\n");
    return retVal;
}
