...
void idAFEntity_Gibbable::SetThrown( bool isThrown ) {
    Sys_Printf("void idAFEntity_Gibbable::SetThrown( bool isThrown )\r\n");
}
...
bool idAFEntity_Gibbable::Collide( const trace_t &collision, const idVec3 &velocity ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idAFEntity_Gibbable::Collide( const trace_t &collision, const idVec3 &velocity )\r\n");
    return retVal;
}
...
void idAFEntity_VehicleAutomated::Spawn( void ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::Spawn( void )\r\n");
}
...
void idAFEntity_VehicleAutomated::PostSpawn( void ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::PostSpawn( void )\r\n");
}
...
void idAFEntity_VehicleAutomated::Event_SetVelocity( float _velocity ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::Event_SetVelocity( float _velocity )\r\n");
}
...
void idAFEntity_VehicleAutomated::Event_SetTorque( float _torque ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::Event_SetTorque( float _torque )\r\n");
}
...
void idAFEntity_VehicleAutomated::Event_SetSteeringSpeed( float _steeringSpeed ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::Event_SetSteeringSpeed( float _steeringSpeed )\r\n");
}
...
void idAFEntity_VehicleAutomated::Event_SetWayPoint( idEntity *_waypoint ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::Event_SetWayPoint( idEntity *_waypoint )\r\n");
}
...
void idAFEntity_VehicleAutomated::Think( void ) {
    Sys_Printf("void idAFEntity_VehicleAutomated::Think( void )\r\n");
}
...
idHarvestable::idHarvestable() {
    ...
    Sys_Printf("END_CLASSidHarvestable::idHarvestable()\r\n");
    return retVal;
}
...
void idHarvestable::Spawn() {
    Sys_Printf("void idHarvestable::Spawn()\r\n");
}


void idHarvestable::Init(idEntity* parent) {
    Sys_Printf("void idHarvestable::Init(idEntity* parent)\r\n");
}


void idHarvestable::Save( idSaveGame *savefile ) const {
    Sys_Printf("void idHarvestable::Save( idSaveGame *savefile )\r\n");
}


void idHarvestable::Restore( idRestoreGame *savefile ) {
    Sys_Printf("void idHarvestable::Restore( idRestoreGame *savefile )\r\n");
}


void idHarvestable::SetParent(idEntity* parent) {
    Sys_Printf("void idHarvestable::SetParent(idEntity* parent)\r\n");
}


void idHarvestable::Think() {
    Sys_Printf("void idHarvestable::Think()\r\n");
}
...
void idHarvestable::Gib() {
    Sys_Printf("void idHarvestable::Gib()\r\n");
}
...
void idHarvestable::BeginBurn() {
    Sys_Printf("void idHarvestable::BeginBurn()\r\n");
}
...
void idHarvestable::BeginFX() {
    Sys_Printf("void idHarvestable::BeginFX()\r\n");
}
...
void idHarvestable::CalcTriggerBounds( float size, idBounds &bounds ) {
    Sys_Printf("void idHarvestable::CalcTriggerBounds( float size, idBounds &bounds )\r\n");
}
...
bool idHarvestable::GetFxOrientationAxis(idMat3& mat) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idHarvestable::GetFxOrientationAxis(idMat3& mat)\r\n");
    return retVal;
}
...
void idHarvestable::Event_SpawnHarvestTrigger( void ) {
    Sys_Printf("void idHarvestable::Event_SpawnHarvestTrigger( void )\r\n");
}
...
void idHarvestable::Event_Touch( idEntity *other, trace_t *trace ) {
    Sys_Printf("void idHarvestable::Event_Touch( idEntity *other, trace_t *trace )\r\n");
}
...
void idAFEntity_Harvest::Save( idSaveGame *savefile ) const {
    Sys_Printf("void idAFEntity_Harvest::Save( idSaveGame *savefile )\r\n");
}
...
void idAFEntity_Harvest::Restore( idRestoreGame *savefile ) {
    Sys_Printf("void idAFEntity_Harvest::Restore( idRestoreGame *savefile )\r\n");
}
...
void idAFEntity_Harvest::Spawn( void ) {
    Sys_Printf("void idAFEntity_Harvest::Spawn( void )\r\n");
}
...
void idAFEntity_Harvest::Think( void ) {
    Sys_Printf("void idAFEntity_Harvest::Think( void )\r\n");
}


void idAFEntity_Harvest::Event_SpawnHarvestEntity( void ) {
    Sys_Printf("void idAFEntity_Harvest::Event_SpawnHarvestEntity( void )\r\n");
}


void idAFEntity_Harvest::Gib( const idVec3 &dir, const char *damageDefName ) {
    Sys_Printf("void idAFEntity_Harvest::Gib( const idVec3 &dir, const char *damageDefName )\r\n");
}
