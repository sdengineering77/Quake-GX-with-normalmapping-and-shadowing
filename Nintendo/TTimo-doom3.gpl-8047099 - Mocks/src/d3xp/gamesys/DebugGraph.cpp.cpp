...
void idDebugGraph::SetNumSamples( int num ) {
    Sys_Printf("void idDebugGraph::SetNumSamples( int num )\r\n");
}
...
void idDebugGraph::AddValue( float value ) {
    Sys_Printf("void idDebugGraph::AddValue( float value )\r\n");
}
...
void idDebugGraph::Draw( const idVec4 &color, float scale ) const {
    Sys_Printf("void idDebugGraph::Draw( const idVec4 &color, float scale )\r\n");
}
