...
void idInventory::AddPickupName( const char *name, const char *icon, idPlayer* owner ) {
    Sys_Printf("void idInventory::AddPickupName( const char *name, const char *icon, idPlayer* owner )\r\n");
}
...
int idInventory::HasAmmo( const char *weapon_classname, bool includeClip, idPlayer* owner ) {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int idInventory::HasAmmo( const char *weapon_classname, bool includeClip, idPlayer* owner )\r\n");
    return retVal;
}
...
bool idInventory::HasEmptyClipCannotRefill(const char *weapon_classname, idPlayer* owner) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idInventory::HasEmptyClipCannotRefill(const char *weapon_classname, idPlayer* owner)\r\n");
    return retVal;
}
...
void idInventory::InitRechargeAmmo(idPlayer *owner) {
    Sys_Printf("void idInventory::InitRechargeAmmo(idPlayer *owner)\r\n");
}
...
void idInventory::RechargeAmmo(idPlayer *owner) {
    Sys_Printf("void idInventory::RechargeAmmo(idPlayer *owner)\r\n");
}
...
bool idInventory::CanGive( idPlayer *owner, const idDict &spawnArgs, const char *statname, const char *value, int *idealWeapon ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idInventory::CanGive( idPlayer *owner, const idDict &spawnArgs, const char *statname, const char *value, int *idealWeapon )\r\n");
    return retVal;
}
...
bool idPlayer::GiveInventoryItem( const char *name ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idPlayer::GiveInventoryItem( const char *name )\r\n");
    return retVal;
}
...
void idPlayer::UpdatePowerupHud() {
    Sys_Printf("void idPlayer::UpdatePowerupHud()\r\n");
}
...
void idPlayer::StartHealthRecharge(int speed) {
    Sys_Printf("void idPlayer::StartHealthRecharge(int speed)\r\n");
}
...
void idPlayer::StopHealthRecharge() {
    Sys_Printf("void idPlayer::StopHealthRecharge()\r\n");
}
...
idStr idPlayer::GetCurrentWeapon() {
    ...
    Sys_Printf("idStr idPlayer::GetCurrentWeapon()\r\n");
    return retVal;
}
...
bool idPlayer::CanGive( const char *statname, const char *value ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idPlayer::CanGive( const char *statname, const char *value )\r\n");
    return retVal;
}
...
void idPlayer::StopHelltime( bool quick ) {
    Sys_Printf("void idPlayer::StopHelltime( bool quick )\r\n");
}
...
void idPlayer::Event_ToggleBloom( int on ) {
    Sys_Printf("void idPlayer::Event_ToggleBloom( int on )\r\n");
}
...
void idPlayer::Event_SetBloomParms( float speed, float intensity ) {
    Sys_Printf("void idPlayer::Event_SetBloomParms( float speed, float intensity )\r\n");
}
...
void idPlayer::PlayHelltimeStopSound() {
    Sys_Printf("void idPlayer::PlayHelltimeStopSound()\r\n");
}
...
void idPlayer::Event_GiveInventoryItem( const char* name ) {
    Sys_Printf("void idPlayer::Event_GiveInventoryItem( const char* name )\r\n");
}
...
void idPlayer::Event_RemoveInventoryItem( const char* name ) {
    Sys_Printf("void idPlayer::Event_RemoveInventoryItem( const char* name )\r\n");
}
...
void idPlayer::Event_SetPowerupTime( int powerup, int time ) {
    Sys_Printf("void idPlayer::Event_SetPowerupTime( int powerup, int time )\r\n");
}
...
void idPlayer::Event_IsPowerupActive( int powerup ) {
    Sys_Printf("void idPlayer::Event_IsPowerupActive( int powerup )\r\n");
}
...
void idPlayer::Event_StartWarp() {
    Sys_Printf("void idPlayer::Event_StartWarp()\r\n");
}
...
void idPlayer::Event_StopHelltime( int mode ) {
    Sys_Printf("void idPlayer::Event_StopHelltime( int mode )\r\n");
}
...
void idPlayer::Event_WeaponAvailable( const char* name ) {
    Sys_Printf("void idPlayer::Event_WeaponAvailable( const char* name )\r\n");
}
...
bool idPlayer::WeaponAvailable( const char* name ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idPlayer::WeaponAvailable( const char* name )\r\n");
    return retVal;
}
...
void idPlayer::DropFlag( void ) {
    Sys_Printf("void idPlayer::DropFlag( void )\r\n");
}


void idPlayer::ReturnFlag() {
    Sys_Printf("void idPlayer::ReturnFlag()\r\n");
}


void idPlayer::FreeModelDef( void ) {
    Sys_Printf("void idPlayer::FreeModelDef( void )\r\n");
}
