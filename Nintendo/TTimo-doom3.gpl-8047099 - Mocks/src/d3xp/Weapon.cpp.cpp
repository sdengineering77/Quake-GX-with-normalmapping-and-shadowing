...
int idWeapon::GetGrabberState() const {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int idWeapon::GetGrabberState()\r\n");
    return retVal;
}
...
int idWeapon::AmmoCount() const {
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int idWeapon::AmmoCount()\r\n");
    return retVal;
}
...
void idWeapon::Event_Grabber( int enable ) {
    Sys_Printf("void idWeapon::Event_Grabber( int enable )\r\n");
}
...
void idWeapon::Event_GrabberHasTarget() {
    Sys_Printf("void idWeapon::Event_GrabberHasTarget()\r\n");
}
...
void idWeapon::Event_GrabberSetGrabDistance( float dist ) {
    Sys_Printf("void idWeapon::Event_GrabberSetGrabDistance( float dist )\r\n");
}
...
void idWeapon::Event_LaunchProjectilesEllipse( int num_projectiles, float spreada, float spreadb, float fuseOffset, float power ) {
    Sys_Printf("void idWeapon::Event_LaunchProjectilesEllipse( int num_projectiles, float spreada, float spreadb, float fuseOffset, float power )\r\n");
}
...
void idWeapon::Event_LaunchPowerup( const char* powerup, float duration, int useAmmo ) {
    Sys_Printf("void idWeapon::Event_LaunchPowerup( const char* powerup, float duration, int useAmmo )\r\n");
}


void idWeapon::Event_StartWeaponSmoke() {
    Sys_Printf("void idWeapon::Event_StartWeaponSmoke()\r\n");
}


void idWeapon::Event_StopWeaponSmoke() {
    Sys_Printf("void idWeapon::Event_StopWeaponSmoke()\r\n");
}


void idWeapon::Event_StartWeaponParticle( const char* name) {
    Sys_Printf("void idWeapon::Event_StartWeaponParticle( const char* name)\r\n");
}


void idWeapon::Event_StopWeaponParticle( const char* name) {
    Sys_Printf("void idWeapon::Event_StopWeaponParticle( const char* name)\r\n");
}


void idWeapon::Event_StartWeaponLight( const char* name) {
    Sys_Printf("void idWeapon::Event_StartWeaponLight( const char* name)\r\n");
}


void idWeapon::Event_StopWeaponLight( const char* name) {
    Sys_Printf("void idWeapon::Event_StopWeaponLight( const char* name)\r\n");
}
