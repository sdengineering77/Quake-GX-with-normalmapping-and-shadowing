...
void idThread::Event_RandomInt( int range ) const {
    Sys_Printf("void idThread::Event_RandomInt( int range )\r\n");
}
...
void idThread::Event_GetArcSine( float a ) {
    Sys_Printf("void idThread::Event_GetArcSine( float a )\r\n");
}
...
void idThread::Event_GetArcCosine( float a ) {
    Sys_Printf("void idThread::Event_GetArcCosine( float a )\r\n");
}
...
void idThread::Event_VecToOrthoBasisAngles( idVec3 &vec ) {
    Sys_Printf("void idThread::Event_VecToOrthoBasisAngles( idVec3 &vec )\r\n");
}


void idThread::Event_RotateVector( idVec3 &vec, idVec3 &ang ) {
    Sys_Printf("void idThread::Event_RotateVector( idVec3 &vec, idVec3 &ang )\r\n");
}
