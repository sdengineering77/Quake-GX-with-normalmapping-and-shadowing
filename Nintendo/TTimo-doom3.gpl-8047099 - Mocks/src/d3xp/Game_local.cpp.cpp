...
void idGameLocal::Clear( void ) {
    Sys_Printf("void idGameLocal::Clear( void )\r\n");
}
...
void idGameLocal::Init( void ) {
    Sys_Printf("void idGameLocal::Init( void )\r\n");
}
...
void idGameLocal::Shutdown( void ) {
    Sys_Printf("void idGameLocal::Shutdown( void )\r\n");
}
...
void idGameLocal::Printf( const char *fmt, ... ) const {
    Sys_Printf("void idGameLocal::Printf( const char *fmt, ... )\r\n");
}
...
void idGameLocal::RunTimeGroup2() {
    Sys_Printf("void idGameLocal::RunTimeGroup2()\r\n");
}
...
void idGameLocal::SetPortalSkyEnt( idEntity *ent ) {
    Sys_Printf("void idGameLocal::SetPortalSkyEnt( idEntity *ent )\r\n");
}
...
bool idGameLocal::IsPortalSkyAcive() {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idGameLocal::IsPortalSkyAcive()\r\n");
    return retVal;
}
...
void idGameLocal::ComputeSlowMsec() {
    Sys_Printf("void idGameLocal::ComputeSlowMsec()\r\n");
}
...
void idGameLocal::ResetSlowTimeVars() {
    Sys_Printf("void idGameLocal::ResetSlowTimeVars()\r\n");
}
...
void idGameLocal::QuickSlowmoReset() {
    Sys_Printf("void idGameLocal::QuickSlowmoReset()\r\n");
}
