...
void idDamagable::Hide( void ) {
    Sys_Printf("void idDamagable::Hide( void )\r\n");
}
...
void idDamagable::Show( void ) {
    Sys_Printf("void idDamagable::Show( void )\r\n");
}
...
void idAnimated::Event_SetAnimation( const char *animName ) {
    Sys_Printf("void idAnimated::Event_SetAnimation( const char *animName )\r\n");
}
...
void idAnimated::Event_GetAnimationLength() {
    Sys_Printf("void idAnimated::Event_GetAnimationLength()\r\n");
}
...
void idShockwave::Save( idSaveGame *savefile ) const {
    Sys_Printf("void idShockwave::Save( idSaveGame *savefile )\r\n");
}
...
void idShockwave::Restore( idRestoreGame *savefile ) {
    Sys_Printf("void idShockwave::Restore( idRestoreGame *savefile )\r\n");
}
...
void idShockwave::Spawn() {
    Sys_Printf("void idShockwave::Spawn()\r\n");
}
...
void idShockwave::Think() {
    Sys_Printf("void idShockwave::Think()\r\n");
}
...
void idShockwave::Event_Activate( idEntity *activator ) {
    Sys_Printf("void idShockwave::Event_Activate( idEntity *activator )\r\n");
}
...
void idFuncMountedObject::Spawn( void ) {
    Sys_Printf("void idFuncMountedObject::Spawn( void )\r\n");
}
...
void idFuncMountedObject::Think( void ) {
    Sys_Printf("void idFuncMountedObject::Think( void )\r\n");
}
...
void idFuncMountedObject::GetAngleRestrictions( int &yaw_min, int &yaw_max, int &pitch ) {
    Sys_Printf("void idFuncMountedObject::GetAngleRestrictions( int &yaw_min, int &yaw_max, int &pitch )\r\n");
}
...
void idFuncMountedObject::Event_Touch( idEntity *other, trace_t *trace ) {
    Sys_Printf("void idFuncMountedObject::Event_Touch( idEntity *other, trace_t *trace )\r\n");
}
...
void idFuncMountedObject::Event_Activate( idEntity *activator ) {
    Sys_Printf("void idFuncMountedObject::Event_Activate( idEntity *activator )\r\n");
}
...
idFuncMountedWeapon::idFuncMountedWeapon() {
    ...
    Sys_Printf("END_CLASSidFuncMountedWeapon::idFuncMountedWeapon()\r\n");
    return retVal;
}
...
void idFuncMountedWeapon::Spawn( void ) {
    Sys_Printf("void idFuncMountedWeapon::Spawn( void )\r\n");
}


void idFuncMountedWeapon::Think( void ) {
    Sys_Printf("void idFuncMountedWeapon::Think( void )\r\n");
}


void idFuncMountedWeapon::Event_PostSpawn( void ) {
    Sys_Printf("void idFuncMountedWeapon::Event_PostSpawn( void )\r\n");
}
...
void idPortalSky::Spawn( void ) {
    Sys_Printf("void idPortalSky::Spawn( void )\r\n");
}
...
void idPortalSky::Event_PostSpawn() {
    Sys_Printf("void idPortalSky::Event_PostSpawn()\r\n");
}
...
void idPortalSky::Event_Activate( idEntity *activator ) {
    Sys_Printf("void idPortalSky::Event_Activate( idEntity *activator )\r\n");
}
