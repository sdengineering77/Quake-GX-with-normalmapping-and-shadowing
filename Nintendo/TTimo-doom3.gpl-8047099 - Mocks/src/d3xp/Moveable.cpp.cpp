...
void idMoveable::SetAttacker( idEntity *ent ) {
    Sys_Printf("void idMoveable::SetAttacker( idEntity *ent )\r\n");
}
...
void idExplodingBarrel::SetStability( bool stability ) {
    Sys_Printf("void idExplodingBarrel::SetStability( bool stability )\r\n");
}
...
bool idExplodingBarrel::IsStable( void ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idExplodingBarrel::IsStable( void )\r\n");
    return retVal;
}
...
void idExplodingBarrel::StartBurning( void ) {
    Sys_Printf("void idExplodingBarrel::StartBurning( void )\r\n");
}
...
void idExplodingBarrel::StopBurning( void ) {
    Sys_Printf("void idExplodingBarrel::StopBurning( void )\r\n");
}
