...
void idEntity::Event_SetGui( int guiNum, const char *guiName) {
    Sys_Printf("void idEntity::Event_SetGui( int guiNum, const char *guiName)\r\n");
}
...
void idEntity::Event_PrecacheGui( const char *guiName ) {
    Sys_Printf("void idEntity::Event_PrecacheGui( const char *guiName )\r\n");
}


void idEntity::Event_GetGuiParm(int guiNum, const char *key) {
    Sys_Printf("void idEntity::Event_GetGuiParm(int guiNum, const char *key)\r\n");
}


void idEntity::Event_GetGuiParmFloat(int guiNum, const char *key) {
    Sys_Printf("void idEntity::Event_GetGuiParmFloat(int guiNum, const char *key)\r\n");
}


void idEntity::Event_GuiNamedEvent(int guiNum, const char *event) {
    Sys_Printf("void idEntity::Event_GuiNamedEvent(int guiNum, const char *event)\r\n");
}
...
void idEntity::DetermineTimeGroup( bool slowmo ) {
    Sys_Printf("void idEntity::DetermineTimeGroup( bool slowmo )\r\n");
}
...
void idEntity::SetGrabbedState( bool grabbed ) {
    Sys_Printf("void idEntity::SetGrabbedState( bool grabbed )\r\n");
}
...
bool idEntity::IsGrabbed() {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idEntity::IsGrabbed()\r\n");
    return retVal;
}
