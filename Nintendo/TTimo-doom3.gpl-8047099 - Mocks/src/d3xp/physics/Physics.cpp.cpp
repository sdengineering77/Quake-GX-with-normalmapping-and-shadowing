...
void idPhysics::Save( idSaveGame *savefile ) const {
    Sys_Printf("void idPhysics::Save( idSaveGame *savefile )\r\n");
}
...
void idPhysics::Restore( idRestoreGame *savefile ) {
    Sys_Printf("void idPhysics::Restore( idRestoreGame *savefile )\r\n");
}
...
void idPhysics::SetClipBox( const idBounds &bounds, float density ) {
    Sys_Printf("void idPhysics::SetClipBox( const idBounds &bounds, float density )\r\n");
}
...
int idPhysics::SnapTimeToPhysicsFrame( int t ) {
    ...
    Sys_Printf("int idPhysics::SnapTimeToPhysicsFrame( int t )\r\n");
    return retVal;
}
