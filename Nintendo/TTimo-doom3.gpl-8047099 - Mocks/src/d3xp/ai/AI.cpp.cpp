...
void idAI::Gib( const idVec3 &dir, const char *damageDefName ) {
    Sys_Printf("void idAI::Gib( const idVec3 &dir, const char *damageDefName )\r\n");
}
...
void idAI::TriggerFX( const char* joint, const char* fx ) {
    Sys_Printf("void idAI::TriggerFX( const char* joint, const char* fx )\r\n");
}


idEntity* idAI::StartEmitter( const char* name, const char* joint, const char* particle ) {
    Sys_Printf("idEntity* idAI::StartEmitter( const char* name, const char* joint, const char* particle )\r\n");
    return NULL;
}


idEntity* idAI::GetEmitter( const char* name ) {
    Sys_Printf("idEntity* idAI::GetEmitter( const char* name )\r\n");
    return NULL;
}


void idAI::StopEmitter( const char* name ) {
    Sys_Printf("void idAI::StopEmitter( const char* name )\r\n");
}
