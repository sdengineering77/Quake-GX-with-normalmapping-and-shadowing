...
void idWorldspawn::Spawn( void ) {
    Sys_Printf("void idWorldspawn::Spawn( void )\r\n");
}
...
void idWorldspawn::Save( idRestoreGame *savefile ) {
    Sys_Printf("void idWorldspawn::Save( idRestoreGame *savefile )\r\n");
}
...
void idWorldspawn::Restore( idRestoreGame *savefile ) {
    Sys_Printf("void idWorldspawn::Restore( idRestoreGame *savefile )\r\n");
}
...
void idWorldspawn::Event_Remove( void ) {
    Sys_Printf("void idWorldspawn::Event_Remove( void )\r\n");
}
