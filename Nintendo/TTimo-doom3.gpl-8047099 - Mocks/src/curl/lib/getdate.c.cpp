...
{
    Sys_Printf("void__yy_memcpy (char *to, char *from, unsigned int count)\r\n");
}
...
/* yyresume: */
  ...
  if (yychar <= 0)		/* This means end of input. */
	...
	{
    0 retVal;
    memset(&retVal, 0, sizeof(0));
    Sys_Printf("0      if (yydebug)\r\n");
    return retVal;
}
...
yyerror (const char *s ATTRIBUTE_UNUSED)
{
    ...
    Sys_Printf("intyyerror (const char *s ATTRIBUTE_UNUSED)\r\n");
    return retVal;
}
...
ToHour (int Hours, MERIDIAN Meridian)
{
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("intToHour (int Hours, MERIDIAN Meridian)\r\n");
    return retVal;
}
...
LookupWord (YYSTYPE *yylval, char *buff)
{
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("intLookupWord (YYSTYPE *yylval, char *buff)\r\n");
    return retVal;
}
...
yylex (YYSTYPE *yylval, void *cookie)
{
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("intyylex (YYSTYPE *yylval, void *cookie)\r\n");
    return retVal;
}
...
difftm (struct tm *a, struct tm *b)
{
    ...
    Sys_Printf("longdifftm (struct tm *a, struct tm *b)\r\n");
    return retVal;
}
...
{
    time_t retVal;
    memset(&retVal, 0, sizeof(time_t));
    Sys_Printf("time_tcurl_getdate (const char *p, const time_t *now)\r\n");
    return retVal;
}
...
main (int ac, char *av[])
{
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("intmain (int ac, char *av[])\r\n");
    return retVal;
}
