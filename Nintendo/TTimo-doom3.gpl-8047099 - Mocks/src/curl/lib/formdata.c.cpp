...
static const char * ContentTypeForFilename (const char *filename,
					    const char *prevtype)
{
    Sys_Printf("char * ContentTypeForFilename (const char *filename, const char *prevtype)\r\n");
    return NULL;
}
                 ...
                 ...)
{
    CURLFORMcode retVal;
    memset(&retVal, 0, sizeof(CURLFORMcode));
    Sys_Printf("CURLFORMcode curl_formadd(struct curl_httppost **httppost, struct curl_httppost **last_post, ...)\r\n");
    return retVal;
}
                        ...
                        const char *fmt, ...)
{
    size_t retVal;
    memset(&retVal, 0, sizeof(size_t));
    Sys_Printf("size_t AddFormDataf(struct FormData **formp, const char *fmt, ...)\r\n");
    return retVal;
}
                 ...
                 ...)
{
    int retVal;
    memset(&retVal, 0, sizeof(int));
    Sys_Printf("int FormAddTest(const char * errormsg, struct curl_httppost **httppost, struct curl_httppost **last_post, ...)\r\n");
    return retVal;
}
