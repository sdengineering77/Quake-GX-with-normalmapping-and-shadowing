...
// DRS: ogc (based on Linux)
#ifdef DOOMGX
#define	BUILD_STRING				"ogc-ppc"
// DRS TODO: used mac ppc id, hopefully works!
#define BUILD_OS_ID					1
#define CPUSTRING					"ppc"
#define CPU_EASYARGS				0
...
#else
// DRS : quake 3 event structure DOES have a evTime member; use it because the one
// shipped above doesn't have it while DOOM code is linking it... Kind of weird!
typedef struct {
    int             evTime;
    sysEventType_t  evType;
    int             evValue;
