...
size_t idDeclSkin::Size( void ) const {
    ...
    Sys_Printf("size_t idDeclSkin::Size( void )\r\n");
    return retVal;
}
...
void idDeclSkin::FreeData( void ) {
    Sys_Printf("void idDeclSkin::FreeData( void )\r\n");
}
...
bool idDeclSkin::Parse( const char *text, const int textLength ) {
    ...
    Sys_Printf("bool idDeclSkin::Parse( const char *text, const int textLength )\r\n");
    return retVal;
}
...
bool idDeclSkin::SetDefaultText( void ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idDeclSkin::SetDefaultText( void )\r\n");
    return retVal;
}
...
const char *idDeclSkin::DefaultDefinition( void ) const {
    Sys_Printf("char *idDeclSkin::DefaultDefinition( void )\r\n");
    return NULL;
}
...
const int idDeclSkin::GetNumModelAssociations(void ) const {
    ...
    Sys_Printf("int idDeclSkin::GetNumModelAssociations(void )\r\n");
    return retVal;
}
...
const char *idDeclSkin::GetAssociatedModel( int index ) const {
    Sys_Printf("char *idDeclSkin::GetAssociatedModel( int index )\r\n");
    return NULL;
}
...
const idMaterial *idDeclSkin::RemapShaderBySkin( const idMaterial *shader ) const {
    Sys_Printf("idMaterial *idDeclSkin::RemapShaderBySkin( const idMaterial *shader )\r\n");
    return NULL;
}
