...
idODE_Euler::idODE_Euler( const int dim, deriveFunction_t dr, const void *ud ) {
    ...
    Sys_DebugPrintf("idODE_Euler::idODE_Euler( const int dim, deriveFunction_t dr, const void *ud ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idODE_Midpoint::idODE_Midpoint( const int dim, deriveFunction_t dr, const void *ud ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idODE_RK4::idODE_RK4( const int dim, deriveFunction_t dr, const void *ud ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idODE_RK4Adaptive::idODE_RK4Adaptive( const int dim, deriveFunction_t dr, const void *ud ) size %d\r\n", sizeof(*this));
#endif
