...
idPlayerIcon::idPlayerIcon() {
    ...
    Sys_DebugPrintf("idPlayerIcon::idPlayerIcon() size %d\r\n", sizeof(*this));
#endif
...
void idPlayerIcon::Draw( idPlayer *player, jointHandle_t joint ) {
    Sys_Printf("void idPlayerIcon::Draw( idPlayer *player, jointHandle_t joint )\r\n");
}
...
void idPlayerIcon::Draw( idPlayer *player, const idVec3 &origin ) {
    Sys_Printf("void idPlayerIcon::Draw( idPlayer *player, const idVec3 &origin )\r\n");
}
...
void idPlayerIcon::FreeIcon( void ) {
    Sys_Printf("void idPlayerIcon::FreeIcon( void )\r\n");
}
...
bool idPlayerIcon::CreateIcon( idPlayer *player, playerIconType_t type, const idVec3 &origin, const idMat3 &axis ) {
    ...
    Sys_Printf("bool idPlayerIcon::CreateIcon( idPlayer *player, playerIconType_t type, const idVec3 &origin, const idMat3 &axis )\r\n");
    return retVal;
}
...
bool idPlayerIcon::CreateIcon( idPlayer *player, playerIconType_t type, const char *mtr, const idVec3 &origin, const idMat3 &axis ) {
    bool retVal;
    memset(&retVal, 0, sizeof(bool));
    Sys_Printf("bool idPlayerIcon::CreateIcon( idPlayer *player, playerIconType_t type, const char *mtr, const idVec3 &origin, const idMat3 &axis )\r\n");
    return retVal;
}
...
void idPlayerIcon::UpdateIcon( idPlayer *player, const idVec3 &origin, const idMat3 &axis ) {
    Sys_Printf("void idPlayerIcon::UpdateIcon( idPlayer *player, const idVec3 &origin, const idMat3 &axis )\r\n");
}
