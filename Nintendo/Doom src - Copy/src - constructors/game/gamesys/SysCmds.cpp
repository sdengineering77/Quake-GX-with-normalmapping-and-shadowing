...
Sys_Printf("TODO SysCmds.cpp 1297 collisionModelManager->ListModels()\r\n");
// DRS TODO	collisionModelManager->ListModels();
}
...
// DRS TODO		collisionModelManager->ModelInfo( -1 );
	} else {
// DRS TODO		collisionModelManager->ModelInfo( atoi(value) );
	}
}
