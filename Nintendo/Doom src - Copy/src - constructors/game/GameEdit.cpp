...
idCursor3D::idCursor3D( void ) {
    ...
    Sys_DebugPrintf("idCursor3D::idCursor3D( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idDragEntity::idDragEntity( void ) size %d\r\n", sizeof(*this));
#endif
...
#ifdef TRACE_CONSTRUCTS
    Sys_DebugPrintf("idEditEntities::idEditEntities( void ) size %d\r\n", sizeof(*this));
#endif
