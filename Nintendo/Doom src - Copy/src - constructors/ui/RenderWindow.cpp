...
Sys_Printf("TODO void idRenderWindow::BuildAnimation(int time)\r\n");
/*	if (!updateAnimation) {
		return;
	}
...
Sys_Printf("TODO: RenderWindow.cpp preRender() gameEdit->ParseSpawnArgsToRenderLight\r\n");
// DRS TODO		gameEdit->ParseSpawnArgsToRenderLight( &spawnArgs, &rLight );
...
Sys_Printf("TODO: RenderWindow.cpp preRender() gameEdit->ParseSpawnArgsToRenderEntity\r\n");
// DRS TODO		gameEdit->ParseSpawnArgsToRenderEntity( &spawnArgs, &worldEntity );
...
Sys_Printf("TODO RenderWindow.cpp Render() gameEdit->ANIM_CreateAnimFrame \r\n");
// DRS TODO			gameEdit->ANIM_CreateAnimFrame(worldEntity.hModel, modelAnim, worldEntity.numJoints, worldEntity.joints, animLength - (animEndTime - time), vec3_origin, false );
		}
