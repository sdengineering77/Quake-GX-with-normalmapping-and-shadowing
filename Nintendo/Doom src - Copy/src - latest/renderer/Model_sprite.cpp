...
dynamicModel_t idRenderModelSprite::IsDynamicModel() const {
    ...
    Sys_Printf("dynamicModel_t idRenderModelSprite::IsDynamicModel()\r\n");
    return retVal;
}
...
bool idRenderModelSprite::IsLoaded() const {
    ...
    Sys_Printf("bool idRenderModelSprite::IsLoaded()\r\n");
    return retVal;
}
...
idRenderModel *	idRenderModelSprite::InstantiateDynamicModel( const struct renderEntity_s *renderEntity, const struct viewDef_s *viewDef, idRenderModel *cachedModel ) {
    Sys_Printf("idRenderModel *idRenderModelSprite::InstantiateDynamicModel( const struct renderEntity_s *renderEntity, const struct viewDef_s *viewDef, idRenderModel *cachedModel )\r\n");
    return NULL;
}
...
idBounds idRenderModelSprite::Bounds( const struct renderEntity_s *renderEntity ) const {
    ...
    Sys_Printf("idBounds idRenderModelSprite::Bounds( const struct renderEntity_s *renderEntity )\r\n");
    return retVal;
}
